...
export const HELP_TREE = Object.freeze({
  "getting-started": [
    ...
    A("import-a-quote-from-another-system", "Import a quote from another system", { screen: "quotes" }),
  ...
  "jobs-and-scheduling": [
    ...
    A("job-costing", "Job costing: quoted against actual", { feature: "job_costing", only: true }),
    ...
    A("supervisor-required-visits", "Visits that need a supervisor", { feature: "scheduling" }),
  ],
  ...
  "invoices-and-payments": [
    ...
    A("deposits-and-payment-schedules", "Deposits and payment schedules", { screen: "settings-company", feature: "booking_deposit" }),
    A("progress-payments-by-stage", "Progress payments: how each stage is requested", { feature: "booking_deposit" }),
  ...
  clients: [
    ...
    A("referrals-from-clients", "Referrals from clients", { feature: "referrals" }),
  ...
  "marketing-and-website": [
    ...
    A("your-website-address", "Your website address: subdomain and custom domain", { feature: "website_builder" }),
