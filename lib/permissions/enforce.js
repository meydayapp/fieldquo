...
// ── Money ─────────────────────────────────────────────────────────────────
//
// `showPricing: false` is the Worker (limited access) preset's defining
// setting: that person carries materials and marks work complete, and does not
// know what the customer is paying. It gated the price book, the analytics
...
const QUOTE_MONEY_FIELDS = ["subtotal", "discount", "tax", "total"];
