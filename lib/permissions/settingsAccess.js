...
export const SETTINGS_ROW_CAPABILITY = {
  ...
  // they can be scheduled — plus, since 2026-09-20, a fourth of the same kind:
  // their own calendar (Google Calendar connection and feed), because the
  // person in the van is exactly who wants today's visits on their phone and
  // nothing on that row is the company's. Everything under Account, Services & Pricing,
  ...
  // Their own Google Calendar connection and calendar feed. Every route under
  // /api/calendar/google reads the member id off the session and refuses
  // nothing a member may do to their own calendar, so the row is exactly as
  // usable as it claims to be.
...
export const SETTINGS_ROW_REQUIREMENTS = {
  ...
  // owner's spec for Crew is three rows (four with My calendar), and these four are the ones no role
