 ...
 * hold user:manage — it means "may run a crew": invite an estimator, fix the
 * phone number of an accepted member ranked below them (a pending invitee
 * has no edit path; see the pending routes). Not set a labour rate — that is
 * payroll, clamped behind payroll:view_all on the same PATCH, and this
 * comment used to claim it. None of that implies authority to revoke
 * somebody's login.
 *
