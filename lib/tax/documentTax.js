...
export function resolveDocumentTax({
  ...
  const assumed =
    ...
    // The US rung, and its stated zero: "no Texas sales tax on this quote"
    // assumed from the company's own Texas address is still an assumption
    // about where the client is, and a Louisiana client owes something else.
