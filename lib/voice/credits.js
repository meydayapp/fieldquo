...
const AI_KINDS = new Set([
  ...
  "image_vision",
  "material_list",
  // The AI employee, charged per reply from its own token counts — the
  // owner's 2026-09-25 decision; lib/ai/walletMeter.js holds the arithmetic.
  // The kind IS the AiUsage feature name, so the statement and the usage
  // screen say the same word for the same spend.
  "ai_employee_reply",
  "ai_employee_front_desk",
