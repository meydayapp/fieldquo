...
export const NUMBER_SOURCES = [
  {
    ...
    caveat:
      "You set the forwarding on your own phone, and you can turn it off the same way in under a minute.",
  },
  {
    key: "purchased",
...
export function forwardingCodes(target) {
  ...
  return [
    {
      when: "When you don't answer",
      code: `*61*${n}#`,
      note: "Rings your phone first. Most people want this one.",
    },
    { when: "When your line is busy", code: `*67*${n}#` },
    { when: "When your phone is off or out of signal", code: `*62*${n}#` },
    { when: "Every call, straight through", code: `*21*${n}#`, note: "Your phone won't ring at all." },
