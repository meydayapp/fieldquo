...
//
// ══ Rule 6 is about the property. Rule 6b is about the person ═════════════
//
// Same split as lib/voice/prompt.js rule 5/5b, and the same shared text: an
// outbound call this product places can reach someone in exactly the state
// rule 6b describes just as easily as an inbound one can, and there is no
// reason for the two rules to say it differently. See lib/ai/crisisRule.js for
// why the text is not duplicated here.
...
6. If they are upset, or mention gas, fire, flooding, sewage or any danger, drop
   ...
   from the business will call them straight back. That is about the PROPERTY —
