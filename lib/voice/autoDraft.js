 ...
 *
 * ── A crisis mention no longer lands here ───────────────────────────────────
 *
 * draftQuoteFromCall used to return a dedicated CRISIS_DETECTED reason that
 * this function turned into a skip AND a needsReview flag. It no longer does:
 * a crisis mention now flags needsReview itself, inline, and still drafts the
 * quote normally — see lib/ai/crisisRule.js, "why these two no longer refuse".
 * A crisis call that genuinely has nothing else on it falls out through
 * NOTHING_SAID or NOTHING_QUOTABLE below like any other thin call; either way
 * needsReview has already been set before this function is ever reached.
 */
