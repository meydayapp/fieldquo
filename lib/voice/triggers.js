 ...
 *
 * What this function adds is the two rules specific to a quote:
 *
 ...
 *
 * @param quote { autoEstimated, needsReview, sentAt, company:{outboundCallsEnabled}, client:{phone} }
 */
export function approvedQuoteCallGate(quote) {
  ...
  // Scope, deliberately narrow: this trigger is the instant-estimate follow-up.
  // A quote an estimator typed by hand has a human who already knows the
  // customer, and auto-dialling them was never asked for.
  if (!quote.autoEstimated) return { allowed: false, reason: CALLBACK_REFUSED.NOT_ESTIMATE };
