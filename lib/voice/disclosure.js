...
export const DISCLOSURE = {
  // Every inbound form where somebody hands over a number expecting a reply.
  // Worded so it's true whether a person or the assistant rings first — the
  // point is that they know a call is coming and that it may not be a human.
  lead:
    "Someone will be in touch about your request — it may be an assistant calling first.",
  self_quote:
