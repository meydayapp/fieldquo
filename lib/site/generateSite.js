...
company's website. The brief, every time:
  ...
  AT MOST 7 sections. A focused page beats a long one: a homeowner scans, they
  don't read. If you can say it in six sections, use six.
...
Return AT MOST 7. The four marked (always) are added for you if you leave them
out, so they count against your seven — plan for them. Pick from exactly these
keys and order them the way this business should be read:
...
- Very little content at all? Return a SHORT page. Five sections that are full
  beat seven that are thin. Never pad to reach the limit.
