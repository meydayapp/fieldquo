...
const COPY = {
  en: {
    ...
    siteBy: "Site by",
    // "Client login" — the header/footer link and the /client page, shown
    // only when the company switched CompanySite.clientPortalEnabled on.
    // clientLoginSent is deliberately the same whether or not the address
    // belongs to a client (app/api/portal-login/route.js).
    clientLogin: "Client login",
    clientLoginHeading: "Your account",
    clientLoginIntro: "Enter the email address we have on file for you and we'll send you a link to your quotes, invoices, visits and plans.",
    clientLoginEmail: "Email address",
    clientLoginSend: "Email me my link",
    clientLoginSent: "If you're a client, a link is on its way. Check your inbox (and spam folder) in a minute or two.",
    clientLoginInvalid: "Enter a valid email address.",
    clientLoginBusy: "Too many tries. Please wait a few minutes and try again.",
    clientLoginFailed: "Something went wrong. Please try again.",
    clientLoginNoPassword: "No password needed: the link in the email is your key.",
    // Derived intros
  ...
  fr: {
    ...
    clientLoginHeading: "Votre compte",
    clientLoginIntro: "Entrez l'adresse courriel que nous avons à votre dossier et nous vous enverrons un lien vers vos soumissions, factures, visites et forfaits.",
    clientLoginEmail: "Adresse courriel",
    clientLoginSend: "M'envoyer mon lien",
    clientLoginSent: "Si vous êtes client, un lien est en route. Vérifiez votre boîte de réception (et vos indésirables) d'ici une minute ou deux.",
    clientLoginInvalid: "Entrez une adresse courriel valide.",
    clientLoginBusy: "Trop de tentatives. Veuillez patienter quelques minutes et réessayer.",
    clientLoginFailed: "Un problème est survenu. Veuillez réessayer.",
    clientLoginNoPassword: "Aucun mot de passe : le lien dans le courriel est votre clé.",
  ...
  es: {
    ...
    clientLoginHeading: "Su cuenta",
    clientLoginIntro: "Escriba el correo electrónico que tenemos registrado y le enviaremos un enlace a sus presupuestos, facturas, visitas y planes.",
    clientLoginEmail: "Correo electrónico",
    clientLoginSend: "Enviarme mi enlace",
    clientLoginSent: "Si es cliente, le llegará un enlace. Revise su bandeja de entrada (y el correo no deseado) en un par de minutos.",
    clientLoginInvalid: "Escriba un correo electrónico válido.",
    clientLoginBusy: "Demasiados intentos. Espere unos minutos e inténtelo de nuevo.",
    clientLoginFailed: "Algo salió mal. Inténtelo de nuevo.",
    clientLoginNoPassword: "No necesita contraseña: el enlace del correo es su llave.",
  ...
  uk: {
    ...
    clientLoginHeading: "Ваш обліковий запис",
    clientLoginIntro: "Введіть адресу електронної пошти, яку ми маємо у вашій картці, і ми надішлемо посилання на ваші кошториси, рахунки, візити та плани.",
    clientLoginEmail: "Електронна пошта",
    clientLoginSend: "Надіслати мені посилання",
    clientLoginSent: "Якщо ви наш клієнт, посилання вже в дорозі. Перевірте вхідні (і спам) за хвилину-дві.",
    clientLoginInvalid: "Введіть дійсну адресу електронної пошти.",
    clientLoginBusy: "Забагато спроб. Зачекайте кілька хвилин і спробуйте ще раз.",
    clientLoginFailed: "Щось пішло не так. Спробуйте ще раз.",
    clientLoginNoPassword: "Пароль не потрібен: посилання в листі і є вашим ключем.",
  ...
  pa: {
    ...
    clientLogin: "ਗਾਹਕ ਲੌਗਇਨ",
    clientLoginHeading: "ਤੁਹਾਡਾ ਖਾਤਾ",
    clientLoginIntro: "ਸਾਡੇ ਕੋਲ ਦਰਜ ਆਪਣਾ ਈਮੇਲ ਪਤਾ ਲਿਖੋ ਅਤੇ ਅਸੀਂ ਤੁਹਾਨੂੰ ਤੁਹਾਡੇ ਹਵਾਲਿਆਂ, ਇਨਵੌਇਸਾਂ, ਫੇਰੀਆਂ ਅਤੇ ਪਲਾਨਾਂ ਦਾ ਲਿੰਕ ਭੇਜਾਂਗੇ।",
    clientLoginEmail: "ਈਮੇਲ ਪਤਾ",
    clientLoginSend: "ਮੈਨੂੰ ਮੇਰਾ ਲਿੰਕ ਈਮੇਲ ਕਰੋ",
    clientLoginSent: "ਜੇ ਤੁਸੀਂ ਸਾਡੇ ਗਾਹਕ ਹੋ, ਤਾਂ ਲਿੰਕ ਰਸਤੇ ਵਿੱਚ ਹੈ। ਇੱਕ-ਦੋ ਮਿੰਟਾਂ ਵਿੱਚ ਆਪਣਾ ਇਨਬਾਕਸ (ਅਤੇ ਸਪੈਮ) ਦੇਖੋ।",
    clientLoginInvalid: "ਇੱਕ ਸਹੀ ਈਮੇਲ ਪਤਾ ਲਿਖੋ।",
    clientLoginBusy: "ਬਹੁਤ ਵਾਰ ਕੋਸ਼ਿਸ਼ ਹੋਈ। ਕੁਝ ਮਿੰਟ ਉਡੀਕ ਕਰਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।",
    clientLoginFailed: "ਕੁਝ ਗਲਤ ਹੋ ਗਿਆ। ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।",
    clientLoginNoPassword: "ਪਾਸਵਰਡ ਦੀ ਲੋੜ ਨਹੀਂ: ਈਮੇਲ ਵਿਚਲਾ ਲਿੰਕ ਹੀ ਤੁਹਾਡੀ ਚਾਬੀ ਹੈ।",
  ...
  tl: {
    ...
    siteBy: "Site ng",
    clientLogin: "Client login",
    clientLoginHeading: "Ang iyong account",
    clientLoginIntro: "Ilagay ang email address na nasa aming talaan at padadalhan ka namin ng link sa iyong mga quote, invoice, pagbisita at plan.",
    clientLoginEmail: "Email address",
    clientLoginSend: "I-email ang aking link",
    clientLoginSent: "Kung kliyente ka namin, papunta na ang link. Tingnan ang iyong inbox (at spam) sa loob ng isa o dalawang minuto.",
    clientLoginInvalid: "Maglagay ng wastong email address.",
    clientLoginBusy: "Masyadong maraming subok. Maghintay ng ilang minuto at subukan muli.",
    clientLoginFailed: "May nangyaring mali. Pakisubukan muli.",
    clientLoginNoPassword: "Walang kailangang password: ang link sa email ang iyong susi.",
  ...
  de: {
    ...
    clientLoginHeading: "Ihr Konto",
    clientLoginIntro: "Geben Sie die E-Mail-Adresse ein, die wir von Ihnen haben, und wir senden Ihnen einen Link zu Ihren Angeboten, Rechnungen, Besuchen und Plänen.",
    clientLoginEmail: "E-Mail-Adresse",
    clientLoginSend: "Link per E-Mail senden",
    clientLoginSent: "Wenn Sie Kunde sind, ist ein Link unterwegs. Sehen Sie in ein bis zwei Minuten in Ihrem Posteingang (und Spam-Ordner) nach.",
    clientLoginInvalid: "Geben Sie eine gültige E-Mail-Adresse ein.",
    clientLoginBusy: "Zu viele Versuche. Bitte warten Sie ein paar Minuten und versuchen Sie es erneut.",
    clientLoginFailed: "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut.",
    clientLoginNoPassword: "Kein Passwort nötig: Der Link in der E-Mail ist Ihr Schlüssel.",
  ...
  it: {
    ...
    clientLoginHeading: "Il suo account",
    clientLoginIntro: "Inserisca l'indirizzo email che abbiamo in archivio e le invieremo un link ai suoi preventivi, fatture, visite e piani.",
    clientLoginEmail: "Indirizzo email",
    clientLoginSend: "Inviami il mio link",
    clientLoginSent: "Se è nostro cliente, un link è in arrivo. Controlli la posta in arrivo (e lo spam) tra un paio di minuti.",
    clientLoginInvalid: "Inserisca un indirizzo email valido.",
    clientLoginBusy: "Troppi tentativi. Attenda qualche minuto e riprovi.",
    clientLoginFailed: "Qualcosa è andato storto. Riprovi.",
    clientLoginNoPassword: "Nessuna password: il link nell'email è la sua chiave.",
