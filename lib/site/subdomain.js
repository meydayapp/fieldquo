...
export const RESERVED_SUBDOMAINS = new Set([
  ...
  "admin",
  "platform",
  // FieldQuo's own sales console lives at /sales and its token is scoped to
  // the apex; a tenant holding sales.fieldquo.com is the same cookie-scope
  // takeover as app. — it was claimable until the 6 September QA rerun tried.
  "sales",
  // The public help centre (help.fieldquo.com → /help/*, rewritten first in
  // middleware.js, no session). It sat in the "useful later" block below
  // until 2026-09-12; it now serves, and lib/help/host.js is what recognises
  // the host. A tenant holding it would be a phishing page in FieldQuo's own
  // name one click from every "Contact support" link.
  "help",
  "book",
  "quote",
  "q",
  ...
  "noreply",
  "no-reply",
  // Mail identities of FieldQuo's own: a tenant site at reply.fieldquo.com
  // would sit on the name a rep's reply address may carry
  // (docs/SALES-OUTREACH.md §5b), and "inbound" is the same idea.
  "reply",
  "replies",
  "inbound",
]);
