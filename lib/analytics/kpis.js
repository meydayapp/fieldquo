...
// ═══════════════════════════════════════════════════════════════════════════
//
// Four metrics a KPI dashboard is normally expected to carry, and the reason
...
//
// Rework/callback rate and change-order rate used to be on this list too.
// They moved to the QUALITY section above once JobVisit.returnReason,
// Job.originalJobId/callbackReason and the ChangeOrder model gave this file
// something honest to compute from — see docs/CALLBACKS-AND-CHANGE-ORDERS.md.
