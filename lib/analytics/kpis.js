...
// ═══════════════════════════════════════════════════════════════════════════
//
// Five metrics a KPI dashboard is normally expected to carry, and the reason
...
//
// Customer satisfaction used to be a sixth entry here ("Nothing in the
// product asks a client to rate the work. There is no survey to summarise.").
// It no longer is — see buildCsat() below and SatisfactionResponse in the
// schema, which is now what asks and what summarises.
