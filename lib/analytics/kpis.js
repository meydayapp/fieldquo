...
export const NOT_TRACKED = [
  ...
  // safetyIncidentRate is no longer here — SafetyIncident exists now, and
  // `safety.incidentRate` below is the real figure, gated at MIN_HOURS_FOR_RATE
  // hours logged (see lib/analytics/safety.js for why hours rather than a
  // count of incidents, and why this is NOT an OSHA/CNESST/WSIB rate).
  {
