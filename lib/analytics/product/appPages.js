...
export const APP_PAGES = Object.freeze([
  ...
  // The More page: the rows that are not one of the rail's seventeen, as
  // tiles. Furniture, not a feature — nothing on it is not also a row.
  { href: "/app/more", navKey: "app.nav.more", matrix: null, feature: null },
  ...
  { href: "/app/tickets", navKey: "app.nav.clientTickets", matrix: null, feature: null },
  ...
  // Daily sheets (2026-09-21) and the assignee's callback list. The list
  // has no sidebar row of its own — it is linked from Clients and from
  // Settings → Follow-ups → Past clients — so its navKey is its own title.
  { href: "/app/daily-sheets", navKey: "app.nav.dailySheets", matrix: "timesheets", feature: null },
  { href: "/app/callbacks", navKey: "app.callbacks.title", matrix: "follow_ups", feature: null },
  ...
  // The receipts book — reached from Expense Tracking, a job page and the
  // Create menu's Snap receipt, not from a rail row; labelled by its own title.
  { href: "/app/receipts", navKey: "app.receipts.title", matrix: "expenses", feature: null },
  ...
  { href: "/app/analytics/commissions", navKey: "app.commissions.reportTitle", matrix: null, feature: null },
  ...
  { href: "/app/settings/my-calendar", navKey: "app.settings.myCalendar", matrix: "scheduling", feature: null },
  ...
  { href: "/app/settings/field-work", navKey: "app.settings.fieldWork", matrix: null, feature: null },
  ...
  { href: "/app/settings/maintenance-plans", navKey: "app.settings.planTemplates", matrix: "price_book", feature: null },
  ...
  { href: "/app/settings/work-email", navKey: "app.settings.workEmail", matrix: null, feature: null },
  ...
  { href: "/app/settings/commissions", navKey: "app.settings.commissions", matrix: null, feature: null },
  ...
  // A rail row since the 2026-09-21 shell: the rail's key is the word a rep
  // should say (check-product-analytics' "navFirst" rule).
  { href: "/app/settings/ai-employee", navKey: "app.nav.aiTeam", matrix: null, feature: "ai_employee" },
