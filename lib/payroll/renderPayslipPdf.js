  ...
  return (
    ...
    >
      <Text
        style={{
          fontSize: 9.5,
          fontFamily: bold ? PDF_FONT_BOLD : PDF_FONT,
...
export async function renderPayslipPdfBuffer({ line, run, company, currency = "$" }) {
  ...
  const doc = (
    <Document title={`Payslip — ${line.workerName}`}>
      <Page size="LETTER" style={{ padding: 40, fontFamily: PDF_FONT, color: theme.ink }}>
        ...
        >
          <View style={{ flex: 1 }}>
            {company?.logoUrl ? (
              ...
              <Text style={{ fontSize: 15, fontFamily: PDF_FONT_BOLD }}>
          ...
          <View style={{ alignItems: "flex-end" }}>
            ...
            <Text style={{ fontSize: 16, fontFamily: PDF_FONT_BOLD, color: theme.accentText }}>
              Payslip
            </Text>
        ...
        >
          <Text style={{ fontSize: 12, fontFamily: PDF_FONT_BOLD, color: band.fg }}>
            {line.workerName}
          </Text>
