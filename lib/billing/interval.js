 ...
 *
 * Zero today, on purpose. Returns null when either price is missing — "we
 * cannot compare" is not "no saving", and a screen that printed "save $0"
 * because a column was blank would be inventing a statement.
 */
