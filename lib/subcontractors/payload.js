 ...
 */
// The US ways of handing a sub money are outbound too: a check, a Zelle, a
// Venmo, a Cash App, an ACH push or PayPal all mean "we paid the sub".
export const OUTBOUND_PAYMENT_METHODS = Object.freeze([
  "cash",
  "e_transfer",
  "cheque",
  "check",
