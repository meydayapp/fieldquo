...
export const NEUTRALS = {
  ...
  // ── Both are 11px TEXT, not dots ────────────────────────────────────────
  //
  // renderTemplateSections.js prints the words "Done" and "Pending" in these
  // colours at 11px. They were #2ea043 (3.37:1 on the card) and #c9bfb4
  // (1.81:1) — "Pending" was effectively invisible, and the smaller the type
  // the less a marginal ratio survives a phone screen in daylight.
  //
  // Measured against BOTH grounds this palette renders on: the white card and
  // the #F8F4EF page. 5.08:1 and 6.34:1 respectively.
  done: "#1a7f37", // completed stage label
  // Reuses `muted` above rather than inventing a second near-identical brown.
  // "Pending" is quieter than "Done" by being an unremarkable colour, not by
  // being a faint one.
  pending: "#6b5d52",
};
