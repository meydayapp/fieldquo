...
// Measured, not chosen by eye. #9ca3af — the grey both this file and
// billingEmail.js used for small print — is 2.54:1 on the white card and
// 2.33:1 on the page, against a 4.5:1 requirement. That put "copy and paste
// this link if the button doesn't work" in the least legible type in the
// message: the one line a reader needs precisely when something has already
// gone wrong for them.
//
// #595f6b is 6.41:1 on the card and 5.88:1 on the page. Still visibly quieter
// than the body text, which is the whole job of a faint colour.
const FAINT = "#595f6b";
