...
// Where each trade LIVES — its street, its tax, its clients' streets, what it
// buys — is the sibling table in lib/demo/profiles.js, keyed the same way.
 ...
 *
 * `pitchTrade` is the lib/sales/discovery/trades.js key whose selling points
 * (lib/sales/tradeSellingPoints.js) the rep's demo card lists as "what to
 * show them" — so the demo is walked in the same three-point order the call
 * and the email pitched. A string, not an import: this file stays pure and
...
export const INDUSTRIES = {
  ...
  cabinets: {
    ...
    // The help-centre screenshots are photographed around this shop
    // (docs/screens/app-guide/harness/fixtures/company.js), so the live demo
    // carries the same name — a guide and a demo should tell one story.
    company: "Érable Design Cabinetry",
