      ...
      ...(st.aiReview
        ? {
            aiReview: {
              ...
              checks: [
                {
                  ...
                  detail: `"${items[0].name}" — only the name reaches the client, and there is no scope paragraph above it to say what is done. A sentence on what is done, per what unit, is what they judge the price against.`,
                },
                {
                  id: "no_photos",
                  severity: "low",
              ...
              addOns: [
                {
                  description: `Extended warranty — ${items[0].name.toLowerCase()}`,
