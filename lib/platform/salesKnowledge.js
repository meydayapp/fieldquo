...
export const SPOKEN_FEATURE_LINES = Object.freeze({
  ...
  marketing_designer:
    "A drag-and-drop design canvas for social posts and ads, sized for every " +
    "platform automatically, with ready-made templates and stock photos " +
    "built in. AI image generation and background removal are available " +
    "inside it too.",
});
