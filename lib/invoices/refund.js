...
export async function issueRefund(
  ...
  // Money went back to the client, so the commission earned on it comes back
  // too — a negative ledger row, see lib/commissions/sync.js.
  await syncCommissionsForInvoice(db, latest.id);
