    ...
    void db.staffRoom
      .findUnique({
        ...
        select: {
          name: true,
          kind: true,
          members: { where: { open: true }, select: { platformAdminId: true, salesRepId: true, lastSeenAt: true, open: true } },
        },
      })
      .then((room) => {
        if (!room) return;
 ...
 * they are looking at it (lastSeenAt within the last half minute; see
