 ...
 *
 * Lives in lib/staff/teams.js now, and is about EVERYBODY rather than the
 * viewer — see that file's header for the production state that forced the
 * change (a "Sales" room with no members, at a demo). Kept under this name so
 * the route reads the same.
 */
