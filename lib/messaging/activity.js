...
export const ACTIVITY_TYPES = Object.freeze([
  ...
  "snoozed",
  "unsnoozed",
  // The shared SMS line: this phone is on file at more than one company, so
  // the text was filed here AND at the others, and no automatic reply went
  // out from any of them (lib/aiEmployee/smsChannel.js). Written so a person
  // reading the thread knows why the employee stayed quiet.
  "shared_line",
]);
...
export function activityLabel(activity) {
  ...
  switch (activity.type) {
    ...
    case "shared_line":
      // Never "by" anybody — the line itself is the actor.
      return { key: "app.messages.activity.shared_line", params: {} };
    default:
