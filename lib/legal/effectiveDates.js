...
export const PRIVACY_POLICY_EFFECTIVE_DATE = "2026-09-20";
...
// The data-deletion page is the same kind of thing as the security page: not
// a contract term, but a set of claims about what FieldQuo can and cannot
// erase today. Those claims change the moment account deletion ships, and
// this date is what tells a reader whether they are reading the version from
// before or after that.
// 2026-09-08: the request form, the reference and status line, the 30
// business-day manual-deletion promise, and Meta's deletion callback were
// added. The version Meta's reviewer read before that date said "no form".
export const DATA_DELETION_PAGE_UPDATED_DATE = "2026-09-08";
