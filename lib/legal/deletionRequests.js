...
//
// ══ This is the RESPONSE promise, not the deletion promise ═══════════════
//
// Since 2026-09-08 the page makes two: a person answers an emailed request
// within this many days, and the owner carries the deletion OUT within
// DELETION_BUSINESS_DAYS (lib/dataDeletion/constants.js) — a number the owner
// set, in business days. Requests made through the page's form are answered
// automatically the moment they land, so this constant only governs the
// plain-email path. Keep the two apart: one is how fast we reply, the other
// is how long the work may take.
