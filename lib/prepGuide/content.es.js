...
export const GUIDES_ES = {
  ...
  // ── Los oficios del 2026-09-21 ────────────────────────────────────────────
  // Ver content.en.js: la iluminación usa la guía `electrical`; los otros
  // quince tienen su propia lista.

  air_duct_cleaning: {
    checklist: [
      "Despeje el acceso a cada rejilla de suministro y de retorno de la casa — quite muebles, alfombras y cajas de las rejillas del piso y apártelos de las rejillas de pared y techo.",
      "Despeje la zona alrededor del calefactor o de la unidad de aire — un metro libre por cada lado y un paso desde la puerta, porque ahí se conecta la aspiradora.",
      "Cuéntenos lo que debamos saber de los ductos — una remodelación reciente, un olor, moho que haya visto, o una habitación a la que nunca llega aire.",
      "Cubra o guarde lo delicado cerca de las rejillas — el polvo se contiene, pero al abrir una rejilla puede soltarse algo.",
      "Mascotas — manténgalas en una habitación lejos de las rejillas que se trabajan; el equipo es ruidoso y hay mangueras por la casa.",
    ],
    warning:
      "La calefacción o el aire acondicionado estarán apagados toda la visita. Una rejilla tapada por algo que no se puede mover no se puede limpiar — avísenos antes de que lleguemos si hay muebles empotrados sobre rejillas.",
    dayOf: [
      "Primero inspeccionamos el sistema, sellamos las rejillas, conectamos la aspiradora a la unidad de aire y limpiamos cada ducto con cepillos y aire. Le mostramos el antes y el después donde los ductos se pueden fotografiar.",
      "Al final se cambia o limpia el filtro, y el sistema se pone en marcha antes de irnos.",
    ],
    afterCare:
      "Cambie el filtro según el calendario que le damos — un ducto limpio detrás de un filtro sucio no se mantiene limpio. Avísenos si un olor o el polvo vuelven poco después de la visita.",
  },

  deck_patio: {
    checklist: [
      "Despeje por completo la terraza o el patio — muebles, parrilla, macetas, tapetes y todo lo guardado debajo.",
      "Abra los portones laterales y despeje un paso desde la entrada hasta el fondo — por ahí pasan materiales y herramientas.",
      "Saque los autos de la entrada si le dijimos que la entrega llega ahí.",
      "Apague los aspersores cerca de la zona de trabajo, y avísenos de líneas enterradas — riego, cables de iluminación, la línea de gas de la parrilla.",
      "Mascotas y niños — manténgalos lejos de la zona de trabajo, y adentro mientras cortamos y construimos.",
    ],
    warning:
      "La terraza o el patio no se pueden usar desde que empieza el trabajo hasta que lo entregamos — incluida cualquier puerta que dé a ellos. Planee otra forma de entrar y salir de la casa, y mantenga a los niños lejos de zapatas abiertas y tablas sueltas.",
    dayOf: [
      "Confirmamos el trazado y las alturas con usted antes de cortar o excavar nada. Primero se retira la superficie vieja si su cotización lo incluye; la nueva se construye según el plano de su cotización.",
      "Cuando se requiere permiso o inspección, le decimos qué sigue y cuándo.",
    ],
    afterCare:
      "No pise concreto nuevo ni un acabado fresco durante el tiempo que le indiquemos. Una terraza de madera necesita mantener su acabado protector; pregúntenos cuándo toca la primera capa nueva.",
  },

  doors_windows: {
    checklist: [
      "Despeje un metro por dentro y por fuera de cada puerta o ventana que se reemplaza — muebles, plantas, todo lo que haya en el alféizar.",
      "Descuelgue cortinas, persianas, barras y cubiertas de las aberturas que se trabajan; no podemos quitarlas sin riesgo de dañarlas.",
      "Quite lo frágil de las paredes alrededor de las aberturas — cuadros y repisas — porque sacar un marco hace vibrar la pared.",
      "Abra los portones y despeje un paso por fuera hasta las aberturas, incluida cualquier ventana de planta baja a la que lleguemos con escalera.",
      "Mascotas — manténgalas en una habitación cerrada; la casa tendrá huecos abiertos en las paredes parte del día.",
    ],
    warning:
      "Cada abertura queda expuesta al clima mientras se saca la unidad vieja y se coloca la nueva. No empezamos una abertura que no podamos cerrar el mismo día, y con mal tiempo quizá reprogramemos — se lo diremos lo antes posible.",
    dayOf: [
      "Confirmamos cada abertura y el orden del trabajo con usted, protegemos los pisos, sacamos la unidad vieja, instalamos, aislamos y sellamos la nueva, y comprobamos que cada puerta y ventana abra, cierre y trabe.",
      "Las unidades viejas y el embalaje se van con nosotros.",
    ],
    afterCare:
      "Deje que las molduras, la pintura y el sellador se asienten durante el tiempo que le indiquemos antes de limpiar alrededor. Avísenos si una puerta roza, una ventana se atasca o nota una corriente de aire — el ajuste es parte del trabajo.",
  },

  security_systems: {
    checklist: [
      "Díganos dónde quiere cada cámara, sensor, teclado y sirena — recorra la casa con una lista, o la recorremos juntos al llegar.",
      "Tenga a mano el nombre y la contraseña de su red Wi-Fi, y el router accesible — la mayoría de los paneles y cámaras se conectan a ella.",
      "Si ya tiene una alarma, busque el código de instalador o maestro y el nombre y número de cuenta de la empresa de monitoreo, y avísele que habrá trabajos.",
      "Despeje el acceso al panel eléctrico, al router, a los lugares donde irán el panel y los teclados, y al ático o sótano si los cables pasan por ahí.",
      "Mantenga a las mascotas fuera de las habitaciones en obra — y díganos qué mascotas estarán en casa con el sistema armado, para elegir sensores de movimiento adecuados.",
    ],
    warning:
      "Sin los códigos del sistema existente, puede que haya que reemplazar un panel viejo en lugar de reutilizarlo, y una alarma que se dispare durante el trabajo avisará a la empresa de monitoreo. Tenga los códigos, o díganos que no los tiene, antes de que lleguemos.",
    dayOf: [
      "Instalamos el equipo donde acordamos, lo conectamos y probamos cada sensor, cámara y sirena con usted. Configuramos la app en su teléfono y le mostramos cómo armar, desarmar y cancelar una falsa alarma.",
    ],
    afterCare:
      "Elija códigos que solo conozca su hogar, y déselos solo a quien los necesite. Avísenos si un sensor se dispara una y otra vez, si una cámara se desconecta o si la app deja de enviar alertas.",
  },

  sewer_septic: {
    checklist: [
      "Marque o descubra las tapas de la fosa séptica o el registro del drenaje si sabe dónde están — y díganos si no lo sabe; los planos de la propiedad o una factura anterior suelen indicarlo.",
      "Despeje el terreno sobre la fosa y el camino hasta ella — vehículos, cosas guardadas, cualquier cosa construida o plantada sobre las tapas.",
      "Deje libre la entrada para el camión, y avísenos de lo que un vehículo pesado no debe pisar — el campo de drenaje, una tubería séptica, un césped blando.",
      "Cuéntenos lo que ha notado — desagües lentos, gorgoteos, olores, suelo húmedo o pasto muy verde sobre el campo.",
      "Mantenga a mascotas y niños lejos de las tapas abiertas y de cualquier excavación.",
    ],
    warning:
      "Limite el uso de agua — sin lavadora, lavavajillas ni duchas largas — el día de la visita, y después durante el tiempo que le indiquemos si el trabajo lo requiere. Una fosa o tubería que se llena mientras trabajamos es un peligro y retrasa el trabajo.",
    dayOf: [
      "Localizamos y abrimos la fosa o el registro, bombeamos, limpiamos o inspeccionamos la tubería según el plan de su cotización, y le decimos lo que encontramos — el estado de los deflectores, el nivel, lo que necesita atención. Si su cotización incluye inspección con cámara, se la mostramos.",
      "Las tapas se cierran y aseguran antes de irnos.",
    ],
    afterCare:
      "Por el inodoro solo va papel higiénico — las toallitas llamadas desechables, la grasa y los químicos acortan la vida del sistema. No deje que los vehículos pisen la fosa ni el campo, y pregúntenos cuándo toca el próximo bombeo.",
  },

  smart_home: {
    checklist: [
      "Tenga a mano el nombre y la contraseña de su red Wi-Fi, y el router accesible — casi todo lo que instalamos se conecta a ella.",
      "Tenga el equipo en casa si lo pone usted — televisor, bocinas, centrales, interruptores inteligentes — sin abrir, con todas sus piezas y controles.",
      "Decida dónde va cada pantalla, bocina y aparato, y la altura de un televisor en la pared; la confirmamos con usted antes de perforar.",
      "Despeje las paredes y la zona donde se montarán o cablearán los aparatos, y denos acceso al ático o sótano si los cables pasan por ahí.",
      "Tenga a mano los datos de acceso de sus cuentas de video, música y domótica — solo podemos vincular lo que usted pueda abrir.",
    ],
    warning:
      "Una pantalla en la pared necesita la pared adecuada detrás. Si no encontramos una fijación sólida donde la quiere, le propondremos el lugar seguro más cercano en vez de colgarla de todos modos. Un equipo que pone usted y al que le falta una pieza o un control no se puede terminar ese día.",
    dayOf: [
      "Confirmamos las ubicaciones con usted, montamos y cableamos, conectamos todo a la red, configuramos las apps y los controles, y le mostramos cómo funciona todo junto antes de irnos.",
      "El embalaje se va con nosotros.",
    ],
    afterCare:
      "Guarde juntos manuales y recibos para las garantías. Si algo se desconecta de la red tras cambiar el router o un corte de luz, avísenos antes de restablecerlo — restablecer a menudo obliga a configurarlo de nuevo.",
  },

  solar_energy: {
    checklist: [
      "Despeje el acceso a su panel eléctrico y al lugar donde irá el inversor, la batería o el cargador — un metro libre delante de cada uno.",
      "Saque los autos del garaje o de la entrada donde irá el cargador, y deje libre la entrada el día de la instalación para los materiales y la plataforma.",
      "Despeje la trampilla del ático y un paso hasta ella si tenemos que llegar a la parte inferior del techo.",
      "Háblenos del techo — su antigüedad, cualquier gotera conocida, si hay un reemplazo previsto; los paneles deben ir sobre un techo que dure más que ellos.",
      "Mantenga a mascotas y niños adentro y lejos del contorno de la casa mientras estamos en el techo, y lejos del panel mientras esté abierto.",
    ],
    warning:
      "La corriente estará cortada parte de la visita mientras conectamos al panel. El sistema no se puede encender hasta que la compañía eléctrica y, si hace falta, el inspector lo aprueben — le diremos qué falta y no encenderemos nada antes.",
    dayOf: [
      "Confirmamos el trazado con usted, montamos y cableamos el equipo de su cotización, lo conectamos al panel y lo probamos. Le mostramos la app o la pantalla, y cómo apagar el sistema.",
      "Cuando se necesita inspección o aprobación de la compañía eléctrica, le decimos qué sigue y cuándo.",
    ],
    afterCare:
      "No encienda el sistema usted mismo antes de que le confirmemos la aprobación. Mantenga los paneles libres de ramas, y avísenos si la producción baja en la app o si un cargador deja de cargar.",
  },

  moving: {
    checklist: [
      "Empaque todo lo que va en cajas antes de que lleguemos, salvo que su cotización incluya el empaque — cierre cada caja y rotúlela con la habitación de destino.",
      "Aparte lo que se queda o viaja con usted — documentos, medicamentos, llaves, joyas, objetos de valor — en su auto o en una habitación marcada donde no entraremos.",
      "Reserve estacionamiento o una zona de carga en ambas direcciones, y el elevador en un edificio, para el horario de la mudanza.",
      "Vacíe, descongele y seque el congelador y el refrigerador, drene las mangueras de la lavadora y desconecte lo que requiera un técnico para reconectar.",
      "Avísenos antes del día, no ese mismo día, de todo lo muy pesado, frágil o valioso — un piano, una caja fuerte, vidrio, arte.",
    ],
    warning:
      "Lo que no esté empacado cuando lleguemos hay que empacarlo antes de moverlo, y ese tiempo se cobra. Los materiales peligrosos — combustible, propano, diluyente de pintura, municiones — no pueden viajar en el camión; busque otra forma de llevarlos.",
    dayOf: [
      "Primero recorremos todo con usted, protegemos pisos, marcos de puertas y barandales, cargamos en el orden que mejor se descarga, y colocamos cada caja y cada mueble en la habitación que usted elija en el destino.",
      "Volvemos a armar lo que desarmamos si su cotización lo incluye.",
    ],
    afterCare:
      "Revise todo antes de que nos vayamos y avísenos de cualquier daño ese mismo día — es cuando se puede resolver. Guarde el inventario que le damos hasta terminar de desempacar.",
  },

  wildlife_control: {
    checklist: [
      "No tape ni selle el hueco que cree que usa el animal antes de que lleguemos — un animal encerrado dentro de la casa, o separado de sus crías, es el problema más difícil.",
      "Despeje el acceso a donde lo ha oído o visto — la trampilla del ático, el entrepiso, el garaje, debajo de la terraza — y un paso hasta ahí.",
      "Cuéntenos lo que ha notado y cuándo — rasguños al anochecer, excrementos, un olor, un hueco — y si puede haber crías.",
      "Mantenga a las mascotas adentro, y a los niños lejos de las trampas, las aberturas y cualquier animal que encontremos.",
      "Guarde la comida de mascotas, las semillas para pájaros y la basura de afuera; atraen más animales mientras trabajamos.",
    ],
    warning:
      "No intente agarrar, acorralar ni alimentar al animal. Un animal salvaje que se defiende, o defiende a sus crías, puede morder, y algunos transmiten enfermedades. Si uno entra a la zona habitada antes de que lleguemos, cierre la puerta de esa habitación y llámenos.",
    dayOf: [
      "Primero inspeccionamos, le mostramos por dónde entra el animal, y lo retiramos o excluimos según el plan de su cotización y las normas locales de fauna. Las trampas y puertas de un solo sentido van rotuladas; por favor no las mueva.",
      "Los puntos de entrada se sellan cuando el animal y sus crías ya salieron — nunca antes.",
    ],
    afterCare:
      "Avísenos de inmediato si vuelve a oír actividad después de sellar las aberturas. Mantenga bien cerradas la basura, la composta y la comida de mascotas — es lo que los atrajo la primera vez.",
  },

  caulking_sealants: {
    checklist: [
      "Díganos cada junta que quiere rehacer — tina, ducha, lavabo, ventanas, revestimiento exterior — y recórralas con nosotros al llegar.",
      "Despeje la zona alrededor de cada junta — artículos de baño fuera de la ducha y del borde de la tina, cortinas y objetos lejos de las ventanas, y un paso por fuera hacia las juntas exteriores.",
      "Mantenga secas las juntas antes de que lleguemos — nada de ducha ni baño justo antes en esa habitación.",
      "Avísenos de cualquier fuga, mancha o moho que haya visto detrás o debajo de una junta; el sellador puede ser un síntoma y no la causa.",
      "Mantenga a las mascotas lejos del sellador fresco — las patas dejan marcas que se quedan.",
    ],
    warning:
      "La ducha o la tina que se vuelve a sellar no se puede usar hasta que el sellador nuevo cure — le decimos cuánto tiempo para el producto usado. El agua sobre un cordón fresco lo arruina y hay que rehacer la junta.",
    dayOf: [
      "Retiramos el sellador viejo, limpiamos y secamos la junta, tratamos el moho al que lleguemos y aplicamos un cordón nuevo. Le decimos cuándo puede mojarse cada junta.",
    ],
    afterCare:
      "Mantenga las juntas secas y sin tocar durante el tiempo que le indiquemos. Seque la tina y la ducha de vez en cuando; el agua estancada acorta la vida de un cordón. Avísenos si una junta se despega o se decolora antes de tiempo.",
  },

  furniture_upholstery: {
    checklist: [
      "Díganos qué muebles se trabajan y dónde están, y despeje un paso desde la puerta si vamos a recogerlos.",
      "Vacíe cajones, cojines y rincones — monedas, controles y objetos pequeños en las costuras se pierden o dañan el trabajo.",
      "Tenga lista la tela o el material si lo pone usted, en cantidad suficiente — confirmamos la cantidad con usted antes.",
      "Cuéntenos la historia del mueble — reparaciones anteriores, manchas y su causa, mascotas que lo usan, y cualquier detalle de valor sentimental que debamos conservar.",
      "Mantenga a las mascotas lejos del mueble mientras trabajamos, y hasta que la limpieza o el acabado se hayan secado.",
    ],
    warning:
      "Algunas manchas y reparaciones antiguas no se pueden revertir del todo, y un mueble antiguo puede esconder bajo su tapizado daños que solo vemos al abrirlo. Se lo decimos antes de seguir, con el costo, no después.",
    dayOf: [
      "Revisamos el mueble con usted y confirmamos el trabajo de su cotización. El trabajo en su casa se hace sobre pisos protegidos; los muebles que llevamos van envueltos y etiquetados con su nombre, y le decimos cuándo esperarlos de vuelta.",
    ],
    afterCare:
      "No use un mueble limpiado o restaurado durante el tiempo que le indiquemos, y manténgalo lejos del sol directo si puede. Avísenos si una costura, un resorte o un acabado da problemas antes de tiempo.",
  },

  glass: {
    checklist: [
      "Despeje un metro alrededor de cada vidrio, espejo o cancel que se trabaja, por dentro y por fuera — muebles, plantas, artículos de baño, todo lo que haya en un alféizar o repisa.",
      "Descuelgue cortinas, persianas y todo lo que cuelgue cerca del vidrio.",
      "Despeje un paso directo desde la puerta hasta el trabajo — el vidrio llega en piezas grandes y pesadas.",
      "Avísenos si alguna abertura parece distinta de la que medimos, o si una grieta se ha extendido desde entonces.",
      "Mantenga a mascotas y niños fuera de la zona — el vidrio roto se retira en pedazos, y un fragmento puede saltar.",
    ],
    warning:
      "Nadie debe estar cerca del vidrio mientras se retira o se coloca. Si un vidrio ya está roto, cierre el paso a la zona y deje los pedazos donde están para nosotros — no intente sacarlos.",
    dayOf: [
      "Protegemos el entorno, retiramos el vidrio viejo, limpiamos el marco, y colocamos y sellamos el vidrio nuevo. Una puerta o cancel de ducha se ajusta hasta que cierre y selle bien.",
      "El vidrio roto y el embalaje se van con nosotros, y aspiramos la zona antes de irnos.",
    ],
    afterCare:
      "No use un cancel de ducha nuevo, ni limpie alrededor del sellador nuevo, durante el tiempo que le indiquemos. Quite la película protectora cuando le digamos. Avísenos de inmediato de una fuga, un roce o una corriente de aire.",
  },

  marine_services: {
    checklist: [
      "Díganos exactamente dónde estará la embarcación — la marina, el número de amarre, dónde está el remolque — y organice nuestro acceso con la marina o la entrada.",
      "Retire objetos personales, equipo y objetos de valor de las zonas de trabajo — la cabina, los cofres, el compartimento del motor.",
      "Tenga las llaves, la bitácora y los registros de mantenimiento a bordo o con usted, y díganos qué se hizo recientemente.",
      "Cuéntenos lo que ha notado — un ruido, una fuga, una luz de aviso, un cambio en cómo navega.",
      "Asegúrese de que podamos llegar a la embarcación con seguridad — en un remolque calzado, o amarrada con toma de corriente en el muelle si el trabajo la necesita.",
    ],
    warning:
      "Si al llegar no podemos alcanzar la embarcación o subir a bordo — la entrada cerrada, un amarre distinto del indicado, la marina no nos autorizó — la visita no puede hacerse y puede cobrarse igual. Revise el acceso el día anterior.",
    dayOf: [
      "Primero inspeccionamos, confirmamos con usted el trabajo y el costo, luego hacemos el trabajo de su cotización y probamos lo que tocamos — en el agua cuando hace falta y es seguro.",
      "Dejamos una nota de lo que se hizo y de lo que requerirá atención después.",
    ],
    afterCare:
      "Ponga en marcha el motor y los sistemas que trabajamos en su próxima salida y avísenos de cualquier cambio. Guarde nuestros registros con la bitácora de la embarcación; cuentan al venderla.",
  },

  home_organization: {
    checklist: [
      "Díganos qué habitaciones o espacios trabajamos y qué no funciona hoy — lo que no encuentra, lo que no cabe, cómo usa la habitación.",
      "Decida de antemano de qué está dispuesto a desprenderse, o reserve tiempo para decidirlo con nosotros ese día — ordenar es más rápido cuando quien decide está en casa.",
      "Aparte todo lo privado, valioso o que no debe tocarse — documentos, medicamentos, joyas — en un lugar donde no trabajaremos.",
      "Tenga listas bolsas o cajas para donar y desechar, y díganos a dónde van después si su cotización no incluye llevárnoslas.",
      "Despeje un paso hasta el espacio, y lugar para estacionar nuestro vehículo si traemos productos o muebles.",
    ],
    warning:
      "Nada se tira ni se dona sin su permiso. Si quien decide no está disponible ese día, solo podemos ordenar, no retirar, y el tiempo se cobra igual.",
    dayOf: [
      "Partimos del espacio tal como está, clasificamos todo con usted entre conservar, donar y desechar, y luego armamos la nueva distribución, los organizadores y las etiquetas de su cotización. Si su cotización incluye diseño, repasamos el plan con usted antes de comprar o mover nada.",
    ],
    afterCare:
      "Devuelva cada cosa a donde indica su etiqueta. Un espacio se mantiene ordenado cuando cada objeto nuevo tiene su lugar — avísenos si un sistema deja de funcionarle con el tiempo y lo ajustamos.",
  },

  baby_proofing: {
    checklist: [
      "Recorra la casa con nosotros, o díganos antes, dónde pasa el tiempo el bebé y a qué llegará pronto — escaleras, cocina, baño, alberca.",
      "Despeje las zonas de trabajo — alrededor de las escaleras, gabinetes y cajones, los muebles que se fijarán a la pared y las ventanas.",
      "Vacíe la parte de arriba de los muebles que se fijarán a la pared, y sepárelos un poco para que alcancemos la parte de atrás.",
      "Tenga en casa los productos que pone usted, sin abrir, con todas sus piezas — rejas, seguros, anclajes, tapas.",
      "Díganos de qué material son los postes de la escalera y las paredes donde irán las rejas — una reja necesita una fijación sólida, no solo tablaroca.",
    ],
    warning:
      "Los productos de seguridad solo funcionan instalados según las instrucciones del fabricante. Si un producto que pone usted no sirve para su escalera o su puerta, se lo diremos en vez de instalarlo de todos modos, y le sugeriremos lo que sí sirve.",
    dayOf: [
      "Confirmamos la lista con usted, instalamos y probamos cada reja, seguro, anclaje y tapa, y enseñamos a cada adulto de la casa a abrirlos.",
    ],
    afterCare:
      "Revise rejas y seguros de vez en cuando — los tornillos se aflojan y los niños aprenden. Avísenos cuando el bebé empiece a trepar o a abrir cosas; la lista cambia a medida que crece.",
  },
};
