...
export const GUIDES_FR = {
  ...
  // ── Les métiers du 2026-09-21 ─────────────────────────────────────────────
  // Voir content.en.js : l'éclairage utilise le guide `electrical`, les quinze
  // autres ont leur propre liste.

  air_duct_cleaning: {
    checklist: [
      "Dégagez l'accès à chaque bouche de soufflage et de reprise de la maison — retirez meubles, tapis et boîtes des grilles au sol, et éloignez-les des grilles murales et au plafond.",
      "Dégagez la zone autour de la fournaise ou de l'appareil de traitement d'air — un mètre libre de chaque côté et un passage depuis la porte, car c'est là que l'aspirateur se raccorde.",
      "Signalez-nous tout ce que nous devrions savoir sur les conduits — une rénovation récente, une odeur, de la moisissure aperçue, ou une pièce où l'air n'arrive jamais.",
      "Couvrez ou rangez les objets délicats près des bouches — la poussière est contenue, mais l'ouverture d'une grille peut en libérer un peu.",
      "Animaux — gardez-les dans une pièce loin des bouches traitées ; l'équipement est bruyant et des boyaux traversent la maison.",
    ],
    warning:
      "Le chauffage ou la climatisation est coupé pendant toute la visite. Une bouche bloquée par un élément impossible à déplacer ne peut pas être nettoyée — signalez-nous les meubles encastrés au-dessus des bouches avant notre arrivée.",
    dayOf: [
      "Nous inspectons d'abord le système, scellons les grilles, raccordons l'aspirateur à l'appareil de traitement d'air, puis nettoyons chaque conduit à la brosse et à l'air. Nous vous montrons l'avant et l'après là où les conduits peuvent être photographiés.",
      "Le filtre est remplacé ou nettoyé à la fin, et le système est remis en marche avant notre départ.",
    ],
    afterCare:
      "Changez le filtre selon le calendrier que nous vous donnons — un conduit propre derrière un filtre sale ne reste pas propre. Dites-nous si une odeur ou de la poussière revient peu après la visite.",
  },

  deck_patio: {
    checklist: [
      "Videz complètement la terrasse ou le patio — meubles, barbecue, jardinières, tapis et tout ce qui est rangé dessous.",
      "Déverrouillez les barrières latérales et dégagez un passage de l'entrée jusqu'à l'arrière — les matériaux et les outils passent par là.",
      "Sortez les voitures de l'entrée si nous vous avons dit que la livraison s'y fera.",
      "Coupez l'arrosage près de la zone de travail, et signalez-nous les conduites enfouies — irrigation, câbles d'éclairage, conduite de gaz du barbecue.",
      "Animaux et enfants — gardez-les loin de la zone de travail, et à l'intérieur pendant la coupe et la construction.",
    ],
    warning:
      "La terrasse ou le patio est inutilisable dès le début des travaux jusqu'à la remise — y compris toute porte qui y donne. Prévoyez un autre accès à la maison, et gardez les enfants loin des fondations ouvertes et des planches non fixées.",
    dayOf: [
      "Nous confirmons l'implantation et les hauteurs avec vous avant de couper ou de creuser quoi que ce soit. L'ancien revêtement est retiré d'abord si votre soumission l'inclut ; le nouveau est construit selon le plan de votre soumission.",
      "Quand un permis ou une inspection est requis, nous vous disons la suite et quand.",
    ],
    afterCare:
      "Ne marchez pas sur un béton neuf ou une finition fraîche pendant le temps que nous vous indiquons. Une terrasse en bois demande que sa finition protectrice soit entretenue ; demandez-nous quand la première nouvelle couche est due.",
  },

  doors_windows: {
    checklist: [
      "Dégagez un mètre à l'intérieur et à l'extérieur de chaque porte ou fenêtre remplacée — meubles, plantes, tout ce qui est sur le rebord.",
      "Décrochez rideaux, stores, tringles et habillages des ouvertures concernées ; nous ne pouvons pas les retirer sans risquer de les abîmer.",
      "Retirez les objets fragiles des murs autour des ouvertures — cadres et étagères — car retirer un châssis fait vibrer le mur.",
      "Déverrouillez les barrières et dégagez un passage extérieur jusqu'aux ouvertures, y compris les fenêtres du rez-de-chaussée atteintes à l'échelle.",
      "Animaux — gardez-les dans une pièce fermée ; la maison aura des ouvertures dans ses murs pendant une partie de la journée.",
    ],
    warning:
      "Chaque ouverture est exposée aux intempéries pendant que l'ancienne unité est retirée et la nouvelle posée. Nous ne commençons pas une ouverture que nous ne pouvons pas refermer le jour même, et par mauvais temps nous pourrions reporter — nous vous le dirons le plus tôt possible.",
    dayOf: [
      "Nous confirmons chaque ouverture et l'ordre des travaux avec vous, protégeons les planchers, retirons l'ancienne unité, posons, isolons et scellons la nouvelle, puis vérifions que chaque porte et fenêtre s'ouvre, se ferme et se verrouille.",
      "Les anciennes unités et les emballages partent avec nous.",
    ],
    afterCare:
      "Laissez les moulures, la peinture et le calfeutrage se stabiliser pendant le temps que nous vous indiquons avant de nettoyer autour. Dites-nous si une porte frotte, si une fenêtre coince ou si vous sentez un courant d'air — l'ajustement fait partie du travail.",
  },

  security_systems: {
    checklist: [
      "Indiquez-nous où vous voulez chaque caméra, détecteur, clavier et sirène — faites le tour de la maison avec une liste, ou nous le ferons avec vous à l'arrivée.",
      "Ayez le nom et le mot de passe de votre réseau Wi-Fi, et un routeur accessible — la plupart des centrales et des caméras s'y connectent.",
      "Si vous avez déjà une alarme, retrouvez le code installateur ou maître, le nom de la centrale de surveillance et votre numéro de compte, et prévenez-la que des travaux ont lieu.",
      "Dégagez l'accès au panneau électrique, au routeur, aux emplacements de la centrale et des claviers, et au grenier ou au sous-sol si les câbles y passent.",
      "Gardez les animaux hors des pièces en travaux — et dites-nous quels animaux seront à la maison une fois le système armé, pour choisir des détecteurs de mouvement adaptés.",
    ],
    warning:
      "Sans les codes du système existant, une ancienne centrale devra peut-être être remplacée plutôt que reprise, et une alarme déclenchée pendant les travaux alertera la centrale de surveillance. Ayez les codes, ou dites-nous que vous ne les avez pas, avant notre arrivée.",
    dayOf: [
      "Nous installons l'équipement aux endroits convenus, le raccordons et testons chaque détecteur, caméra et sirène avec vous. Nous configurons l'application sur votre téléphone et vous montrons comment armer, désarmer et annuler une fausse alarme.",
    ],
    afterCare:
      "Choisissez des codes que seul votre foyer connaît, et ne les donnez qu'aux personnes qui en ont besoin. Dites-nous si un détecteur se déclenche sans cesse, si une caméra se déconnecte ou si l'application n'envoie plus d'alertes.",
  },

  sewer_septic: {
    checklist: [
      "Repérez ou dégagez les couvercles de la fosse septique ou le regard de nettoyage de l'égout si vous savez où ils sont — et dites-nous si vous ne le savez pas ; les documents de la propriété ou une ancienne facture l'indiquent souvent.",
      "Dégagez le sol au-dessus de la fosse et le chemin pour y accéder — véhicules, objets entreposés, tout ce qui est construit ou planté sur les couvercles.",
      "Gardez l'entrée libre pour le camion, et signalez-nous ce sur quoi un véhicule lourd ne doit pas rouler — le champ d'épuration, une conduite septique, une pelouse détrempée.",
      "Dites-nous ce que vous avez remarqué — drains lents, gargouillements, odeurs, sol humide ou herbe très verte au-dessus du champ.",
      "Gardez animaux et enfants loin des couvercles ouverts et de toute excavation.",
    ],
    warning:
      "Limitez la consommation d'eau — pas de lessive, de lave-vaisselle ni de longues douches — le jour de la visite, puis pendant le temps que nous vous indiquons si les travaux l'exigent. Une fosse ou une conduite qui se remplit pendant que nous y travaillons est un danger et ralentit le travail.",
    dayOf: [
      "Nous localisons et ouvrons la fosse ou le regard, puis vidangeons, nettoyons ou inspectons la conduite selon le plan de votre soumission, et vous disons ce que nous avons trouvé — l'état des chicanes, le niveau, ce qui demande attention. Si votre soumission inclut une inspection par caméra, nous vous la montrons.",
      "Les couvercles sont refermés et fixés avant notre départ.",
    ],
    afterCare:
      "Seul le papier hygiénique va dans la toilette — les lingettes dites jetables, les graisses et les produits chimiques raccourcissent la vie du système. Gardez les véhicules hors de la fosse et du champ, et demandez-nous quand la prochaine vidange est due.",
  },

  smart_home: {
    checklist: [
      "Ayez le nom et le mot de passe de votre réseau Wi-Fi, et un routeur accessible — presque tout ce que nous installons s'y connecte.",
      "Ayez l'équipement sur place si vous le fournissez — téléviseur, haut-parleurs, concentrateurs, interrupteurs intelligents — non ouvert, avec toutes ses pièces et télécommandes.",
      "Décidez où va chaque écran, haut-parleur et appareil, et la hauteur d'un téléviseur fixé au mur ; nous la confirmons avec vous avant de percer.",
      "Dégagez les murs et la zone où les appareils seront fixés ou câblés, et donnez-nous accès au grenier ou au sous-sol si des câbles y passent.",
      "Ayez sous la main les identifiants de vos comptes de diffusion, de musique et de domotique — nous ne pouvons relier que ce à quoi vous pouvez vous connecter.",
    ],
    warning:
      "Un écran fixé au mur a besoin d'un mur adapté derrière lui. Si nous ne trouvons pas de fixation solide à l'endroit voulu, nous proposerons l'endroit sûr le plus proche plutôt que de l'accrocher quand même. Un équipement fourni par vous à qui il manque une pièce ou une télécommande ne peut pas être terminé le jour même.",
    dayOf: [
      "Nous confirmons les emplacements avec vous, fixons et câblons, connectons tout au réseau, configurons les applications et les télécommandes, et vous montrons comment tout fonctionne ensemble avant de partir.",
      "Les emballages partent avec nous.",
    ],
    afterCare:
      "Gardez manuels et reçus ensemble pour les garanties. Si un appareil se déconnecte après un changement de routeur ou une panne de courant, dites-le-nous avant de le réinitialiser — une réinitialisation oblige souvent à tout reconfigurer.",
  },

  solar_energy: {
    checklist: [
      "Dégagez l'accès à votre panneau électrique et à l'emplacement de l'onduleur, de la batterie ou de la borne — un mètre libre devant chacun.",
      "Sortez les voitures du garage ou de l'entrée où va la borne, et libérez l'entrée le jour de l'installation pour les matériaux et la nacelle.",
      "Dégagez la trappe du grenier et un passage jusqu'à elle si nous devons atteindre le dessous du toit.",
      "Parlez-nous du toit — son âge, une fuite connue, un remplacement prévu ; des panneaux doivent être posés sur un toit qui durera plus longtemps qu'eux.",
      "Gardez animaux et enfants à l'intérieur et loin du pourtour de la maison pendant que nous sommes sur le toit, et loin du panneau tant qu'il est ouvert.",
    ],
    warning:
      "Le courant sera coupé pendant une partie de la visite, le temps du raccordement au panneau. Le système ne peut pas être mis en service avant l'approbation du distributeur d'électricité et, si nécessaire, de l'inspecteur — nous vous dirons ce qui reste à obtenir et n'allumerons rien avant.",
    dayOf: [
      "Nous confirmons l'implantation avec vous, fixons et câblons l'équipement de votre soumission, le raccordons au panneau et le testons. Nous vous montrons l'application ou l'afficheur, et comment couper le système.",
      "Quand une inspection ou l'approbation du distributeur est requise, nous vous disons la suite et quand.",
    ],
    afterCare:
      "Ne mettez pas le système en marche vous-même avant que nous vous confirmions l'approbation. Gardez les panneaux dégagés des branches, et dites-nous si la production baisse dans l'application ou si une borne ne recharge plus.",
  },

  moving: {
    checklist: [
      "Emballez tout ce qui va en boîtes avant notre arrivée, sauf si votre soumission inclut l'emballage — fermez chaque boîte et étiquetez-la avec la pièce de destination.",
      "Mettez de côté ce qui reste ou voyage avec vous — documents, médicaments, clés, bijoux, objets de valeur — dans votre voiture ou une pièce identifiée où nous n'entrerons pas.",
      "Réservez le stationnement ou une zone de chargement aux deux adresses, et l'ascenseur dans un immeuble, pour la durée prévue du déménagement.",
      "Videz, dégivrez et séchez congélateur et réfrigérateur, vidangez les boyaux de la laveuse, et débranchez ce qui demande un technicien pour être rebranché.",
      "Signalez-nous avant le jour, pas le jour même, tout objet très lourd, fragile ou de valeur — piano, coffre-fort, verre, œuvre d'art.",
    ],
    warning:
      "Ce qui n'est pas emballé à notre arrivée doit l'être avant de partir, et ce temps est facturé. Les matières dangereuses — carburant, propane, diluant à peinture, munitions — ne peuvent pas voyager dans le camion ; prévoyez une autre solution pour elles.",
    dayOf: [
      "Nous faisons d'abord le tour avec vous, protégeons planchers, cadres de porte et rampes, chargeons dans l'ordre qui facilite le déchargement, et plaçons chaque boîte et chaque meuble dans la pièce de votre choix à l'arrivée.",
      "Nous remontons ce que nous avons démonté si votre soumission l'inclut.",
    ],
    afterCare:
      "Vérifiez tout avant notre départ et signalez-nous tout dommage le jour même — c'est là qu'il peut être réglé. Gardez l'inventaire que nous vous remettons jusqu'à la fin du déballage.",
  },

  wildlife_control: {
    checklist: [
      "Ne bouchez pas le trou que l'animal semble utiliser avant notre arrivée — un animal enfermé dans la maison, ou séparé de ses petits, est un problème plus difficile.",
      "Dégagez l'accès à l'endroit où vous l'avez entendu ou vu — trappe du grenier, vide sanitaire, garage, dessous de la terrasse — et un passage jusque-là.",
      "Dites-nous ce que vous avez remarqué et quand — grattements au crépuscule, excréments, odeur, trou — et s'il peut y avoir des petits.",
      "Gardez les animaux domestiques à l'intérieur, et les enfants loin des cages, des ouvertures et de tout animal trouvé.",
      "Rangez la nourriture des animaux, les graines pour oiseaux et les poubelles extérieures ; elles attirent d'autres animaux pendant les travaux.",
    ],
    warning:
      "N'essayez pas de manipuler, d'acculer ou de nourrir l'animal. Un animal sauvage qui se défend, ou qui défend ses petits, peut mordre, et certains transmettent des maladies. Si l'un d'eux entre dans l'espace habité avant notre arrivée, fermez la porte de la pièce et appelez-nous.",
    dayOf: [
      "Nous inspectons d'abord, vous montrons par où l'animal entre, et le retirons ou l'excluons selon le plan de votre soumission et les règles locales sur la faune. Cages et portes à sens unique sont identifiées ; ne les déplacez pas, s'il vous plaît.",
      "Les points d'entrée sont scellés une fois l'animal et ses petits sortis — jamais avant.",
    ],
    afterCare:
      "Dites-nous tout de suite si vous entendez encore de l'activité après le scellement des ouvertures. Gardez poubelles, compost et nourriture d'animaux bien fermés — c'est ce qui les a attirés la première fois.",
  },

  caulking_sealants: {
    checklist: [
      "Indiquez-nous chaque joint à refaire — baignoire, douche, lavabo, fenêtres, revêtement extérieur — et faites-en le tour avec nous à l'arrivée.",
      "Dégagez la zone autour de chaque joint — produits de toilette hors de la douche et du rebord de la baignoire, rideaux et objets loin des fenêtres, et un passage extérieur vers les joints extérieurs.",
      "Gardez les joints secs avant notre arrivée — pas de douche ni de bain juste avant dans la pièce concernée.",
      "Signalez-nous toute fuite, tache ou moisissure remarquée derrière ou sous un joint ; le calfeutrage peut être un symptôme plutôt que la cause.",
      "Gardez les animaux loin du calfeutrage frais — les pattes laissent des marques qui restent.",
    ],
    warning:
      "La douche ou la baignoire recalfeutrée est inutilisable jusqu'à ce que le nouveau scellant ait durci — nous vous disons combien de temps pour le produit utilisé. De l'eau sur un cordon frais le gâche, et le joint est à refaire.",
    dayOf: [
      "Nous retirons l'ancien scellant, nettoyons et séchons le joint, traitons la moisissure accessible, et posons un nouveau cordon. Nous vous disons quand chaque joint peut être mouillé.",
    ],
    afterCare:
      "Gardez les joints secs et n'y touchez pas pendant le temps que nous vous indiquons. Essuyez de temps en temps la baignoire et la douche ; l'eau stagnante raccourcit la vie d'un joint. Dites-nous si un joint se décolle ou se décolore trop tôt.",
  },

  furniture_upholstery: {
    checklist: [
      "Indiquez-nous quels meubles sont concernés et où ils se trouvent, et dégagez un passage depuis la porte si nous venons les chercher.",
      "Videz tiroirs, coussins et recoins — pièces de monnaie, télécommandes et petits objets dans les coutures se perdent ou abîment le travail.",
      "Ayez le tissu ou le matériau prêt si vous le fournissez, en quantité suffisante — nous confirmons la quantité avec vous à l'avance.",
      "Racontez-nous l'histoire du meuble — réparations antérieures, taches et leur cause, animaux qui l'utilisent, et tout élément à valeur sentimentale à conserver.",
      "Gardez les animaux loin du meuble pendant les travaux, et jusqu'à ce que le nettoyage ou la finition ait séché.",
    ],
    warning:
      "Certaines taches et anciennes réparations ne s'effacent pas complètement, et un meuble ancien peut cacher sous son revêtement des dommages que nous ne découvrons qu'une fois ouvert. Nous vous le disons avant d'aller plus loin, avec le coût, et non après.",
    dayOf: [
      "Nous examinons le meuble avec vous et confirmons le travail de votre soumission. Le travail fait chez vous se fait sur des planchers protégés ; les meubles emportés sont emballés et étiquetés à votre nom, et nous vous disons quand les attendre.",
    ],
    afterCare:
      "N'utilisez pas un meuble nettoyé ou refini pendant le temps que nous vous indiquons, et gardez-le à l'abri du plein soleil si possible. Dites-nous si une couture, un ressort ou une finition pose problème trop tôt.",
  },

  glass: {
    checklist: [
      "Dégagez un mètre autour de chaque vitre, miroir ou cabine concerné, à l'intérieur comme à l'extérieur — meubles, plantes, produits de toilette, tout ce qui est sur un rebord ou une tablette.",
      "Décrochez rideaux, stores et tout ce qui est suspendu près du verre.",
      "Dégagez un passage direct depuis la porte jusqu'au travail — le verre arrive en grandes pièces lourdes.",
      "Signalez-nous toute ouverture qui semble différente de celle que nous avons mesurée, ou toute fissure qui s'est étendue depuis.",
      "Gardez animaux et enfants hors de la zone — le verre cassé est retiré en morceaux, et un éclat peut voler.",
    ],
    warning:
      "Personne ne doit se tenir près du verre pendant qu'il est retiré ou posé. Si une vitre est déjà cassée, fermez l'accès à la zone et laissez les morceaux en place pour nous — n'essayez pas de les retirer.",
    dayOf: [
      "Nous protégeons les alentours, retirons l'ancien verre, nettoyons le cadre, puis posons et scellons le nouveau verre. Une porte ou cabine de douche est ajustée jusqu'à ce qu'elle ferme et soit étanche.",
      "Le verre cassé et les emballages partent avec nous, et nous passons l'aspirateur avant de partir.",
    ],
    afterCare:
      "N'utilisez pas une nouvelle cabine de douche, et ne nettoyez pas autour d'un scellant neuf, pendant le temps que nous vous indiquons. Retirez le film protecteur quand nous vous le disons. Signalez-nous tout de suite une fuite, un frottement ou un courant d'air.",
  },

  marine_services: {
    checklist: [
      "Indiquez-nous exactement où sera le bateau — la marina, le numéro d'emplacement, l'endroit où se trouve la remorque — et organisez notre accès avec la marina ou la barrière.",
      "Retirez effets personnels, équipement et objets de valeur des zones de travail — cabine, coffres, compartiment moteur.",
      "Ayez les clés, le journal de bord et les registres d'entretien à bord ou avec vous, et dites-nous ce qui a été fait récemment.",
      "Dites-nous ce que vous avez remarqué — un bruit, une fuite, un voyant, un changement de comportement sur l'eau.",
      "Assurez-vous que nous pouvons atteindre le bateau en sécurité — sur une remorque calée, ou amarré à un emplacement avec branchement à quai si le travail l'exige.",
    ],
    warning:
      "Si nous ne pouvons pas atteindre le bateau ou monter à bord à notre arrivée — barrière fermée, mauvais emplacement, marina qui ne nous a pas autorisés — la visite ne peut pas avoir lieu et peut quand même être facturée. Vérifiez l'accès la veille.",
    dayOf: [
      "Nous inspectons d'abord, confirmons le travail et le coût avec vous, puis faisons le travail de votre soumission et testons ce que nous avons touché — sur l'eau si nécessaire et si c'est sécuritaire.",
      "Nous laissons une note de ce qui a été fait et de ce qui demandera attention ensuite.",
    ],
    afterCare:
      "Faites tourner le moteur et les systèmes sur lesquels nous avons travaillé à votre prochaine sortie, et signalez-nous tout changement. Gardez nos rapports avec le journal du bateau ; ils comptent à la revente.",
  },

  home_organization: {
    checklist: [
      "Indiquez-nous les pièces ou espaces concernés et ce qui ne fonctionne pas aujourd'hui — ce que vous ne trouvez pas, ce qui ne rentre pas, comment vous utilisez la pièce.",
      "Décidez à l'avance ce dont vous êtes prêt à vous séparer, ou prévoyez du temps pour décider avec nous le jour même — le tri va plus vite quand la personne qui décide est présente.",
      "Mettez de côté tout ce qui est privé, de valeur ou à ne pas toucher — documents, médicaments, bijoux — dans un endroit où nous ne travaillerons pas.",
      "Préparez sacs ou boîtes pour les dons et la mise au rebut, et dites-nous où ils vont ensuite si votre soumission n'inclut pas leur enlèvement.",
      "Dégagez un passage jusqu'à l'espace, et une place pour notre véhicule si nous apportons des produits ou des meubles.",
    ],
    warning:
      "Rien n'est jeté ni donné sans votre accord. Si la personne qui décide n'est pas disponible ce jour-là, nous pouvons seulement trier, pas retirer, et le temps reste facturé.",
    dayOf: [
      "Nous partons de l'espace tel qu'il est, trions tout avec vous entre garder, donner et jeter, puis mettons en place la nouvelle disposition, les rangements et les étiquettes de votre soumission. Si votre soumission inclut du design, nous passons le plan en revue avec vous avant d'acheter ou de déplacer quoi que ce soit.",
    ],
    afterCare:
      "Remettez chaque chose là où son étiquette l'indique. Un espace reste organisé quand chaque nouvel objet a sa place — dites-nous si un système ne vous convient plus après un moment, et nous l'ajusterons.",
  },

  baby_proofing: {
    checklist: [
      "Faites le tour de la maison avec nous, ou dites-nous à l'avance, où le bébé passe du temps et ce qu'il atteindra bientôt — escaliers, cuisine, salle de bain, piscine.",
      "Dégagez les zones de travail — autour des escaliers, des armoires et tiroirs, des meubles à fixer au mur et des fenêtres.",
      "Videz le dessus des meubles à fixer au mur, et avancez-les un peu pour que nous puissions atteindre l'arrière.",
      "Ayez sur place les produits que vous fournissez, non ouverts, avec toutes leurs pièces — barrières, loquets, ancrages, cache-prises.",
      "Dites-nous en quoi sont faits vos poteaux d'escalier et vos murs là où vont les barrières — une barrière a besoin d'une fixation solide, pas seulement de gypse.",
    ],
    warning:
      "Les produits de sécurité ne fonctionnent que s'ils sont installés selon les instructions du fabricant. Si un produit que vous fournissez ne convient pas à votre escalier ou à votre cadre de porte, nous vous le dirons plutôt que de l'installer quand même, et vous proposerons ce qui convient.",
    dayOf: [
      "Nous confirmons la liste avec vous, installons et testons chaque barrière, loquet, ancrage et cache, et montrons à chaque adulte de la maison comment les ouvrir.",
    ],
    afterCare:
      "Vérifiez barrières et loquets de temps en temps — les vis se desserrent et les enfants apprennent. Dites-nous quand le bébé commence à grimper ou à ouvrir des choses ; la liste change à mesure qu'il grandit.",
  },
};
