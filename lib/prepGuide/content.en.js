...
// ── Families ────────────────────────────────────────────────────────────────
//
// Eighty-five categories do not need eighty-five guides: a lawn-mowing visit and
...
export const GUIDES_EN = {
  ...
  // ── The 2026-09-21 trades ────────────────────────────────────────────────
  //
  // The sixteen keys the service-seed work added to lib/trades/catalog.js.
  // Lighting installation asks the homeowner for exactly what any electrical
  // visit does, so it maps onto `electrical` in content.js; the other fifteen
  // ask for something genuinely different and have their own list.

  air_duct_cleaning: {
    checklist: [
      "Clear a path to every supply and return vent in the house — move furniture, rugs and boxes off floor registers and away from wall and ceiling grilles.",
      "Clear the area around the furnace or air handler — a clear metre on every side, and a path from the door to it, because that is where the vacuum connects.",
      "Tell us anything we should know about the ductwork — a recent renovation, a smell, mould you have seen, or a room that never gets air.",
      "Cover or put away anything delicate near the vents — the dust is contained, but opening a register can still release some.",
      "Pets — keep them in a room away from the vents being worked on; the equipment is loud and hoses run through the house.",
    ],
    warning:
      "The heating or cooling is off for the whole visit. A vent blocked by something that cannot be moved cannot be cleaned — please tell us about built-ins over vents before we arrive.",
    dayOf: [
      "We inspect the system first, seal the registers, connect the vacuum at the air handler, and clean each run with brushes and air. We show you the before and after where the ducts can be photographed.",
      "The filter is replaced or cleaned at the end, and the system is run before we leave.",
    ],
    afterCare:
      "Change the filter on the schedule we give you — a clean duct behind a dirty filter does not stay clean. Tell us if a smell or dust comes back soon after the visit.",
  },

  deck_patio: {
    checklist: [
      "Clear the deck or patio completely — furniture, barbecues, planters, rugs and anything stored underneath.",
      "Unlock side gates and clear a path from the driveway to the back — materials and tools come through it.",
      "Move cars off the driveway if we have told you that is where the delivery goes.",
      "Turn off sprinklers near the work area, and tell us about buried lines — irrigation, lighting cables, a gas line to the barbecue.",
      "Pets and children — keep them away from the work area, and inside while we are cutting and building.",
    ],
    warning:
      "The deck or patio is out of use from the moment work starts until we hand it back — including any door that opens onto it. Please plan another way in and out of the house, and keep children away from open footings and loose boards.",
    dayOf: [
      "We confirm the layout and the heights with you before anything is cut or dug. The old surface comes off first where your quote includes it; the new one is built to the plan on your quote.",
      "Where a permit or an inspection is required, we tell you what happens next and when.",
    ],
    afterCare:
      "Keep off new concrete or a fresh finish for the time we tell you. A wood deck needs its protective finish kept up; ask us when the first re-coat is due.",
  },

  doors_windows: {
    checklist: [
      "Clear a metre inside and outside each door or window being replaced — furniture, plants, anything on the sill.",
      "Take down curtains, blinds, rods and coverings on the openings being worked on; we cannot remove them without risking damage.",
      "Move anything fragile off the walls around the openings — pictures and shelves — because taking out a frame vibrates the wall.",
      "Unlock gates and clear a path to the openings on the outside, including any ground-floor window we reach from a ladder.",
      "Pets — keep them in a closed room; the house will have open holes in its walls for part of the day.",
    ],
    warning:
      "Each opening is open to the weather while the old unit is out and the new one goes in. We do not start an opening we cannot close the same day, and in bad weather we may reschedule — we will tell you as early as we can.",
    dayOf: [
      "We confirm each opening and the order of work with you, protect the floors, remove the old unit, install, insulate and seal the new one, and check that every door and window opens, closes and locks.",
      "The old units and the packaging leave with us.",
    ],
    afterCare:
      "Let the trim, paint and caulk settle for the time we tell you before cleaning around them. Tell us if a door rubs, a window sticks or you feel a draught — adjustment is part of the job.",
  },

  security_systems: {
    checklist: [
      "Tell us where you want each camera, sensor, keypad and siren — walk the house with a list, or we will walk it with you on arrival.",
      "Have your Wi-Fi network name and password ready, and the router accessible — most panels and cameras connect to it.",
      "If you have an existing alarm, find the installer or master code and the monitoring company's name and account number, and tell the monitoring company work is happening.",
      "Clear access to the electrical panel, the router, the spots where the panel and keypads will go, and the attic or basement if the cables run through them.",
      "Keep pets out of the rooms being worked on — and tell us which pets will be home once the system is armed, so the motion sensors can be chosen for them.",
    ],
    warning:
      "Without the existing system's codes, an old panel may have to be replaced rather than taken over, and an alarm set off during the work will call the monitoring company. Please have the codes, or tell us you do not have them, before we arrive.",
    dayOf: [
      "We install the equipment where we agreed, connect it, and test every sensor, camera and siren with you. We set up the app on your phone and show you how to arm, disarm and cancel a false alarm.",
    ],
    afterCare:
      "Choose codes only your household knows, and give them only to the people who need them. Tell us if a sensor keeps triggering, a camera goes offline or the app stops sending alerts.",
  },

  sewer_septic: {
    checklist: [
      "Mark or uncover the septic tank lids or the sewer clean-out if you know where they are — and tell us if you do not; the property records or a previous invoice often show it.",
      "Clear the ground over the tank and the path to it — vehicles, stored items, anything built or planted over the lids.",
      "Keep the driveway clear for the truck, and tell us about anything a heavy vehicle must not drive over — the leach field, a septic line, a soft lawn.",
      "Tell us what you have noticed — slow drains, gurgling, smells, wet ground or lush grass over the field.",
      "Keep pets and children away from open lids and any excavation.",
    ],
    warning:
      "Limit water use — no laundry, dishwasher or long showers — on the day of the visit, and afterwards for the time we tell you where the work needs it. A tank or line filling while we work on it is a hazard and slows the job.",
    dayOf: [
      "We locate and open the tank or clean-out, then pump, clean or inspect the line to the plan on your quote, and tell you what we found — the condition of the baffles, the level, anything that needs attention. Where your quote includes a camera inspection, we show it to you.",
      "Lids are closed and secured before we leave.",
    ],
    afterCare:
      "Only toilet paper goes down the toilet — wipes labelled flushable, grease and chemicals shorten the life of the system. Keep vehicles off the tank and the field, and ask us when the next pump-out is due.",
  },

  smart_home: {
    checklist: [
      "Have your Wi-Fi network name and password ready, and the router accessible — nearly everything we install connects to it.",
      "Have the equipment on site if you are supplying it — TV, speakers, hubs, smart switches — unopened, with all its parts and remotes.",
      "Decide where each screen, speaker and device goes, and the height of a mounted TV; we confirm it with you before we drill.",
      "Clear the walls and the area where things are being mounted or wired, and give us access to the attic or basement if cables run through them.",
      "Have the log-ins for your streaming, music and smart-home accounts to hand — we can only link what you can sign in to.",
    ],
    warning:
      "A mounted screen needs the right wall behind it. If we find no solid fixing where you want it, we will offer the nearest safe spot rather than hang it anyway. Equipment you supply that is missing a part or a remote cannot be finished on the day.",
    dayOf: [
      "We confirm the positions with you, mount and wire, connect everything to the network, set up the apps and the remotes, and show you how it all works together before we leave.",
      "The packaging leaves with us.",
    ],
    afterCare:
      "Keep the manuals and receipts together for the warranties. If something drops off the network after a router change or a power cut, tell us before resetting it — a reset often means setting it up again from scratch.",
  },

  solar_energy: {
    checklist: [
      "Clear access to your electrical panel and to the spot where the inverter, battery or charger will go — a clear metre in front of each.",
      "Move cars out of the garage or off the driveway where the charger is going, and off the driveway on installation day for the materials and the lift.",
      "Clear the attic hatch and a path to it if we need to reach the underside of the roof.",
      "Tell us about the roof — its age, any leak you know of, whether a replacement is coming; panels should go on a roof that will outlast them.",
      "Keep pets and children indoors and away from the perimeter while we are on the roof, and away from the panel while it is open.",
    ],
    warning:
      "Power will be off for part of the visit while we connect to the panel. The system cannot be switched on until the utility and, where required, the inspector have approved it — we will tell you what is outstanding and turn nothing on before then.",
    dayOf: [
      "We confirm the layout with you, mount and wire the equipment on your quote, connect it to the panel and test it. We show you the app or the display, and how to shut the system off.",
      "Where an inspection or the utility's approval is needed, we tell you what happens next and when.",
    ],
    afterCare:
      "Do not switch the system on yourself before we tell you it has been approved. Keep the panels clear of branches, and tell us if production drops in the app or a charger stops charging.",
  },

  moving: {
    checklist: [
      "Pack everything that goes in boxes before we arrive, unless your quote includes packing — close each box and label it with the room it goes to.",
      "Set aside what stays or travels with you — documents, medication, keys, jewellery, valuables — in your car or a marked room we will not enter.",
      "Reserve parking or a loading space at both addresses, and the elevator in a building, for the time the move is booked.",
      "Empty, defrost and dry the freezer and refrigerator, drain the washer hoses, and disconnect anything that needs a trade to reconnect.",
      "Tell us about anything unusually heavy, fragile or valuable — a piano, a safe, glass, art — before the day, not on it.",
    ],
    warning:
      "Anything not packed when we arrive has to be packed before it can move, and that time is charged. Hazardous goods — fuel, propane, paint thinner, ammunition — cannot travel in the truck; please make other arrangements for them.",
    dayOf: [
      "We walk through with you first, protect floors, doorways and railings, load in the order that unloads best, and place every box and piece of furniture in the room you choose at the other end.",
      "We reassemble what we took apart where your quote includes it.",
    ],
    afterCare:
      "Check everything before we leave and tell us about any damage the same day — that is when it can be put right. Keep the inventory we give you until you have unpacked.",
  },

  wildlife_control: {
    checklist: [
      "Do not block or seal a hole you think the animal uses before we arrive — an animal shut inside the house, or cut off from its young, is the harder problem.",
      "Clear access to where you have heard or seen it — the attic hatch, the crawlspace, the garage, under the deck — and a path to it.",
      "Tell us what you have noticed and when — scratching at dusk, droppings, a smell, a hole — and whether there may be young.",
      "Keep pets indoors, and children away from the traps, the openings and any animal we find.",
      "Put away pet food, bird seed and outdoor garbage; they bring more animals in while we work.",
    ],
    warning:
      "Do not try to handle, corner or feed the animal. A wild animal defending itself or its young can bite, and some carry disease. If one gets into the living space before we arrive, close the door to that room and call us.",
    dayOf: [
      "We inspect first, show you where the animal is getting in, and remove or exclude it to the plan on your quote and to local wildlife rules. Traps and one-way doors are labelled; please do not move them.",
      "Entry points are sealed once the animal and any young are out — never before.",
    ],
    afterCare:
      "Tell us straight away if you hear activity again after the openings are sealed. Keep garbage, compost and pet food secured — it is what brought them in the first time.",
  },

  caulking_sealants: {
    checklist: [
      "Tell us every joint you want redone — the tub, the shower, the sink, the windows, the siding — and walk them with us on arrival.",
      "Clear the area around each joint — toiletries out of the shower and off the tub edge, curtains and items away from the windows, and a path outside to the exterior joints.",
      "Keep the joints dry before we arrive — no shower or bath beforehand in the room being done.",
      "Tell us about any leak, stain or mould you have noticed behind or below a joint; the caulk may be a symptom rather than the cause.",
      "Keep pets away from fresh caulk — paws leave prints that stay.",
    ],
    warning:
      "A shower or tub being resealed is out of use until the new sealant has cured — we tell you how long for the product used. Water on a fresh bead ruins it, and the joint has to be redone.",
    dayOf: [
      "We remove the old sealant, clean and dry the joint, treat any mould we can reach, and lay a new bead. We tell you when each joint can get wet.",
    ],
    afterCare:
      "Keep the joints dry and untouched for the time we tell you. Wipe the tub and shower dry now and then; standing water is what shortens a bead's life. Tell us if a joint pulls away or discolours early.",
  },

  furniture_upholstery: {
    checklist: [
      "Tell us which pieces are being worked on and where they are, and clear a path from the door to them if we are collecting them.",
      "Empty drawers, cushions and crevices — coins, remotes and small items in the seams get lost or damage the work.",
      "Have the fabric or material ready if you are supplying it, with enough for the piece — we confirm the amount with you beforehand.",
      "Tell us the piece's history — earlier repairs, stains and what caused them, pets that use it, and anything of sentimental value about it we should keep.",
      "Keep pets away from the piece while we work, and until any cleaning or finish has dried.",
    ],
    warning:
      "Some stains and old repairs cannot be fully reversed, and an older piece can hide damage under its covering that we only find once it is open. We tell you before we go further, with the cost, not after.",
    dayOf: [
      "We look over the piece with you and confirm the work on your quote. Work done in your home is done on protected floors; pieces we take away are wrapped and tagged with your name, and we tell you when to expect them back.",
    ],
    afterCare:
      "Keep a cleaned or refinished piece out of use for the time we tell you, and out of strong sunlight where you can. Tell us if a seam, a spring or a finish gives trouble early.",
  },

  glass: {
    checklist: [
      "Clear a metre around each pane, mirror or enclosure being worked on, inside and out — furniture, plants, toiletries, anything on a sill or shelf.",
      "Take down curtains, blinds and anything hanging near the glass.",
      "Clear a straight path from the door to the work — glass is carried in large, heavy pieces.",
      "Tell us if an opening looks different from the one we measured, or if a crack has spread since.",
      "Keep pets and children out of the area — broken glass comes out in pieces, and a fragment can travel.",
    ],
    warning:
      "Nobody should be near the glass while it is being removed or set. If a pane is already broken, keep the area closed off and leave the pieces where they are for us — do not try to pull them out.",
    dayOf: [
      "We protect the surroundings, remove the old glass, clean the frame, and set and seal the new glass. A shower door or enclosure is adjusted until it closes and seals properly.",
      "Broken glass and packaging leave with us, and we vacuum the area before we leave.",
    ],
    afterCare:
      "Do not use a new shower enclosure, or clean around new sealant, for the time we tell you. Remove any protective film when we say it can come off. Tell us about a leak, a rub or a draught straight away.",
  },

  marine_services: {
    checklist: [
      "Tell us exactly where the boat will be — the marina, the slip number, where the trailer is parked — and arrange our access with the marina or the gate.",
      "Remove personal items, gear and valuables from the areas we work in — the cabin, the lockers, the engine space.",
      "Have the keys, the log and any maintenance records aboard or with you, and tell us what has been done recently.",
      "Tell us what you have noticed — a noise, a leak, a warning light, a change in how it handles.",
      "Make sure we can reach the boat safely — on a trailer that is chocked, or secured in a slip with shore power where the work needs it.",
    ],
    warning:
      "If we cannot reach or board the boat when we arrive — the gate is locked, the slip is not the one we were told, the marina has not cleared us — the visit cannot go ahead and may still be charged. Please check access the day before.",
    dayOf: [
      "We inspect first, confirm the work and the cost with you, then do the work on your quote and test what we touched — on the water where it needs it and where it is safe to.",
      "We leave a note of what was done and anything that needs attention next.",
    ],
    afterCare:
      "Run the engine and the systems we worked on at your next outing, and tell us about anything different. Keep the records we leave with the boat's log; they matter when you sell it.",
  },

  home_organization: {
    checklist: [
      "Tell us which rooms or spaces we are working on and what is not working about them now — what you cannot find, what does not fit, how you use the room.",
      "Decide beforehand what you are ready to let go of, or set aside time to decide with us on the day — sorting goes faster when the person who decides is home.",
      "Set aside anything private, valuable or not to be touched — documents, medication, jewellery — in a place we will not work.",
      "Have bags or boxes ready for donation and disposal, and tell us where they go afterwards if your quote does not include taking them.",
      "Clear a path to the space, and parking for our vehicle if we are bringing products or furniture.",
    ],
    warning:
      "Nothing is thrown away or donated without your say-so. If the person who decides is not available on the day, we can only sort, not remove, and the time is still charged.",
    dayOf: [
      "We start with the space as it is, sort everything with you into keep, donate and discard, then set up the new layout, containers and labels on your quote. Where your quote includes design work, we walk the plan through with you before anything is bought or moved.",
    ],
    afterCare:
      "Put things back where their label says. A space stays organised when every new item has a home — tell us if a system stops working for you after a while, and we will adjust it.",
  },

  baby_proofing: {
    checklist: [
      "Walk the house with us, or tell us beforehand, where the baby spends time and what they will reach next — the stairs, the kitchen, the bathroom, the pool.",
      "Clear the areas being worked on — around the stairs, the cabinets and drawers, the furniture to be anchored and the windows.",
      "Empty the tops of furniture being anchored to the wall, and pull it out a little so we can reach behind it.",
      "Have any products you are supplying on site, unopened, with all their parts — gates, latches, anchors, covers.",
      "Tell us what your stair posts and walls are made of where the gates go — a gate needs a solid fixing, not just drywall.",
    ],
    warning:
      "Safety products only work when installed to the manufacturer's instructions. If a product you supply does not fit your stairs or doorway, we will tell you rather than fit it anyway, and suggest what will.",
    dayOf: [
      "We confirm the list with you, install and test each gate, latch, anchor and cover, and show every adult in the house how to open them.",
    ],
    afterCare:
      "Check gates and latches every so often — screws loosen and children learn. Tell us when the baby starts climbing or opening things; the list changes as they grow.",
  },
};
