...
const TOOL_ACCESS = {
  // Currency in, currency out. /api/analytics/overview and
  // /api/analytics/burn-rate refuse the same figures on the same toggle;
  // arriving at them through a sentence rather than a chart doesn't change
  // what they are.
  getCashFlow: { allow: (m) => hasToggle(m, "showPricing") },
