...
export const COPILOT_TOOL_DEFINITIONS = [
  ...
  },
  {
    name: "findJob",
    description:
      "Find jobs by job title or client name and read INSIDE the project: every visit with its date, status and NOTES and how many photos were taken, the hours logged against the job, and the linked quote (total, notes, line items) and invoices (billed and paid). Use for 'how is the X job going', 'what did the crew note on the Smith job', or comparing hours logged against the quoted amount.",
    input_schema: {
      type: "object",
      properties: {
