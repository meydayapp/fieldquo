  ...
  return {
    ...
    ...(unitPriced
      ? {
          ...
          complexityReasons: [],
          // The factor module, every question on its benign answer. Score 0,
          // level Standard, no uplift and no reason lines — identical to what
          // a group with no complexity object produces, which is why seeding
          // it cannot move a price. See lib/pricing/complexity/index.js.
          complexity: newComplexity(category?.key),
          color: "",
          sheen: "",
          doorStyle: "",
