...
export function gutterTakeoffPatch(g, workType = "cleaning", address = "") {
  ...
  const patch = {
    ...
    // The still the eaves were read from, for the document — see
    // lib/measure/measureImages.js. The save route captures it.
    ...(g.satelliteImageUrl ? { measureImage: { sourceUrl: g.satelliteImageUrl } } : {}),
  };
