...
export const TIER_FEATURES = Object.freeze({
  ...
  // records that what they describe is a one-way push. We have neither the push
  // nor a bookkeeping file a customer can download — bulk export is off (owner,
  // 2026-09-24) — so this is a plain gap, not a partial one.
