...
export const FIELDQUO_CAPABILITIES = deepFreeze({
  ...
  accounting_sync: {
    ...
    has: false,
    evidence:
      "docs/INTEGRATIONS-ASSESSMENT.md, written against this repo: the strings quickbooks, zapier and xero appear in no integration code, only in prose. There is no accounting export for customers either: lib/export/accountingExport.js still builds a bookkeeping CSV, but its route answers 403 and nothing in the product offers it, because companies can import but not export (owner, 2026-09-24; lib/export/companyDataExport.js). QuickBooks Desktop is recorded there as refused outright: it needs a Windows connector we cannot ship.",
  },
  gantt_charts: {
...

  {
    ...
    theyHaveWeDont: [
      ...
      },
      {
        ...
        verifiedBy: SERVED_HTML,
        note:
          'Listed on Pro as "QuickBooks Integration". docs/INTEGRATIONS-ASSESSMENT.md records that we have no sync at all, and there is no bookkeeping export a customer can download either (bulk export is off, owner 2026-09-24).',
      },
      {
        capability: "self_serve_demo",
...

  {
    ...
    theyHaveWeDont: [
      ...
      },
      {
        ...
        verifiedBy: SERVED_HTML,
        note:
          'Their integrations page: "Your invoices can be instantly exported to QuickBooks. Your bookkeeping will stay organized, efficient, and up to date with no extra effort." Their pricing page\'s featureList also carries "QuickBooks integration". We have no QuickBooks connection and no invoice export a customer can download — bulk export is off (owner, 2026-09-24); docs/INTEGRATIONS-ASSESSMENT.md.',
      },
      {
        capability: "integration_marketplace",
