...
const ENTRIES = [
  ...
  // the "Subs on this job" panel, the T5018 export), so the sentence is gone
  // and the entry is shipped. Docs/OPEN-WORK-APP.md asked for exactly this.
  {
    ...
    proof: [
      ...
      { path: "app/api/subcontractors/export/route.js", holds: ["export async function GET"] },
      { path: "app/api/jobs/[id]/subcontractors/route.js", holds: ["export async function POST"] },
      { path: "app/app/subcontractors/page.js", holds: [] },
  ...
  },
  {
    ...
    proof: [
      ...
      // The raw CSV — hours, never pay — and the attendance verdict beside
      // each punch (lib/shifts/attendance.js, executed by check:shift-notify).
      { path: "app/api/time-entries/export/route.js", holds: ["export async function GET"] },
