...
export const PERMISSION_PRESETS = {
  ...
  // client was charged wherever showPricing didn't reach. They are `none` now,
  // which is what the description has always claimed.
  //
  // workerFullView ("Worker") is untouched: that tier is meant to see the
  // documents and their prices, and is what a lead hand or a foreman gets.
  worker: {
    label: "Crew",
    description:
      "View their schedule, mark work complete, and track their time. No quotes, jobs, invoices or requests.",
