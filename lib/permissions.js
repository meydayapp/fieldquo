...
// part a reader needs.
//
// TWO CATEGORIES ARE STILL WRITTEN AND READ BY NOTHING:
//
//   * notes       — saved, shown back, gates no note anywhere
//   * requests    — saved, shown back, gates no request anywhere
//
// Both are dead controls in the sense AGENTS.md means: a company can set them,
// see them saved, and reasonably believe an employee is restricted when they
// are not — which is a staffing decision made on a false premise.
//
