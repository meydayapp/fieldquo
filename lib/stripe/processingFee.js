...
//
// Published rates, not the fee Stripe actually assesses on a given charge.
// The two differ for a cross-border card (+0.8%) or a currency conversion
// (+2%); those differences are absorbed by FieldQuo the way Jobber absorbs
// them, because a contractor quoted "3% + 30¢" on their settings page has
// to be able to reconcile their books to it. Affirm is the one exception —
// see lib/stripe/paymentIntentFee.js — because Affirm's rate is not a
// card rate and the contractor chose to offer it.
//
