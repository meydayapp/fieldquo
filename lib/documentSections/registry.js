...
import * as howToPay from "./HowToPaySection";
...
// The crew work order — one section, its own document kind ("work_order_pdf"),
// rendered through the same renderDocumentPdfBuffer as everything else.
import * as workOrder from "./WorkOrderSection";
