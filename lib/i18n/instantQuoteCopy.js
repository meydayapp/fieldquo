...
// ── The trades ─────────────────────────────────────────────────────────────
//
// The chip label per language. The English column mirrors TRADE_LABELS in
// lib/estimate/instantQuoteServer.js (the check script pins the two); a trade
// missing here shows its English label rather than its key.
const TRADES = {
  roofing: {
    en: { label: "Roofing" },
    fr: { label: "Toiture" },
  ...
  gutters: {
    en: { label: "Gutters & Eavestroughs" },
    fr: { label: "Gouttières" },
    es: { label: "Canalones" },
  },
  lawn_care: {
    en: { label: "Lawn Care Programs" },
    fr: { label: "Programmes d'entretien de pelouse" },
    es: { label: "Programas de cuidado del césped" },
  },
  lawn_mowing: {
    en: { label: "Lawn Mowing" },
    fr: { label: "Tonte de pelouse" },
    es: { label: "Corte de césped" },
  },
  paving: {
    en: { label: "Paving" },
    fr: { label: "Pavage" },
    es: { label: "Pavimentación" },
  },
  landscaping: {
    en: { label: "Landscaping" },
    fr: { label: "Aménagement paysager" },
    es: { label: "Paisajismo" },
  },
  painting: {
    en: { label: "Painting" },
  ...
  junk_removal: {
    en: { label: "Junk Removal" },
    fr: { label: "Enlèvement de débris" },
    es: { label: "Retiro de desechos" },
  },
  parging: {
    en: { label: "Parging" },
    fr: { label: "Crépi" },
  ...
  epoxy: {
    en: { label: "Epoxy & Concrete Coatings" },
    fr: { label: "Époxy et revêtements de béton" },
    es: { label: "Epoxi y recubrimientos de concreto" },
  },
  cabinet_refinishing: {
    en: { label: "Cabinet Refinishing" },
    fr: { label: "Refinition d'armoires" },
    es: { label: "Renovación de gabinetes" },
  },
  cabinet_refacing: {
    en: { label: "Cabinet Refacing" },
    fr: { label: "Resurfaçage d'armoires" },
    es: { label: "Recubrimiento de gabinetes" },
  },
  countertop: {
    en: { label: "Countertops" },
    fr: { label: "Comptoirs" },
    es: { label: "Encimeras" },
  },
  flooring: {
  ...
  stair: {
    en: { label: "Stairs & Railings" },
    fr: { label: "Escaliers et rampes" },
    es: { label: "Escaleras y barandas" },
  },
};
