...
const COPY = {
  en: {
    ...
    emailBody: (company) =>
      `Here is your estimate report from ${company}. It's attached as a PDF and you can open it online any time with the button below.`,
    emailCta: "Open your report",
  ...
  fr: {
    ...
    emailBody: (company) =>
      `Voici votre rapport d'estimation de ${company}. Il est joint en PDF et vous pouvez l'ouvrir en ligne à tout moment avec le bouton ci-dessous.`,
    emailCta: "Ouvrir votre rapport",
  ...
  es: {
    ...
    emailBody: (company) =>
      `Aquí tiene su informe de estimación de ${company}. Va adjunto en PDF y puede abrirlo en línea cuando quiera con el botón de abajo.`,
    emailCta: "Abrir su informe",
