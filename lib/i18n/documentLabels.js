...
const LABELS = {
  en: {
    ...
    // The invoice line an approved change order becomes
    // (lib/jobs/changeOrderValue.js billChangeOrders): "Change order CO-2 ·
    // …" with the approval under it. {name}/{date} are filled by the caller.
    changeOrder: "Change order",
    changeOrderApprovedBy: "Approved by {name} on {date}",
  ...
  fr: {
    ...
    // …" with the approval under it. {name}/{date} are filled by the caller.
    changeOrder: "Avenant",
    changeOrderApprovedBy: "Approuvé par {name} le {date}",
  ...
  es: {
    ...
    changeOrderApprovedBy: "Aprobada por {name} el {date}",
  ...
  uk: {
    ...
    // (lib/jobs/changeOrderValue.js billChangeOrders): "Change order CO-2 ·
    // …" with the approval under it. {name}/{date} are filled by the caller.
    changeOrder: "Зміна до замовлення",
    changeOrderApprovedBy: "Погоджено: {name}, {date}",
  ...
  pa: {
    ...
    // (lib/jobs/changeOrderValue.js billChangeOrders): "Change order CO-2 ·
    // …" with the approval under it. {name}/{date} are filled by the caller.
    changeOrder: "ਤਬਦੀਲੀ ਆਰਡਰ",
    changeOrderApprovedBy: "{name} ਵੱਲੋਂ {date} ਨੂੰ ਮਨਜ਼ੂਰ",
  ...
  tl: {
    ...
    // …" with the approval under it. {name}/{date} are filled by the caller.
    changeOrder: "Change order",
    changeOrderApprovedBy: "Inaprubahan ni {name} noong {date}",
  ...
  de: {
    ...
    changeOrderApprovedBy: "Freigegeben von {name} am {date}",
  ...
  it: {
    ...
    // (lib/jobs/changeOrderValue.js billChangeOrders): "Change order CO-2 ·
    // …" with the approval under it. {name}/{date} are filled by the caller.
    changeOrder: "Variante",
    changeOrderApprovedBy: "Approvata da {name} il {date}",
