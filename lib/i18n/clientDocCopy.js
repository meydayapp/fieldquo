...
const COPY = {
  en: {
    ...
    selfQuote: {
      ...
      uploadHint: "A picture, short clip or your PDF plan helps us quote accurately.",
      ...
      bookVisitBody: "Book an in-person visit and we'll confirm your price on site.",
    ...
    visit: {
      ...
      refundAlready: (amount) => `Your ${amount} deposit has already been returned.`,
  ...
  fr: {
    ...
    selfQuote: {
      ...
      step2Hint: "Des chiffres approximatifs suffisent — rien ici n'est engageant.",
      ...
      notesPlaceholder: "Photos, échéancier, accès, tout ce qui sort de l'ordinaire…",
      ...
      bookVisitBody: "Réservez une visite sur place et nous confirmerons votre prix chez vous.",
    ...
    visit: {
      ...
      refundAlready: (amount) => `Votre dépôt de ${amount} a déjà été remboursé.`,
      ...
      timesFailed: "Nous n'avons pas pu charger les disponibilités pour l'instant.",
  ...
  es: {
    ...
    selfQuote: {
      ...
      step1Hint: "Elija lo más parecido — los detalles los concretamos nosotros.",
      noServices: (phone) =>
      ...
      notesPlaceholder: "Fotos, fechas, acceso, cualquier cosa fuera de lo común…",
  ...
  uk: {
    ...
    visit: {
      ...
      noticeHours: (n) => {
        ...
        if (ten >= 2 && ten <= 4 && (hundred < 12 || hundred > 14)) return `${n} години`;
        return `${n} годин`;
      },
      callInstead: (company, phone) =>
        phone
  ...
  pa: {
    ...
    selfQuote: {
      ...
      bookVisitBody: "ਘਰ ਆ ਕੇ ਦੇਖਣ ਦਾ ਸਮਾਂ ਬੁੱਕ ਕਰੋ — ਅਸੀਂ ਮੌਕੇ 'ਤੇ ਕੀਮਤ ਪੱਕੀ ਕਰਾਂਗੇ।",
    ...
    visit: {
      ...
      refundAlready: (amount) => `ਤੁਹਾਡੀ ${amount} ਪੇਸ਼ਗੀ ਪਹਿਲਾਂ ਹੀ ਵਾਪਸ ਕਰ ਦਿੱਤੀ ਗਈ ਹੈ।`,
      ...
      tooSoon: "ਇਹ ਸਮਾਂ ਉਨ੍ਹਾਂ ਨੂੰ ਕਾਫ਼ੀ ਪਹਿਲਾਂ ਨਹੀਂ ਦੱਸਦਾ। ਕੋਈ ਬਾਅਦ ਵਾਲਾ ਸਮਾਂ ਚੁਣੋ।",
      refundFailed:
  ...
  tl: {
    ...
    selfQuote: {
      ...
      errContact: "Magdagdag ng email o numero ng telepono para makasagot kami.",
      ...
      bookVisitBody: "Mag-book ng personal na pagbisita at kumpirmahin namin ang presyo ninyo doon mismo.",
    ...
    visit: {
      ...
      refundAlready: (amount) => `Naibalik na ang inyong ${amount} na deposito.`,
      ...
      tooSoon: "Masyadong maikli ang abiso sa oras na iyon. Pumili ng mas huli.",
      refundFailed:
