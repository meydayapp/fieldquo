...
const COPY = {
  en: {
    // The words FieldQuo itself prints inside a company's email template
    // (lib/email/renderTemplateSections.js): the progress tracker's state
    // words and its default stage names, and the marketing unsubscribe line.
    // Company-typed block text is never looked up here — only these.
    // `marketingFooter` takes the company name (already escaped) and `a`,
    // which wraps its argument in the unsubscribe link, so each language puts
    // the link where its own word order wants it.
    templateBlocks: {
      done: "Done",
      pending: "Pending",
      stageQuote: "Quote",
      stageDeposit: "Deposit & scheduling",
      stageInvoice: "Invoice & scheduling",
      stageStart: "Project start",
      stageComplete: "Project complete",
      thisCompany: "this company",
      marketingFooter: (company, a) => `You're receiving this because you're a customer of ${company}. ${a("Unsubscribe")} from marketing email.`,
    },
    ...
    visit: {
      // The row that names the service — "Consultation with Daniel" — now
      // that the headline and the subject name the MODE (lib/booking/
      // bookingModes.js). Blank until the letter has a mode to name.
      what: "What",
      ...
      // What a measure scheduled FROM A QUOTE is called — the estimator's
      // trip to size the job before the price is final. Named here rather
      // than falling through to serviceFallback so the homeowner reads
      // "Your on-site estimate with Northline is confirmed", not "Your visit".
      measureService: "on-site estimate",
      ...
      aboutJob: (title) => `About your job: ${title}.`,
      aboutInvoice: (ref) => `About your invoice ${ref}.`,
      when: "When",
      where: "Where",
  ...
  fr: {
    templateBlocks: {
      ...
      pending: "En attente",
      stageQuote: "Devis",
      stageDeposit: "Dépôt et planification",
      stageInvoice: "Facture et planification",
      stageStart: "Début du projet",
      stageComplete: "Projet terminé",
      thisCompany: "cette entreprise",
      marketingFooter: (company, a) => `Vous recevez ce courriel parce que vous êtes client de ${company}. ${a("Se désabonner")} des courriels promotionnels.`,
    },
    ...
    visit: {
      ...
      measureService: "visite d\u2019estimation sur place",
      ...
      aboutJob: (title) => `Concernant vos travaux : ${title}.`,
      aboutInvoice: (ref) => `Concernant votre facture ${ref}.`,
      when: "Quand",
      where: "Où",
  ...
  es: {
    templateBlocks: {
      ...
      pending: "Pendiente",
      stageQuote: "Presupuesto",
      stageDeposit: "Depósito y programación",
      stageInvoice: "Factura y programación",
      stageStart: "Inicio del proyecto",
      stageComplete: "Proyecto terminado",
      thisCompany: "esta empresa",
      marketingFooter: (company, a) => `Recibe este correo porque es cliente de ${company}. ${a("Darse de baja")} de los correos promocionales.`,
    },
    ...
    visit: {
      ...
      measureService: "visita de estimaci\u00f3n en sitio",
      ...
      aboutJob: (title) => `Sobre su trabajo: ${title}.`,
      aboutInvoice: (ref) => `Sobre su factura ${ref}.`,
      when: "Cuándo",
      where: "Dónde",
  ...
  uk: {
    templateBlocks: {
      ...
      pending: "Очікується",
      stageQuote: "Кошторис",
      stageDeposit: "Завдаток і планування",
      stageInvoice: "Рахунок і планування",
      stageStart: "Початок проєкту",
      stageComplete: "Проєкт завершено",
      thisCompany: "цієї компанії",
      marketingFooter: (company, a) => `Ви отримали цей лист, бо є клієнтом ${company}. ${a("Відписатися")} від рекламних листів.`,
    },
    ...
    visit: {
      ...
      aboutJob: (title) => `Щодо вашого замовлення: ${title}.`,
      aboutInvoice: (ref) => `Щодо вашого рахунку ${ref}.`,
      when: "Коли",
      where: "Де",
  ...
  pa: {
    templateBlocks: {
      ...
      pending: "ਬਾਕੀ",
      stageQuote: "ਹਵਾਲਾ",
      stageDeposit: "ਜਮ੍ਹਾਂ ਰਕਮ ਅਤੇ ਸਮਾਂ-ਸਾਰਣੀ",
      stageInvoice: "ਬਿੱਲ ਅਤੇ ਸਮਾਂ-ਸਾਰਣੀ",
      stageStart: "ਪ੍ਰੋਜੈਕਟ ਦੀ ਸ਼ੁਰੂਆਤ",
      stageComplete: "ਪ੍ਰੋਜੈਕਟ ਪੂਰਾ",
      thisCompany: "ਇਸ ਕੰਪਨੀ",
      marketingFooter: (company, a) => `ਤੁਹਾਨੂੰ ਇਹ ਈਮੇਲ ਇਸ ਲਈ ਮਿਲੀ ਹੈ ਕਿਉਂਕਿ ਤੁਸੀਂ ${company} ਦੇ ਗਾਹਕ ਹੋ। ਮਾਰਕੀਟਿੰਗ ਈਮੇਲਾਂ ਤੋਂ ${a("ਗਾਹਕੀ ਰੱਦ ਕਰੋ")}।`,
    },
    ...
    visit: {
      ...
      measureService: "ਸਾਈਟ ਉੱਤੇ ਅੰਦਾਜ਼ਾ",
      ...
      aboutJob: (title) => `ਤੁਹਾਡੇ ਕੰਮ ਬਾਰੇ: ${title}।`,
      aboutInvoice: (ref) => `ਤੁਹਾਡੇ ਇਨਵੌਇਸ ${ref} ਬਾਰੇ।`,
      when: "ਕਦੋਂ",
      where: "ਕਿੱਥੇ",
  ...
  tl: {
    templateBlocks: {
      ...
      pending: "Nakabinbin",
      stageQuote: "Quote",
      stageDeposit: "Deposito at iskedyul",
      stageInvoice: "Invoice at iskedyul",
      stageStart: "Simula ng proyekto",
      stageComplete: "Tapos na ang proyekto",
      thisCompany: "kompanyang ito",
      marketingFooter: (company, a) => `Natatanggap mo ito dahil customer ka ng ${company}. ${a("Mag-unsubscribe")} sa mga marketing email.`,
    },
    ...
    visit: {
      ...
      measureService: "on-site na pagtaya",
      ...
      aboutJob: (title) => `Tungkol sa iyong trabaho: ${title}.`,
      aboutInvoice: (ref) => `Tungkol sa iyong invoice ${ref}.`,
      when: "Kailan",
      where: "Saan",
  ...
  de: {
    templateBlocks: {
      ...
      pending: "Ausstehend",
      stageQuote: "Angebot",
      stageDeposit: "Anzahlung & Terminplanung",
      stageInvoice: "Rechnung & Terminplanung",
      stageStart: "Projektbeginn",
      stageComplete: "Projekt abgeschlossen",
      thisCompany: "diesem Unternehmen",
      marketingFooter: (company, a) => `Sie erhalten diese E-Mail, weil Sie Kunde von ${company} sind. Von Marketing-E-Mails ${a("abmelden")}.`,
    },
    ...
    visit: {
      ...
      measureService: "Vor-Ort-Termin zur Kostensch\u00e4tzung",
      ...
      aboutJob: (title) => `Zu Ihrem Auftrag: ${title}.`,
      aboutInvoice: (ref) => `Zu Ihrer Rechnung ${ref}.`,
      when: "Wann",
      where: "Wo",
  ...
  it: {
    templateBlocks: {
      ...
      pending: "In attesa",
      stageQuote: "Preventivo",
      stageDeposit: "Acconto e pianificazione",
      stageInvoice: "Fattura e pianificazione",
      stageStart: "Inizio lavori",
      stageComplete: "Lavori completati",
      thisCompany: "questa azienda",
      marketingFooter: (company, a) => `Riceve questa email perché è cliente di ${company}. ${a("Annulli l'iscrizione")} alle email promozionali.`,
    },
    ...
    visit: {
      ...
      what: "Cosa",
      serviceFallback: "visita",
      measureService: "sopralluogo per il preventivo",
      ...
      aboutJob: (title) => `Riguardo al suo lavoro: ${title}.`,
      aboutInvoice: (ref) => `Riguardo alla sua fattura ${ref}.`,
      when: "Quando",
      where: "Dove",
