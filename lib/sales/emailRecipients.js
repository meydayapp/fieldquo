 ...
 *
 * @param lead      { email, prospect?: { email } }
 ...
 *          own address first, then the prospect's, then people who wrote in,
 *          then people who were copied, then the rep. `label` names the
 *          source so the picker can say "wrote in on this thread".
 */
