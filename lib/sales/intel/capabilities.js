...
const CAPABILITIES = [
  // ── Being findable and reachable at all ──────────────────────────────────
  {
    ...
    description:
      "A real site at their own address on fieldquo.com, built from what they " +
      "already do, that they can change themselves.",
    matrixKeys: ["website_builder"],
    salesPriority: 95,
    tableStakes: DIFFERENTIATOR,
    incompatibilities: [],
    talkingPoints: [
      "You get a site of your own, not a profile page on somebody else's directory.",
  ...
  },
  {
    ...
    description:
      "Documents and client emails in the language the client actually reads — eight of them, not two.",
    matrixKeys: ["languages"],
    salesPriority: 38,
    tableStakes: DIFFERENTIATOR,
    incompatibilities: [],
    talkingPoints: [
      "Send the quote in French to the client who reads French, Spanish to the one who reads Spanish — eight languages, and the app itself can stay in English.",
