...
export const SIGNALS = Object.freeze({
  ...
  // Whose site the record's URL is — lib/sales/intel/siteKind.js. Direct,
  // because the verdict rests on structural observations (a host on a list,
  // a listing site's own menu items, a provider search form) and never on a
  // phrase in prose; the classifier's own confidence is on the row.
  "detection.site_kind": { category: "detection_direct", weight: 0.8 },
