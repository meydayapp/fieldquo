 ...
 */
export function planPlacesWrite({ prospect, place, score = null, placeIdTakenBy = null, existingNumbers = [], now = new Date() } = {}) {
  ...
  const cite = (field, rawValue, normalizedValue = null) =>
    evidence.push({
      ...
      observedAt: now,
      confidence: 1.0,
      detector: `${PLACES_DETECTOR}:${field}`,
      detectorVersion: PLACES_DETECTOR_VERSION,
    });
