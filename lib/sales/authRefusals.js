...
export const AUTH_REFUSAL_KEYS = Object.freeze({
  ...
  // A session ended from elsewhere (lib/sales/auth.js sessionSuperseded):
  // the newer sign-in, or a supervisor's Sign out on the floor board.
  signed_in_elsewhere: "app.salesAuth.session.elsewhere",
  signed_out_by_supervisor: "app.salesAuth.session.supervisor",
});
