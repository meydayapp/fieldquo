 ...
 */
export function windowFor({ prospect = {}, timeZone = null, repZone = null, shiftEnd = null, now = new Date(), language = "en" } = {}) {
  const readiness = salesCallReadiness({ prospect, timeZone, now, language });
 ...
 *          answer per row.
 */
export function groupByWindow(rows = [], { repZone = null, shiftEnd = null, now = new Date(), language = "en" } = {}) {
