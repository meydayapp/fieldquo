  ...
  if (presented.value === null) {
    return {
      ...
      detail: listing
        ...
        : "We could not look, so nothing is claimed either way. Ask them.",
      sayable: false,
      tone: "unknown",
    };
  }
...
export function prospectView({
  ...
  return {
    ...
    facts: [...prospectFacts(prospect, { derivedSite }), serviceMenuFact(serviceMenuFromEvidence(evidence))].filter(Boolean),
