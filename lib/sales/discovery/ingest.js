...
export function planIngest(businesses = [], context = {}, index = null) {
  ...
  for (const business of Array.isArray(businesses) ? businesses : []) {
    ...
    //
    //   maps to a DIFFERENT trade   still skipped outright. This row belongs to
    //                               another trade's campaign and writing it
    //                               here would file it under this campaign and
    //                               its territory, which is a claim about it
    //                               that nobody made.
