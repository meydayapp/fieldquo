  ...
  return [
    {
      ...
      // where that shows up.
      note:
        "Rows this campaign's sources returned for this territory and trade. A business listed by two " +
        "sources is two rows here, flagged as a possible duplicate rather than merged.",
      kind: "total",
    },
    {
      key: "unmapped",
