...
/**
 * How often the rep's panel asks while a signup is live. Thirty seconds —
 * it was ten, and two mounts of the panel on one console made that twelve
 * reads a minute per lead. The panel floors whatever this says at
 * MIN_PANEL_POLL_MS (lib/sales/signupProgressPoll.js) and stops on a 404
 * or a completed row; this is the cadence for the one case that changes.
 */
export const PROGRESS_POLL_MS = 30 * 1000;
