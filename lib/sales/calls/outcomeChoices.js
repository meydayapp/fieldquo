...
//   5  Text me instead          → text_instead (2026-09-18: no re-dial, the
...
// "Text me instead" (2026-09-18): a fifth primary, because it is the answer
// the owner's reps were hearing and had no button for. Folds to
// text_instead, whose save opens the composer.
export const CHOICE_TEXT_INSTEAD = "text_instead";
...
export const OUTCOME_CHOICES = Object.freeze([
  ...
  Object.freeze({ key: CHOICE_TEXT_INSTEAD, primary: true, hotkey: "5", folds: Object.freeze(["text_instead"]) }),
...
export function foldChoice(input) {
  ...
  switch (key) {
    ...
    case CHOICE_TEXT_INSTEAD:
      return done("text_instead");
