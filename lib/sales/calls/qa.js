...
export async function scoreAttempt(
  ...
  // The name the rep SAYS on the call — their work name, else their first
  // name — is the one the "did they name themselves" check listens for.
  const repName = repPublicName(attempt.salesRep);
