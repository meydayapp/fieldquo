...
export function ringPlan({
  ...
  if (lastCalledBy) {
    ...
    if (verdict === LAST_CALLER_RING) {
      pushRep(lastCalledBy, recentDial(lastCalledAt, now) ? "they rang this contractor minutes ago" : "they rang this contractor last");
    } else if (verdict === LAST_CALLER_HOLD && mayRing(lastCalledBy) && !seen.has(lastCalledBy)) {
