...
// The href builders are ./callerHrefs.js (a file with no imports, so a
// client component can use one without dragging lib/db in — its header
// says which screen needed that). Re-exported here so every caller of this
// module is unchanged.
import { consoleHref, leadHref, newLeadHref } from "./callerHrefs";

export { consoleHref, leadHref, newLeadHref };
