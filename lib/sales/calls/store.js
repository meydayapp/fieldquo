...
import { retryWriteFor } from "../retryPool";
...
export async function saveDisposition({
  ...
  // returned beside the attempt so the console can say "Retry 2 of 4 — next
  // at 14:30" from the response rather than waiting for a reload.
  let retry = null;
