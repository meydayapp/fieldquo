 ...
 */
export function buildCallActivity({ reps = [], attempts = [], from = null, to = null, now = new Date(), carrierLegs = null } = {}) {
  ...
  return {
    ...
    reconciliation: carrierLegs && !carrierLegs.error ? reconciliationLine({ legs: carrierLegs.legs, attempts: everyone, listedAll: carrierLegs.listedAll }) : null,
...
export function buildPerformanceReport({
  ...
  return {
    ...report,
    scope: { repIds: scope },
    calls: buildCallActivity({ reps: scopedReps, attempts: scopedAttempts, from, to, now, carrierLegs }),
