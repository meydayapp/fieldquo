...
import { proofViewFor } from "./payoutProof";
...
function weekOf(batch, entries) {
  ...
  return {
    ...
    // How it was paid, and the receipt — the rep's own payment record, so
    // "Paid 15 Sep" is something they can check rather than take on trust.
    // Selected by name through proofViewFor, never spread from the row.
    ...proofViewFor(batch),
