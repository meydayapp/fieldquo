 ...
 * claimed prospect, none per backlog row — is one line with a name.
 */
 ...
 *
 *  @param priority  the task's lane (priority.js). "claimed" continues past
 *                   the brief into CLAIMED_TAIL; anything else ends there. */
export function nextStageFor(kind, { priority = null } = {}) {
  ...
  if (NEXT_STAGE[kind] === null && priority === "claimed" && Object.hasOwn(CLAIMED_TAIL, kind)) {
