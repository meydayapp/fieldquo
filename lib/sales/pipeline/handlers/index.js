...
//
// ══ Four of the eight stages are real, and that is the honest state ═══════
//
// DISCOVER_BUSINESSES, CRAWL_WEBSITE, DETECT_TECHNOLOGY and
// ANALYZE_CAPABILITIES are implemented and imported below. The other four are
// not, and the registry holds a "not implemented" stand-in
// for each, which records a terminal `abandoned` row naming the missing
// handler — so a pipeline run today reports exactly what is and is not built,
