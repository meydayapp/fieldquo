...
// Wrapped — see chain.js. "No crawled page loaded" is terminal here and must
// NOT end the prospect's pipeline: the capability pass writes the unknowns,
// the score reads them, and the brief says the site could not be read. That is
// a useful card; silence is not.
registerHandler("DETECT_TECHNOLOGY", withChain("DETECT_TECHNOLOGY", handleDetectTechnology));
