    ...
    return shape(
      ...
      held > 0
        ? // No count in the English, and that is the point. The number and its
          ...
          "Pick one of the prospects you hold from the list and its number, and whether you " +
      ...
      return shape(
        ...
        contact.text ||
          "Ringing our own infrastructure bridges a loop and bills both legs, so no dial control " +
            "is offered on it. If this is the prospect's real number, it is on one of FieldQuo's " +
