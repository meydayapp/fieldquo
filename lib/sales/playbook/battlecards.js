...
function saidOutLoud({ name, theyDoWell, weWin, gateGap, price, math, limits }) {
  ...
  lines.push({
    beat: "ask",
    text: weWin[0]
      ? `Give me your logo and the colour you use and I will build one real quote with your name on it — put it next to the last one you sent out of ${name} and tell me what is wrong with it.`
      : `Give me your logo and the colour you use and I will build one real quote with your name on it — put it next to the last one you sent and tell me what is wrong with it.`,
