...
const OBJECTIONS = [
  {
    ...
    response:
      ...
      "solve it in, and I am not going to tell you your scheduler is broken. The one thing it " +
      "does not decide is whose name the homeowner sees: with us the quote, the invoice, the " +
      "booking page and every email between them carry yours, and none of them carry ours. " +
      "Nothing has to come off what you already use for you to look at that. Give me your logo " +
      "and the colour you use and I will build one real quote with your name on it — put it " +
      "next to the last one you sent, and tell me what is wrong with it.",
  },
  {
    code: "TOO_EXPENSIVE",
    ...
    response:
      ...
      "never got round to sending is worth to you. You are the only one who knows your average " +
      "job. Tell me roughly what that is and I will do the arithmetic with your figure instead " +
      "of mine, in writing, so you can read it when you are not standing on somebody's drive.",
  },
  {
