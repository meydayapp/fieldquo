...
const OBJECTIONS = [
  {
    ...
    response:
      ...
      "fifteen minutes and I will show you how it works for a business like yours — a quote " +
      "with your name on it, review and all, next to the last one you sent. Then tell me what " +
      "is wrong with it.",
  },
  {
    code: "TOO_EXPENSIVE",
  ...
  },
  {
    ...
    response:
      ...
      "Rather than argue about how long it takes: give me fifteen minutes and one job you have " +
      "already done, and I will show you how it would really run for you. Then you tell me " +
      "whether that was the effort you were picturing.",
  },
  {
    ...
    response:
      ...
      "about that one, which is exactly why it is worth a look rather than a shrug. Give me " +
      "fifteen minutes and three photos of a job you are proud of, and I will show you what " +
      "that neighbour would have found — then tell me what is wrong with it.",
  },
  {
    ...
    response:
      ...
      "happen. Tell me the hours you would genuinely accept, and give me fifteen minutes — I " +
      "will show you how it works inside those hours, and you look at it before anybody else " +
      "can.",
  },
  {
    ...
    response:
      ...
      "me the four things you always end up asking, and give me fifteen minutes — I will show " +
      "you how it works with your questions, not ours.",
  },
  {
    code: "SEND_ME_INFO",
    ...
    response:
      ...
      "back. What works better for you, mornings or afternoons?",
  },
  {
    code: "NOT_INTERESTED",
  ...
  // customer list ends up.
  {
    ...
    response:
      ...
      "you on the phone, or fifteen minutes with you now and I will send over what we looked " +
      "at, so what they are looking at is the thing itself. Tell me which of those is easier " +
      "this week.",
  },
  {
    ...
    response:
      ...
      "The part that would take an afternoon is fifteen minutes on a screen, not an afternoon " +
      "of yours. And the month " +
  ...
  },
  {
    ...
    response:
      ...
      "billed per head, so taking somebody on does not become a reason to leave. Give me " +
      "fifteen minutes and one job you have already done, and I will show you how it would " +
      "really run for one person. Then you tell me whether that is more work than what you do " +
      "now or less.",
  },
  {
    code: "PLENTY_OF_WORK",
  ...
  },
  {
    ...
    response:
      ...
      "back to you. Give me fifteen minutes and one job out of the book — a real one, your own " +
      "numbers — and I will show you it next to what you would have sent, and you say which " +
      "one you would rather a customer opened.",
  },
  {
    code: "NEED_TO_THINK",
    ...
    response:
      ...
      "itself. So let me take the deciding out of it. Give me fifteen minutes and I will show " +
      "you how it works for a business like yours — a real quote with your name on it, at no " +
      "cost and with nothing attached to it — and you can think about that instead of about " +
      "me. Tell me which day next week I should keep clear of, and I will ring you on a " +
      "different one.",
  },
  {
