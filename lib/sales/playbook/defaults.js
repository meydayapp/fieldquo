...
const PLAYBOOKS = [
  {
    ...
    stages: {
      ...
      fit: {
        say:
          "Then here's the only claim I'll make today, and it answers what you just said: " +
          "everything the homeowner sees is yours. Your logo, your colour, your name in the from " +
          "line — on the quote, on the invoice, on every email between them. Somebody holding " +
          "three quotes cannot tell that two of them were written in the same software. And " +
          "before you have to raise it: nothing has to come off {competitor} for you to look at " +
          "that. Nothing gets switched off, nothing gets imported, nobody learns anything this week.",
        prompts: [],
      },
