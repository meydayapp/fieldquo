...
const PLAYBOOKS = [
    ...
    stages: {
      ...
      fit: {
        say:
          ...
          "sees is yours. Your logo, your colour, your name in the from line. " +
...

  {
    ...
    stages: {
      ...
      fit: {
        say:
          "The short version: we build the site out of the jobs you've already done, at your own " +
          "address on fieldquo.com, and it takes an afternoon rather than a project. You don't " +
          "write anything.",
        prompts: [],
      },
      objections: { say: "", prompts: [] },
