    ...
    lines: [
      {
        ...
        text:
          ...
          "than a sales call. I'm on {repPhone}. That's {repPhone}. I'll try you again Thursday " +
          "morning either way.",
      },
    ],
    notes: [
    ...
    lines: [
      {
        ...
        text: "{repName} from FieldQuo. Thursday half seven as agreed - quote with your name on it lands Wednesday night.",
      },
      {
        label: "After a voicemail",
        text: "{repName} from FieldQuo. Left you a message about your quotes - no need to ring back, I'll try you Thursday.",
      },
      {
    ...
    lines: [
      ...
      },
      {
        ...
        text:
          ...
          "Thursday at half seven still suits me. If it stops suiting you, tell me and we'll move " +
...

  {
    ...
    lines: [
      ...
      },
      {
        ...
        text:
          "Good. Send me your rates however they exist — a spreadsheet, a photo of a page, " +
          "whatever you actually use — and I'll have it ready to send from tomorrow. Then send " +
          "one real quote out of it and ring me if it feels wrong.",
      },
    ],
    notes: [
