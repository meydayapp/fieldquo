...

  {
    ...
    lines: [
      ...
      },
      {
        ...
        text:
          "Good. Your rates go in however they exist — a spreadsheet, a photo of a page, " +
          "whatever you actually use — and the setup steps in your account walk you through it. " +
          "Then send one real quote out of it and ring me if it feels wrong.",
      },
    ],
    notes: [
