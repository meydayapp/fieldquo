...
//
// ══ `name` is what the rep sees; `purpose` is a note to the AUTHOR ═══════
//
// The owner opened a prospect and read "Establish relevance — One sentence
// that could only have been said to this business. Not a compliment — a
// reason this call is not a cold list." and said: "I don't even understand
// what this is about." He was right. That paragraph explains the stage to
// whoever writes the lines for it; a rep on a live call needs the stage's
// name and the words, nothing else. So `name` is now two or three plain
// words — Open · Why them · Ask · How it works today · What it costs them ·
// What we do · If they push back · Next step · Wrap up — `nameKey` is the
// catalogue key the rep's screen translates it by, and `purpose` stays for
// the platform console and for a collapsed "why this stage exists" the rep
// can open and by default does not.
//
...
export const STAGES = Object.freeze([
  {
    key: "open",
    name: "Open",
    nameKey: "app.salesCall.stage.open",
    purpose:
  ...
  },
  {
    key: "relevance",
    name: "Why them",
    nameKey: "app.salesCall.stage.relevance",
    purpose:
  ...
  },
  {
    key: "discovery",
    name: "Ask",
    nameKey: "app.salesCall.stage.discovery",
    purpose:
  ...
  },
  {
    ...
    nameKey: "app.salesCall.stage.current_process",
    purpose:
  ...
  {
    key: "pain",
    name: "What it costs them",
    nameKey: "app.salesCall.stage.pain",
    purpose:
  ...
  },
  {
    key: "fit",
    name: "What we do",
    nameKey: "app.salesCall.stage.fit",
    purpose:
  ...
  },
  {
    ...
    nameKey: "app.salesCall.stage.objections",
    purpose:
  ...
  },
  {
    key: "next_step",
    name: "Next step",
    nameKey: "app.salesCall.stage.next_step",
    purpose:
  ...
  },
  {
    key: "close",
    name: "Wrap up",
    nameKey: "app.salesCall.stage.close",
    purpose:
