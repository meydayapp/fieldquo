...
export function salesCallReadiness({
  ...
  if (testLine === true) return testLineReadiness({ blockers, warnings, unenforced });
...
/**
 * The answer for one of our own phones.
 *
 ...
 * lines on those being present, and a test line has none of them to print.
 ...
 * language, and it says the two things a rep needs: this is our own number,
 * and the dial will not be counted.
 */
function testLineReadiness({ blockers, warnings, unenforced }) {
  unenforced.push({
    code: "test_line",
