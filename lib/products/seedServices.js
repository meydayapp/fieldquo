...
import { planServiceSeeds, seedText, seedTemplateFor, seedCategoryKeys, serviceSeedsFor } from "@/lib/services/seeds";
 ...
 */
export function productDataForSeed(service, { companyId, categoryId, language, currency, categoryIdsByKey = null }) {
  ...
  const { templateLines, defaultDiscount, imageUrl, estimateTypes } = seedTemplateFor(service, { language, currency });
