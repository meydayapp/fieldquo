...
// 14 Aug" — was written and then taken back out. Nothing stores the receipt
// image: JobMaterial has no attachment column, Expense has none either, and
// the schema is closed for this session. A human-readable name for a file
// nobody keeps is a field written and read by nothing, which is the first
// failure class in AGENTS.md. It goes back in the day there is somewhere to
// put the photo.
//
