...
export function simulatedExtraction() {
  return {
    ...
    merchantCity: "Montréal",
    merchantPostalCode: "H3B 1A1",
    ...
    currencyCode: "CAD",
    items: [
      { description: "Primer, 3.78 L", quantity: "2", unitPrice: "42.50", lineTotal: "85.00", sku: "PR-378", kind: "materials" },
      { description: "Sandpaper 180 grit, 25 pk", quantity: "1", unitPrice: "18.75", lineTotal: "18.75", sku: null, kind: "materials" },
      { description: "Painter's tape 48 mm", quantity: "4", unitPrice: "7.95", lineTotal: "31.80", sku: null, kind: "materials" },
    ],
    printedSubtotal: "135.55",
    // Quebec prints both taxes AND their sum — so both are here, and the
    // validator (lib/receipts/validate.js) checks one against the other.
    printedTax: "20.30",
    taxLines: [
      { label: "TPS/GST 5%", amount: "6.78" },
      { label: "TVQ/QST 9.975%", amount: "13.52" },
    ],
    printedTotal: "155.85",
