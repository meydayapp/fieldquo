...
/** Where a conversation came from. Meta's three, spelled the same everywhere. */
export const CONVERSATION_SOURCES = Object.freeze(["meta_messenger", "meta_instagram", "meta_lead_ad"]);
