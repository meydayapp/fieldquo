...
export const CONVERSATION_SOURCES = Object.freeze([
  ...
  "meta_whatsapp",
  "meta_lead_ad",
  // FieldQuo's own two channels — the site chat widget and the shared SMS
  // number — so a conversation the AI employee held there is attributed the
  // same way a Messenger one is, rather than dropping out of the rollup.
  "web_chat",
  "sms_chat",
  // An email thread filed from a connected work mailbox (lib/mailbox/) — an
  // email enquiry is reviewed like a text or chat one.
  "email",
]);
