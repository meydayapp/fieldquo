...
//   risers     = steps                one riser per step — the closed face
//                                     under each tread; an open-riser stair is
//                                     the estimator's correction, not the rule
 ...
 * @returns {{ steps, shape, treads, risers, balusters, posts, handrailFt, turns } | null}
 */
