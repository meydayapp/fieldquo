...
export function lockedEstimateMessage(language = "en") {
  const code = String(language || "en").slice(0, 2);
  const words = {
    en: {
      title: "Submit to reveal your estimate",
      body: "Fill in the form — your price range appears here instantly and lands in your inbox.",
    },
    fr: {
      title: "Soumettez pour voir votre estimation",
      body: "Remplissez le formulaire — votre fourchette de prix s’affiche ici immédiatement et vous est envoyée par courriel.",
    },
    es: {
      title: "Envíe el formulario para ver su estimación",
      body: "Complete el formulario — su rango de precio aparece aquí al instante y le llega por correo.",
    },
    // The five below exist for the lead funnel, which is drawn in the
    // company's language and so can be in any of the eight client languages
    // (lib/i18n/funnelCopy.js). The instant-quote page still offers en/fr/es
    // only, so for it these are unreachable rather than wrong.
    uk: {
      title: "Надішліть форму, щоб побачити оцінку",
      body: "Заповніть форму — діапазон ціни одразу з'явиться тут і надійде вам на пошту.",
    },
    pa: {
      title: "ਆਪਣਾ ਅਨੁਮਾਨ ਵੇਖਣ ਲਈ ਫਾਰਮ ਭੇਜੋ",
      body: "ਫਾਰਮ ਭਰੋ — ਤੁਹਾਡੀ ਕੀਮਤ ਦੀ ਰੇਂਜ ਤੁਰੰਤ ਇੱਥੇ ਦਿਖਾਈ ਦੇਵੇਗੀ ਅਤੇ ਤੁਹਾਡੀ ਈਮੇਲ ਵਿੱਚ ਵੀ ਆਵੇਗੀ।",
    },
    tl: {
      title: "Ipadala po ang form para makita ang inyong estimate",
      body: "Punan po ang form — lalabas agad dito ang saklaw ng presyo ninyo at ipapadala rin sa inbox ninyo.",
    },
    de: {
      title: "Absenden, um Ihre Schätzung zu sehen",
      body: "Füllen Sie das Formular aus – Ihre Preisspanne erscheint sofort hier und kommt auch per E-Mail.",
    },
    it: {
      title: "Invii il modulo per vedere la sua stima",
      body: "Compili il modulo: la sua fascia di prezzo compare subito qui e le arriva anche via email.",
    },
  };
  return {
    ...(words[code] || words.en),
...
export function gatedMessage(language = "en", stage = "confirmed") {
  ...
  const words = {
    en: {
      prompt: "We don't show prices online for this service. Leave your details and we'll confirm your price shortly.",
      confirmed: "No price is shown here — we review every job and send your quote ourselves.",
    },
    fr: {
      prompt: "Nous ne publions pas nos prix en ligne pour ce service. Laissez-nous vos coordonnées et nous confirmerons votre prix sous peu.",
      confirmed: "Aucun prix n'est affiché ici : nous examinons chaque projet et vous envoyons votre soumission nous-mêmes.",
    },
    es: {
      prompt: "No publicamos precios en línea para este servicio. Déjenos sus datos y confirmaremos su precio en breve.",
      confirmed: "Aquí no se muestra ningún precio: revisamos cada trabajo y le enviamos su presupuesto nosotros mismos.",
    },
    // Same reason as lockedEstimateMessage's five: the funnel runs in any of
    // the eight, and so does the confirmation email this also words.
    uk: {
      prompt: "Ми не публікуємо ціни на цю послугу онлайн. Залиште свої контакти, і ми невдовзі підтвердимо вашу ціну.",
      confirmed: "Ціна тут не показується — ми переглядаємо кожну роботу й самі надсилаємо вам кошторис.",
    },
    pa: {
      prompt: "ਅਸੀਂ ਇਸ ਸੇਵਾ ਲਈ ਕੀਮਤਾਂ ਆਨਲਾਈਨ ਨਹੀਂ ਦਿਖਾਉਂਦੇ। ਆਪਣੇ ਵੇਰਵੇ ਛੱਡੋ ਅਤੇ ਅਸੀਂ ਜਲਦੀ ਹੀ ਤੁਹਾਡੀ ਕੀਮਤ ਦੀ ਪੁਸ਼ਟੀ ਕਰਾਂਗੇ।",
      confirmed: "ਇੱਥੇ ਕੋਈ ਕੀਮਤ ਨਹੀਂ ਦਿਖਾਈ ਜਾਂਦੀ — ਅਸੀਂ ਹਰ ਕੰਮ ਦੀ ਸਮੀਖਿਆ ਕਰਦੇ ਹਾਂ ਅਤੇ ਤੁਹਾਡਾ ਕੋਟ ਖੁਦ ਭੇਜਦੇ ਹਾਂ।",
    },
    tl: {
      prompt: "Hindi po namin ipinapakita online ang presyo para sa serbisyong ito. Iwan po ang inyong detalye at kukumpirmahin namin agad ang presyo ninyo.",
      confirmed: "Walang presyong ipinapakita rito — sinusuri namin ang bawat trabaho at kami mismo ang magpapadala ng quote ninyo.",
    },
    de: {
      prompt: "Für diese Leistung veröffentlichen wir keine Preise online. Hinterlassen Sie Ihre Angaben, und wir bestätigen Ihnen Ihren Preis in Kürze.",
      confirmed: "Hier wird kein Preis angezeigt – wir prüfen jeden Auftrag und senden Ihnen Ihr Angebot selbst.",
    },
    it: {
      prompt: "Per questo servizio non pubblichiamo i prezzi online. Ci lasci i suoi dati e le confermeremo il prezzo a breve.",
      confirmed: "Qui non viene mostrato alcun prezzo: esaminiamo ogni lavoro e le inviamo noi il preventivo.",
    },
  };
  const t = words[code] || words.en;
  return stage === "prompt" ? t.prompt : t.confirmed;
}
