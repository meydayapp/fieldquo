...
//
// Invent a price, a date, or a policy. Those three are not tone — a made-up
// price is a number a homeowner holds the contractor to, a made-up date is a
// van nobody sent, and a made-up policy is a warranty nobody wrote. Every
// price comes from the company's own rows through a tool; every date comes
// from a callback request a person confirms; every policy comes from the
// material the company uploaded, quoted, or is not answered at all.
//
 ...
 */
export function buildEmployeePrompt({ employee = {}, company = {}, sources = [] } = {}) {
