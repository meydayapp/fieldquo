 ...
 * WhatsApp and its Meta error classification. There is no second send path
 * here and there must never be one; WHICH API the reply leaves over is decided
 * in lib/messaging/send.js from the channel's platform, not here.
 */
