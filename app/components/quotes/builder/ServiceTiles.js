...
//
// The cards' description, price and "Add with its template lines" (the
// `details` prop of 2026-09-22) moved into the Add service dialog on
// 2026-09-25 (AddServicePicker.js): the foot of the quote is that control
// now, and a card shape that drew them had no caller left. The row of pills
// is still the inline path there, and the card is EstimateTypeFirst's
// "Other trades".
