...
// ── No bookkeeping export ──────────────────────────────────────────────────
//
// A "Bookkeeping export" card used to sit at the foot of this screen: a date
// range of invoices, payments and expenses as a ZIP of CSVs. It is gone on the
// owner's decision of 2026-09-24 — a company can import into FieldQuo but not
// export out of it, paying customers included. GET /api/export/accounting and
// lib/export/accountingExport.js are kept (the helpers in the latter are
// shared by analytics and payroll), and the route answers 403 through
// lib/export/companyDataExport.js. The card is removed rather than disabled:
// a button whose only answer is "Export isn't available" is the dead control
