// app/app/settings/email-templates/EmailTemplatesManager.js
//
// The whole of Settings > Email templates as one component. The page renders
// it, and so does the home page's "Review your emails" dialog
// (app/components/dashboard/stepPanels.js): the same document-email
// previews, the same template list, the same duplicate and delete. Editing
// a template's CONTENT is a full-page canvas editor ([id]/page.js) in both
// places — the dialog says so beside the list, and Edit is the same link.
//
// `compact` drops the page heading and the "Back to home" link; `onChanged`
// fires after a template is added, duplicated or deleted so the checklist
// can re-read itself. The page passes neither.
//
...
export default function EmailTemplatesManager({ compact = false, onChanged } = {}) {
  ...
  return (
    <div className={compact ? "space-y-8" : "p-4 sm:p-6 max-w-3xl mx-auto space-y-8"}>
