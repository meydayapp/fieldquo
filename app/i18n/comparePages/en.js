...
const en = {
  ...
  "compare.indexLede": "Seven comparisons, each built from what the other company publishes on its own website. Nothing here is converted between currencies, nothing is a promotional rate, and anything we could not settle is named rather than guessed. Two of the seven start cheaper than we do, and those pages say so before they say anything else.",
  ...
  "compare.lede.jobber": "Jobber sells its marketing suite, its AI receptionist and its sales pipeline as separate monthly add-ons — {addOnTotal} a month on top of a plan whose price already moves with your team size. FieldQuo puts all three in every plan, at every price, and everybody in a van is free.",
  ...
  "compare.lede.housecall_pro": "Housecall Pro charges for each extra user, so the plan price is only where your bill starts. FieldQuo bills the people who actually price work — quotes, jobs, invoices — and everybody in a van is crew, at no charge. Every feature is in every plan, starting at {ourEntry}.",
  ...
  "compare.lede.projul": "Projul asks for a flat annual commitment up front. FieldQuo is {ourEntry} a month for one seat and five crew, every feature included, and you can leave at the end of any month — you do not have to buy a year to find out whether it suits you.",
  ...
  "compare.lede.quoteiq": "QuoteIQ starts at {theirEntry}, and that plan cannot build you a website, take a booking, or let a homeowner price their own job. The QuoteIQ plan that carries what FieldQuo puts in every plan is their Max tier, at {theirParity} a month. Ours is {ourEntry} — and forty-one things on our list are not in their line-up at any price.",
  ...
  "compare.case.headlineTheirsPlusAddOns": "At {competitor} the same list is {price} a month, plus {addOns} in add-ons.",
  "compare.rows.parityOnlyPlan": "{plan} — their only plan; the rest is sold as add-ons",
  "compare.rows.parityCheapestToo": "{plan} — their cheapest plan carries it",
  "compare.rows.usersPlusEach": "{users} included, {amount}/mo for each one after",
  "compare.receptionistAddOnOnlyIntro": "No {competitor} tier lists it as included. Their page sells it as an add-on on top of the plan.",
  "compare.receptionistAddOnOnly": "It is {availability}: {price}. That is a floor you pay in a month when the phone never rings.",
  ...
  "compare.capability.payments_in_canada": "Card and bank payments for a Canadian business",
  "compare.rows.theirLimit": "Their page: “{limit}”",
  "compare.rows.unlimitedUsersCap": "Unlimited users",
  "compare.rows.unlimitedEveryPlan": "On every plan, in their words",
  "compare.rows.notCounted": "Not counted",
  "compare.rows.flatFeeSub": "A flat fee — headcount does not move their price",
  "compare.rows.addOnAtPrice": "{addOn} add-on — {amount}/mo",
  "compare.rows.soldSeparately": "sold separately, on top of the plan",
  "compare.case.seatWorking": "{base} + {extra} × {perUser} more users",
  "compare.perUseTitle": "Charged per use, on top of the plan",
  "compare.perUseIntro": "{competitor} prices these per use on every plan, so the plan price above is where their bill starts and not where it ends. FieldQuo has no charge of this kind: measuring a roof from its address is in every plan at the plan price.",
  ...
  "compare.case.headlineTheirsAnnual": "At {competitor} the same list is {price} a year.",
  ...
  "compare.case.calcAfter": "and see every company side by side.",
  ...
  "compare.rows.annualOnlyPlain": "{plan} — billed as a year",
  ...
  "compare.rows.tierAtAnnualPrice": "{plan} — {amount}/yr",
