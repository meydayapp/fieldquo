...
const pa = {
  ...
  "compare.indexLede": "ਸੱਤ ਤੁਲਨਾਵਾਂ, ਹਰ ਇੱਕ ਉਸ ਗੱਲ ਤੋਂ ਬਣੀ ਜੋ ਦੂਜੀ ਕੰਪਨੀ ਆਪਣੀ ਵੈੱਬਸਾਈਟ ਉੱਤੇ ਆਪ ਛਾਪਦੀ ਹੈ। ਇੱਥੇ ਕੋਈ ਰਕਮ ਇੱਕ ਮੁਦਰਾ ਤੋਂ ਦੂਜੀ ਵਿੱਚ ਨਹੀਂ ਬਦਲੀ ਗਈ, ਕੋਈ ਵੀ ਭਾਅ ਛੋਟ ਵਾਲਾ ਨਹੀਂ ਹੈ, ਅਤੇ ਜਿਹੜੀ ਗੱਲ ਅਸੀਂ ਪੱਕੀ ਨਾ ਕਰ ਸਕੇ ਉਹ ਅੰਦਾਜ਼ੇ ਨਾਲ ਭਰਨ ਦੀ ਥਾਂ ਸਾਫ਼ ਲਿਖ ਦਿੱਤੀ ਗਈ ਹੈ। ਸੱਤਾਂ ਵਿੱਚੋਂ ਦੋ ਸਾਡੇ ਨਾਲੋਂ ਸਸਤੇ ਤੋਂ ਸ਼ੁਰੂ ਹੁੰਦੀਆਂ ਹਨ, ਅਤੇ ਉਹ ਪੰਨੇ ਹੋਰ ਕੁਝ ਕਹਿਣ ਤੋਂ ਪਹਿਲਾਂ ਇਹੀ ਕਹਿੰਦੇ ਹਨ।",
  ...
  "compare.lede.jobber": "Jobber ਆਪਣੀ marketing suite, ਆਪਣਾ AI ਰਿਸੈਪਸ਼ਨਿਸਟ ਅਤੇ ਆਪਣੀ ਸੇਲਜ਼ ਪਾਈਪਲਾਈਨ ਵੱਖਰੇ ਮਹੀਨਾਵਾਰ ਐਡ-ਆਨ ਵਜੋਂ ਵੇਚਦਾ ਹੈ — ਉਸ ਪਲਾਨ ਦੇ ਉੱਤੇ {addOnTotal} ਮਹੀਨਾ, ਜਿਸ ਦੀ ਕੀਮਤ ਪਹਿਲਾਂ ਹੀ ਤੁਹਾਡੀ ਟੀਮ ਦੇ ਆਕਾਰ ਨਾਲ ਬਦਲਦੀ ਹੈ। FieldQuo ਇਹ ਤਿੰਨੇ ਹਰ ਪਲਾਨ ਵਿੱਚ, ਹਰ ਕੀਮਤ ਉੱਤੇ ਰੱਖਦਾ ਹੈ, ਅਤੇ ਵੈਨ ਵਿੱਚ ਬੈਠਾ ਹਰ ਬੰਦਾ ਮੁਫ਼ਤ ਹੈ।",
  ...
  "compare.lede.projul": "Projul ਪਹਿਲਾਂ ਹੀ ਪੂਰੇ ਸਾਲ ਦੀ ਇੱਕੋ ਜਿਹੀ ਵਚਨਬੱਧਤਾ ਮੰਗਦਾ ਹੈ। FieldQuo ਇੱਕ ਸੀਟ ਅਤੇ ਪੰਜ ਕਰੂ ਲਈ {ourEntry} ਮਹੀਨਾ ਹੈ, ਹਰ ਸਹੂਲਤ ਸ਼ਾਮਲ, ਅਤੇ ਤੁਸੀਂ ਕਿਸੇ ਵੀ ਮਹੀਨੇ ਦੇ ਅੰਤ 'ਤੇ ਛੱਡ ਸਕਦੇ ਹੋ — ਇਹ ਜਾਣਨ ਲਈ ਕਿ ਇਹ ਤੁਹਾਡੇ ਲਈ ਠੀਕ ਹੈ ਜਾਂ ਨਹੀਂ, ਤੁਹਾਨੂੰ ਪੂਰਾ ਸਾਲ ਖਰੀਦਣ ਦੀ ਲੋੜ ਨਹੀਂ।",
  ...
  "compare.lede.quoteiq": "QuoteIQ {theirEntry} ਤੋਂ ਸ਼ੁਰੂ ਹੁੰਦਾ ਹੈ, ਅਤੇ ਉਹ ਪਲਾਨ ਤੁਹਾਡੇ ਲਈ ਵੈੱਬਸਾਈਟ ਨਹੀਂ ਬਣਾ ਸਕਦਾ, ਬੁਕਿੰਗ ਨਹੀਂ ਲੈ ਸਕਦਾ, ਅਤੇ ਨਾ ਹੀ ਘਰ ਵਾਲੇ ਨੂੰ ਆਪਣੇ ਕੰਮ ਦੀ ਕੀਮਤ ਆਪ ਕੱਢਣ ਦਿੰਦਾ ਹੈ। QuoteIQ ਦਾ ਉਹ ਪਲਾਨ ਜਿਸ ਵਿੱਚ ਉਹ ਸਭ ਹੈ ਜੋ FieldQuo ਹਰ ਪਲਾਨ ਵਿੱਚ ਪਾਉਂਦਾ ਹੈ, ਉਹਨਾਂ ਦਾ Max ਪੱਧਰ ਹੈ, {theirParity} ਮਹੀਨਾ। ਸਾਡਾ {ourEntry} ਹੈ — ਅਤੇ ਸਾਡੀ ਸੂਚੀ ਦੀਆਂ ਇਕਤਾਲੀ ਚੀਜ਼ਾਂ ਉਹਨਾਂ ਦੀ ਲਾਈਨ-ਅੱਪ ਵਿੱਚ ਕਿਸੇ ਵੀ ਕੀਮਤ ਉੱਤੇ ਨਹੀਂ ਹਨ।",
  ...
  "compare.case.headlineTheirsPlusAddOns": "{competitor} ਕੋਲ ਓਹੀ ਸੂਚੀ ਮਹੀਨੇ ਦੇ {price} ਦੀ ਹੈ, ਨਾਲ {addOns} ਐਡ-ਆਨ ਦੇ।",
  "compare.rows.parityOnlyPlan": "{plan} — ਉਹਨਾਂ ਦਾ ਇੱਕੋ-ਇੱਕ ਪਲਾਨ; ਬਾਕੀ ਐਡ-ਆਨ ਵਜੋਂ ਵਿਕਦਾ ਹੈ",
  "compare.rows.parityCheapestToo": "{plan} — ਉਹਨਾਂ ਦੇ ਸਭ ਤੋਂ ਸਸਤੇ ਪਲਾਨ ਵਿੱਚ ਹੈ",
  "compare.rows.usersPlusEach": "{users} ਸ਼ਾਮਲ, ਹਰ ਅਗਲੇ ਲਈ {amount}/ਮਹੀਨਾ",
  "compare.receptionistAddOnOnlyIntro": "{competitor} ਦਾ ਕੋਈ ਪਲਾਨ ਇਸ ਨੂੰ ਸ਼ਾਮਲ ਨਹੀਂ ਦੱਸਦਾ। ਉਹਨਾਂ ਦਾ ਪੰਨਾ ਇਸ ਨੂੰ ਪਲਾਨ ਦੇ ਉੱਤੇ ਐਡ-ਆਨ ਵਜੋਂ ਵੇਚਦਾ ਹੈ।",
  "compare.receptionistAddOnOnly": "ਇਹ {availability} ਹੈ: {price}। ਇਹ ਉਹ ਘੱਟੋ-ਘੱਟ ਰਕਮ ਹੈ ਜੋ ਤੁਸੀਂ ਉਸ ਮਹੀਨੇ ਵੀ ਦਿੰਦੇ ਹੋ ਜਦੋਂ ਫ਼ੋਨ ਕਦੇ ਨਹੀਂ ਵੱਜਦਾ।",
  "compare.lede.roofr": "Roofr SMS ਟੈਕਸਟਿੰਗ, ਆਪਣਾ Instant Estimator, ਇੱਕ ਵੈੱਬਸਾਈਟ ਅਤੇ ਇੱਕ AI ਰਿਸੈਪਸ਼ਨਿਸਟ ਵੱਖਰੇ ਮਹੀਨਾਵਾਰ ਐਡ-ਆਨ ਵਜੋਂ ਵੇਚਦਾ ਹੈ — ਪਲਾਨ ਦੇ ਉੱਤੇ {addOnTotal} ਪ੍ਰਤੀ ਮਹੀਨਾ — ਅਤੇ ਜਿਹੜੀ ਵੀ ਛੱਤ ਤੁਸੀਂ ਮਾਪਦੇ ਹੋ, ਉਸ ਦਾ ਹਰ ਰਿਪੋਰਟ ਲਈ ਵੱਖਰਾ ਪੈਸਾ ਲੱਗਦਾ ਹੈ। FieldQuo ਇਹ ਚਾਰੇ ਹਰ ਪਲਾਨ ਵਿੱਚ, ਹਰ ਕੀਮਤ ਉੱਤੇ, {ourEntry} ਤੋਂ ਦਿੰਦਾ ਹੈ, ਅਤੇ ਛੱਤ ਨੂੰ ਉਸ ਦੇ ਪਤੇ ਤੋਂ ਬਿਨਾਂ ਪ੍ਰਤੀ-ਛੱਤ ਫੀਸ ਦੇ ਮਾਪਦਾ ਹੈ।",
  "compare.concession.roofr": "ਪਹਿਲਾਂ ਉਹ ਜੋ ਸਾਡੇ ਕੋਲ ਨਹੀਂ ਹੈ। Roofr ਦਾ ਸਭ ਤੋਂ ਸਸਤਾ ਪਲਾਨ ਮੁਫ਼ਤ ਹੈ, ਬਿਨਾਂ ਸਮੇਂ ਦੀ ਹੱਦ, ਅਤੇ Roofr ਦੇ ਹਰ ਪਲਾਨ ਵਿੱਚ ਬੇਅੰਤ ਵਰਤੋਂਕਾਰ ਸ਼ਾਮਲ ਹਨ; ਉਹਨਾਂ ਦੀ ਮਾਪ ਰਿਪੋਰਟ ਛੱਤ ਦੀਆਂ ਧਾਰਾਂ, ਕੋਨਿਆਂ ਅਤੇ ਨਾਲੀਆਂ ਨੂੰ ਮਾਪੇ ਹੋਏ ਵਜੋਂ ਲਿਖਦੀ ਹੈ, ਜਦਕਿ ਸਾਡੀ ਉਹ ਵੰਡ ਛੱਤ ਦੇ ਆਕਾਰ ਤੋਂ ਰਿਵਾਜ ਮੁਤਾਬਕ ਕੱਢਦੀ ਹੈ। FieldQuo ਇੱਕ ਵੈੱਬ ਐਪਲੀਕੇਸ਼ਨ ਵੀ ਹੈ, ਜਿਸ ਵਿੱਚ ਕੋਈ ਫ਼ੋਨ ਐਪ ਨਹੀਂ, ਨੈੱਟਵਰਕ ਤੋਂ ਬਿਨਾਂ ਕੁਝ ਨਹੀਂ ਚੱਲਦਾ, ਅਤੇ ਕੋਈ ਵਿਕਰੇਤਾ ਤੁਹਾਨੂੰ ਸਮਝਾਉਣ ਨਹੀਂ ਆਉਂਦਾ।",
  "compare.lede.paintscout": "PaintScout ਦਾ ਪਲਾਨ ਅੰਦਾਜ਼ਾ ਵੇਚਦਾ ਹੈ; ਸ਼ਡਿਊਲ, ਪਾਈਪਲਾਈਨ ਅਤੇ ਕੰਮ ਇੱਕ ਐਡ-ਆਨ ਹਨ ਜੋ ਮਹੀਨੇ ਦੇ {addOnTotal} ਹੋਰ ਲੈਂਦਾ ਹੈ, ਅਤੇ ਪਹਿਲੇ ਤੋਂ ਬਾਅਦ ਹਰ ਬੰਦੇ ਦਾ ਪੈਸਾ ਲੱਗਦਾ ਹੈ। FieldQuo ਵੀ ਪੇਂਟਿੰਗ ਦੀ ਕੀਮਤ ਉਤਪਾਦਨ ਦਰ ਨਾਲ ਕੱਢਦਾ ਹੈ — ਤੁਹਾਡੀਆਂ ਦਰਾਂ ਤੋਂ ਘੰਟੇ, ਕਵਰੇਜ ਤੋਂ ਗੈਲਨ — ਅਤੇ ਕੋਟੇਸ਼ਨ, ਕੰਮ, ਬਿੱਲ ਅਤੇ ਭੁਗਤਾਨ ਇੱਕੋ ਪਲਾਨ ਵਿੱਚ ਚਲਾਉਂਦਾ ਹੈ, ਵੈਨ ਵਾਲੇ ਸਾਰੇ ਮੁਫ਼ਤ, {ourEntry} ਤੋਂ।",
  "compare.concession.paintscout": "ਪਹਿਲਾਂ ਉਹ ਜੋ ਸਾਡੇ ਕੋਲ ਨਹੀਂ ਹੈ। PaintScout ਸਿਰਫ਼ ਪੇਂਟਰਾਂ ਲਈ ਬਣਿਆ ਹੈ, ਅਤੇ ਇਸ ਦੀਆਂ ਡਿਫ਼ਾਲਟ ਉਤਪਾਦਨ ਦਰਾਂ ਸਾਲਾਂ ਦੀਆਂ ਪੇਂਟਿੰਗ ਕੰਪਨੀਆਂ ਤੋਂ ਆਈਆਂ ਹਨ; ਸਾਡੀਆਂ ਸ਼ੁਰੂਆਤੀ ਅੰਕੜਿਆਂ ਵਜੋਂ ਆਉਂਦੀਆਂ ਹਨ ਜਿਨ੍ਹਾਂ ਨੂੰ ਤੁਸੀਂ ਆਪ ਠੀਕ ਕਰੋਗੇ। ਉਹਨਾਂ ਦਾ ਪੰਨਾ iOS ਅਤੇ Android ਐਪ, ਆਫ਼ਲਾਈਨ ਮੋਡ, QuickBooks, Zapier ਅਤੇ CompanyCam, ਹੋਰ ਪੇਂਟਰਾਂ ਦੀ ਇੱਕ ਕਮਿਊਨਿਟੀ, ਅਤੇ ਬਿਨਾਂ ਕਾਰਡ ਵਾਲਾ ਟ੍ਰਾਇਲ ਲਿਖਦਾ ਹੈ। FieldQuo ਕੋਲ ਇਹਨਾਂ ਵਿੱਚੋਂ ਕੁਝ ਨਹੀਂ, ਅਤੇ ਜੇ ਇਹਨਾਂ ਵਿੱਚੋਂ ਕੋਈ ਵੀ ਤੁਹਾਡਾ ਫ਼ੈਸਲਾ ਕਰਦਾ ਹੈ, ਤਾਂ ਉਹ ਬਿਹਤਰ ਖਰੀਦ ਹਨ।",
  "compare.capability.measured_roof_report": "ਮਾਪੀਆਂ ਧਾਰਾਂ ਦੀ ਲੰਬਾਈ ਵਾਲੀ ਛੱਤ ਦੀ ਮਾਪ ਰਿਪੋਰਟ",
  "compare.capability.integration_marketplace": "ਹੋਰ ਟੂਲਾਂ ਨਾਲ ਜੁੜਦਾ ਹੈ (Zapier, CompanyCam)",
  "compare.capability.community": "ਹੋਰ ਠੇਕੇਦਾਰਾਂ ਤੋਂ ਪੁੱਛਣ ਲਈ ਗਾਹਕਾਂ ਦੀ ਕਮਿਊਨਿਟੀ",
  "compare.capability.payments_in_canada": "ਕੈਨੇਡੀਅਨ ਕਾਰੋਬਾਰ ਲਈ ਕਾਰਡ ਅਤੇ ਬੈਂਕ ਡੈਬਿਟ ਭੁਗਤਾਨ",
  "compare.rows.theirLimit": "ਉਹਨਾਂ ਦਾ ਪੰਨਾ: “{limit}”",
  "compare.rows.unlimitedUsersCap": "ਬੇਅੰਤ ਵਰਤੋਂਕਾਰ",
  "compare.rows.unlimitedEveryPlan": "ਹਰ ਪਲਾਨ ਵਿੱਚ, ਉਹਨਾਂ ਦੇ ਆਪਣੇ ਸ਼ਬਦਾਂ ਵਿੱਚ",
  "compare.rows.notCounted": "ਗਿਣਿਆ ਨਹੀਂ ਜਾਂਦਾ",
  "compare.rows.flatFeeSub": "ਇੱਕ ਪੱਕੀ ਫੀਸ — ਬੰਦਿਆਂ ਦੀ ਗਿਣਤੀ ਉਹਨਾਂ ਦੀ ਕੀਮਤ ਨਹੀਂ ਬਦਲਦੀ",
  "compare.rows.addOnAtPrice": "{addOn} ਐਡ-ਆਨ — {amount}/ਮਹੀਨਾ",
  "compare.rows.soldSeparately": "ਵੱਖਰਾ ਵਿਕਦਾ ਹੈ, ਪਲਾਨ ਦੇ ਉੱਤੇ",
  "compare.case.seatWorking": "{base} + {extra} × {perUser} ਹੋਰ ਵਰਤੋਂਕਾਰ",
  "compare.perUseTitle": "ਵਰਤੋਂ ਮੁਤਾਬਕ ਪੈਸਾ, ਪਲਾਨ ਦੇ ਉੱਤੇ",
  "compare.perUseIntro": "{competitor} ਇਹ ਹਰ ਪਲਾਨ ਵਿੱਚ ਵਰਤੋਂ ਮੁਤਾਬਕ ਲੈਂਦਾ ਹੈ, ਇਸ ਲਈ ਉੱਪਰ ਵਾਲੀ ਪਲਾਨ ਦੀ ਕੀਮਤ ਉਹ ਹੈ ਜਿੱਥੋਂ ਉਹਨਾਂ ਦਾ ਬਿੱਲ ਸ਼ੁਰੂ ਹੁੰਦਾ ਹੈ, ਮੁੱਕਦਾ ਨਹੀਂ। FieldQuo ਵਿੱਚ ਇਸ ਤਰ੍ਹਾਂ ਦਾ ਕੋਈ ਖ਼ਰਚਾ ਨਹੀਂ: ਛੱਤ ਨੂੰ ਪਤੇ ਤੋਂ ਮਾਪਣਾ ਹਰ ਪਲਾਨ ਵਿੱਚ ਪਲਾਨ ਦੀ ਕੀਮਤ ਉੱਤੇ ਹੈ।",
  "compare.perUseAmount": "${amount} {currency} {unit}",
  ...
  "compare.case.headlineTheirsAnnual": "{competitor} ਕੋਲ ਓਹੀ ਸੂਚੀ {price} ਸਾਲ ਦੀ ਹੈ।",
  ...
  "compare.case.calcAfter": "ਵਿੱਚ ਭਰੋ ਅਤੇ ਸਾਰੀਆਂ ਕੰਪਨੀਆਂ ਨਾਲੋ-ਨਾਲ ਵੇਖੋ।",
  ...
  "compare.rows.annualOnlyPlain": "{plan} — ਬਿੱਲ ਸਾਲ ਦਾ",
  ...
  "compare.rows.tierAtAnnualPrice": "{plan} — {amount}/ਸਾਲ",
  ...
  "addOns.totalBody": "ਉਹਨਾਂ ਦੇ ਆਪਣੇ ਸਿਲੈਕਟਰਾਂ ਉੱਤੇ ਜਿਸ ਥਾਂ ਅਸੀਂ ਇਹ ਪੜ੍ਹੇ, ਉੱਥੇ ਇਹ {count} ਮਿਲ ਕੇ ਇੰਨੇ ਦੇ ਪੈਂਦੇ ਹਨ। FieldQuo ਵਿੱਚ ਇਹੀ {count} ਕੰਮ ਹਰ ਪਲਾਨ ਵਿੱਚ, ਹਰ ਆਕਾਰ ਉੱਤੇ ਹਨ, ਇਸ ਪੰਨੇ ਦੇ ਸਭ ਤੋਂ ਸਸਤੇ ਪਲਾਨ ਤੋਂ ਹੀ।",
