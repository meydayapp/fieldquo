...
const tl = {
  ...
  "compare.indexLede": "Pitong paghahambing, bawat isa ay hango sa kung ano ang inilalathala ng kabilang kumpanya sa sarili nitong website. Walang kinonvert na currency dito, walang promotional na presyo, at ang hindi namin natiyak ay pinapangalanan sa halip na hulaan. Dalawa sa pito ang mas mura ang simula kaysa sa amin, at sinasabi iyon ng mga page na iyon bago pa ang kahit anong iba.",
  ...
  "compare.case.headlineTheirsPlusAddOns": "Sa {competitor}, ang parehong listahan ay {price} bawat buwan, dagdag ang {addOns} sa mga add-on.",
  "compare.rows.parityOnlyPlan": "{plan} — ang kanilang tanging plano; ang iba ay ibinebenta bilang add-on",
  "compare.rows.parityCheapestToo": "{plan} — kasama na ito sa kanilang pinakamurang plano",
  "compare.rows.usersPlusEach": "{users} kasama, {amount}/buwan para sa bawat isa pa",
  "compare.receptionistAddOnOnlyIntro": "Walang plano ng {competitor} na naglilista nito bilang kasama. Ibinebenta ito ng kanilang page bilang add-on sa ibabaw ng plano.",
  "compare.receptionistAddOnOnly": "Ito ay {availability}: {price}. Iyan ang minimum na binabayaran mo sa buwang hindi tumutunog ang telepono.",
  ...
  "compare.capability.payments_in_canada": "Bayad sa card at bank debit para sa negosyong Canadian",
  "compare.rows.theirLimit": "Ang kanilang page: “{limit}”",
  "compare.rows.unlimitedUsersCap": "Walang-limitasyong mga user",
  "compare.rows.unlimitedEveryPlan": "Sa bawat plano, sa kanilang mga salita",
  "compare.rows.notCounted": "Hindi binibilang",
  "compare.rows.flatFeeSub": "Fixed na bayad — hindi ginagalaw ng bilang ng tao ang kanilang presyo",
  "compare.rows.addOnAtPrice": "{addOn} add-on — {amount}/buwan",
  "compare.rows.soldSeparately": "hiwalay na ibinebenta, sa ibabaw ng plano",
  "compare.case.seatWorking": "{base} + {extra} × {perUser} pang user",
  "compare.perUseTitle": "Sinisingil bawat gamit, sa ibabaw ng plano",
  "compare.perUseIntro": "Sinisingil ito ng {competitor} bawat gamit sa bawat plano, kaya ang presyo ng plano sa itaas ay kung saan nagsisimula ang kanilang bill at hindi kung saan ito nagtatapos. Walang ganitong singil ang FieldQuo: ang pagsukat ng bubong mula sa address nito ay nasa bawat plano sa presyo ng plano.",
  ...
  "compare.capability.entry_price_below_our_floor": "Planong mas mababa ang presyo sa pinakamurang baitang ng FieldQuo",
  ...
  "compare.capability.white_label_documents": "Ang mga quote, invoice at email ay may brand ng kontratista, hindi sa amin",
  ...
  "compare.case.calcAfter": "at tingnan ang bawat kumpanya nang magkatabi.",
