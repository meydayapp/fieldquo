...
const de = {
  ...
  "compare.indexLede": "Sieben Vergleiche, jeder aus dem gebaut, was das andere Unternehmen auf seiner eigenen Website veröffentlicht. Hier wird nichts zwischen Währungen umgerechnet, nichts ist ein Aktionspreis, und was wir nicht klären konnten, wird benannt statt geraten. Zwei der sieben starten günstiger als wir, und diese Seiten sagen das, bevor sie irgendetwas anderes sagen.",
  ...
  "compare.case.headlineTheirsPlusAddOns": "Bei {competitor} kostet dieselbe Liste {price} im Monat, plus {addOns} an Zusatzmodulen.",
  "compare.rows.parityOnlyPlan": "{plan} — ihr einziger Tarif; der Rest wird als Zusatzmodul verkauft",
  "compare.rows.parityCheapestToo": "{plan} — ihr günstigster Tarif enthält es",
  "compare.rows.usersPlusEach": "{users} inklusive, {amount}/Monat für jeden weiteren",
  "compare.receptionistAddOnOnlyIntro": "Kein {competitor}-Tarif führt es als enthalten. Ihre Seite verkauft es als Zusatzmodul zum Tarif.",
  "compare.receptionistAddOnOnly": "Es ist {availability}: {price}. Das ist ein Sockelbetrag, den Sie in einem Monat zahlen, in dem das Telefon nie klingelt.",
  ...
  "compare.capability.payments_in_canada": "Karten- und Lastschriftzahlungen für ein kanadisches Unternehmen",
  "compare.rows.theirLimit": "Ihre Seite: „{limit}“",
  "compare.rows.unlimitedUsersCap": "Unbegrenzt Nutzer",
  "compare.rows.unlimitedEveryPlan": "In jedem Tarif, in ihren Worten",
  "compare.rows.notCounted": "Nicht gezählt",
  "compare.rows.flatFeeSub": "Ein Pauschalpreis — die Kopfzahl ändert ihren Preis nicht",
  "compare.rows.addOnAtPrice": "Zusatzmodul {addOn} — {amount}/Monat",
  "compare.rows.soldSeparately": "separat verkauft, zusätzlich zum Tarif",
  "compare.case.seatWorking": "{base} + {extra} × {perUser} weitere Nutzer",
  "compare.perUseTitle": "Pro Nutzung berechnet, zusätzlich zum Tarif",
  "compare.perUseIntro": "{competitor} berechnet dies in jedem Tarif pro Nutzung, der Tarifpreis oben ist also der Anfang ihrer Rechnung und nicht ihr Ende. FieldQuo hat keine Gebühr dieser Art: ein Dach anhand seiner Adresse aufzumessen ist in jedem Tarif zum Tarifpreis enthalten.",
  ...
  "compare.case.calcAfter": "ein und sehen Sie alle Anbieter nebeneinander.",
