...
const de = {
  ...
  "compare.lede.housecall_pro": "Housecall Pro berechnet jeden zusätzlichen Nutzer, der Tarifpreis ist also nur der Anfang Ihrer Rechnung. FieldQuo berechnet die Leute, die tatsächlich Arbeit kalkulieren — Angebote, Aufträge, Rechnungen — und jeder, der im Transporter sitzt, zählt als Team, kostenlos. Jede Funktion steckt in jedem Tarif, ab $99.",
  ...
  "compare.lede.projul": "Projul verlangt eine pauschale Jahresbindung im Voraus. FieldQuo kostet $99 im Monat für einen Platz und fünf Teammitglieder, alle Funktionen inklusive, und Sie können zum Ende jedes Monats gehen — Sie müssen kein Jahr kaufen, um herauszufinden, ob es zu Ihnen passt.",
  ...
  "compare.lede.quoteiq": "QuoteIQ startet bei $29.99, und dieser Tarif kann Ihnen keine Website bauen, keine Buchung annehmen und keinen Hausbesitzer seinen eigenen Auftrag kalkulieren lassen. Der QuoteIQ-Tarif, der das enthält, was FieldQuo in jeden Tarif legt, ist ihre Stufe Max, für $699 im Monat. Unserer kostet $99 — und einundvierzig Punkte auf unserer Liste gibt es bei ihnen zu keinem Preis.",
