...
const zh = {
  ...
  "compare.indexLede": "七组对比，每一组都出自对方自己网站上公开的内容。这里没有任何汇率换算，没有任何促销价；凡是我们没能弄清楚的，都直说，而不是猜。七家里有两家的起步价比我们便宜，那两页在说别的之前，先说了这件事。",
  ...
  "compare.lede.jobber": "Jobber 把营销套件、AI 接线员和销售管道当作三个单独的按月加购来卖——在一个价格本来就随团队人数变动的套餐之上，再加每月 {addOnTotal}。FieldQuo 把这三样都放进每一个套餐、每一个价位，而且车上的人一律免费。",
  "compare.concession.jobber": "先说我们没有的。FieldQuo 是一个网页应用：没有可以从应用商店安装的东西，没信号就什么都用不了，也没有销售会带着你走一遍。",
  "compare.lede.housecall_pro": "Housecall Pro 每多一个用户就多收一份钱，所以套餐价只是你账单的起点。FieldQuo 只对真正给活定价的人收费——报价、工程、账单——车上的人都算班组，不收钱。所有功能每个套餐都有，{ourEntry} 起。",
  ...
  "compare.lede.projul": "Projul 要求先按年一次性承诺。FieldQuo 是每月 {ourEntry}，含一个席位和五名班组成员，所有功能都在里面，任何一个月末都可以走人——你不必先买下一整年，才知道它适不适合你。",
  "compare.concession.projul": "在说别的之前：FieldQuo 没有手机 App，没信号就用不了，也没有人会给你做演示。Projul 会给你约一场演示。",
  "compare.lede.quoteiq": "QuoteIQ 从 {theirEntry} 起，而那个套餐不能给你做网站，不能接受预约，也不能让业主自己给自家的活估价。QuoteIQ 里装得下 FieldQuo 每个套餐都有的那些东西的，是他们的 Max 档，每月 {theirParity}。我们的是 {ourEntry}——而且我们清单上有四十一项，他们的产品线里无论花多少钱都没有。",
  "compare.concession.quoteiq": "先说价格，因为你就是来看这个的。QuoteIQ 的起步价低于我们最便宜的套餐，有我们没有的手机 App，还会给你约一场实操讲解。FieldQuo 是一个网页应用，不配销售。",
  "compare.case.headlineTheirsPlusAddOns": "在 {competitor}，同样这份清单是每月 {price}，再加 {addOns} 的附加项。",
  "compare.rows.parityOnlyPlan": "{plan}——他们唯一的套餐；其余的作为附加项出售",
  "compare.rows.parityCheapestToo": "{plan}——他们最便宜的套餐就包含",
  "compare.rows.usersPlusEach": "含 {users}，之后每人 {amount}/月",
  "compare.receptionistAddOnOnlyIntro": "{competitor} 没有任何套餐把它列为包含项。他们的页面把它当作套餐之外的附加项出售。",
  "compare.receptionistAddOnOnly": "它是{availability}：{price}。这是一个底价，电话一个月都不响你也要付。",
  ...
  "compare.capability.payments_in_canada": "加拿大企业的银行卡和银行扣款收款",
  "compare.rows.theirLimit": "他们的页面：“{limit}”",
  "compare.rows.unlimitedUsersCap": "不限用户数",
  "compare.rows.unlimitedEveryPlan": "每个套餐都是，用他们自己的话说",
  "compare.rows.notCounted": "不计人数",
  "compare.rows.flatFeeSub": "固定费用——人数不影响他们的价格",
  "compare.rows.addOnAtPrice": "{addOn} 附加项——{amount}/月",
  "compare.rows.soldSeparately": "单独出售，在套餐之外",
  "compare.case.seatWorking": "{base} + {extra} × {perUser} 位额外用户",
  "compare.perUseTitle": "按次收费，在套餐之外",
  "compare.perUseIntro": "{competitor} 在每个套餐里都对这些按次收费，所以上面的套餐价只是他们账单的起点，不是终点。FieldQuo 没有这类收费：按地址测量屋顶在每个套餐里都包含，就是套餐价。",
  ...
  "compare.case.headlineTheirsAnnual": "在 {competitor}，同样这份清单是每年 {price}。",
  ...
  "compare.case.calcAfter": "里，把每家公司并排看一遍。",
  ...
  "compare.rows.annualOnlyPlain": "{plan} —— 按年结算",
  ...
  "compare.rows.tierAtAnnualPrice": "{plan} —— {amount}／年",
