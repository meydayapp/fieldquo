...
const uk = {
  ...
  "compare.indexLede": "Сім порівнянь, кожне зібране з того, що інша компанія публікує на власному сайті. Тут ніщо не конвертується між валютами, ніщо не є акційною ціною, а все, чого ми не змогли з’ясувати, назване, а не вгадане. Двоє з семи стартують дешевше за нас, і ті сторінки говорять про це раніше, ніж про будь-що інше.",
  ...
  "compare.case.headlineTheirsPlusAddOns": "У {competitor} той самий список коштує {price} на місяць, плюс {addOns} за доповнення.",
  "compare.rows.parityOnlyPlan": "{plan} — їхній єдиний план; решта продається як доповнення",
  "compare.rows.parityCheapestToo": "{plan} — їхній найдешевший план це містить",
  "compare.rows.usersPlusEach": "{users} включено, {amount}/міс за кожного наступного",
  "compare.receptionistAddOnOnlyIntro": "Жоден план {competitor} не вказує це як включене. Їхня сторінка продає це як доповнення понад план.",
  "compare.receptionistAddOnOnly": "Це {availability}: {price}. Це мінімум, який ви платите в місяць, коли телефон жодного разу не дзвонить.",
  "compare.lede.roofr": "Roofr продає SMS, свій Instant Estimator, сайт і ШІ-рецепціоніста як окремі щомісячні доповнення — {addOnTotal} на місяць понад план — а кожен дах, який ви вимірюєте, оплачується ще й за звіт. У FieldQuo всі чотири є в кожному плані, за будь-якої ціни, від {ourEntry}, і дах вимірюється за адресою без плати за дах.",
  "compare.concession.roofr": "Почнімо з того, чого в нас немає. Найдешевший план Roofr безкоштовний, без обмеження в часі, і кожен план Roofr включає необмежену кількість користувачів; їхній звіт з вимірювання подає гребені, ребра і розжолобки як виміряні, а наш виводить цей розподіл за домовленістю з форми даху. FieldQuo — це також вебзастосунок без мобільного застосунку, без нічого, що працює без мережі, і без продавця, який вас проведе.",
  "compare.lede.paintscout": "План PaintScout продає кошторис; розклад, воронка і сам об’єкт — це доповнення ще за {addOnTotal} на місяць, і кожна людина після першої оплачується. FieldQuo теж рахує малярні роботи за нормою виробітку — години з ваших норм, галони з витрати — і веде кошторис, об’єкт, рахунок і оплату в одному плані, з усіма в фургоні безкоштовно, від {ourEntry}.",
  "compare.concession.paintscout": "Почнімо з того, чого в нас немає. PaintScout зроблений лише для малярів, і його типові норми виробітку походять з років роботи малярних компаній; наші постачаються як стартові значення, які ви маєте підлаштувати. На їхній сторінці є застосунки для iOS та Android, офлайн-режим, QuickBooks, Zapier і CompanyCam, спільнота інших малярів і пробний період без картки. У FieldQuo нічого з цього немає, і якщо щось із цього вирішує для вас, то вони — кращий вибір.",
  "compare.capability.measured_roof_report": "Звіт з вимірювання даху з виміряними довжинами ребер",
  "compare.capability.integration_marketplace": "З’єднується з іншими інструментами (Zapier, CompanyCam)",
  "compare.capability.community": "Спільнота клієнтів, де можна запитати інших підрядників",
  "compare.capability.payments_in_canada": "Оплата карткою та банківським списанням для канадського бізнесу",
  "compare.rows.theirLimit": "Їхня сторінка: «{limit}»",
  "compare.rows.unlimitedUsersCap": "Необмежено користувачів",
  "compare.rows.unlimitedEveryPlan": "У кожному плані, їхніми словами",
  "compare.rows.notCounted": "Не рахується",
  "compare.rows.flatFeeSub": "Фіксована плата — кількість людей не змінює їхню ціну",
  "compare.rows.addOnAtPrice": "Доповнення {addOn} — {amount}/міс",
  "compare.rows.soldSeparately": "продається окремо, понад план",
  "compare.case.seatWorking": "{base} + {extra} × {perUser} додаткових користувачів",
  "compare.perUseTitle": "Оплата за використання, понад план",
  "compare.perUseIntro": "{competitor} бере за це плату за використання в кожному плані, тож ціна плану вище — це те, з чого їхній рахунок починається, а не те, чим закінчується. У FieldQuo такої плати немає: вимірювання даху за адресою є в кожному плані за ціною плану.",
  ...
  "compare.case.calcAfter": "і подивіться всі компанії поруч.",
  ...
  "addOns.totalBody": "Саме стільки ці {count} коштують разом у тій точці їхніх власних перемикачів, де ми їх зчитали. У FieldQuo ті самі {count} роботи є в кожному плані, за будь-якого розміру, починаючи з найдешевшого на цій сторінці.",
