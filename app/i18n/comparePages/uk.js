...
const uk = {
  ...
  "compare.lede.jobber": "Jobber продає свій Marketing Suite, свого ШІ-секретаря на телефоні і свою воронку продажів як окремі щомісячні доповнення — $177 на місяць поверх плану, ціна якого й так рухається разом із розміром вашої команди. FieldQuo кладе всі три в кожен план, за будь-якої ціни, а кожен, хто у фургоні, — безкоштовно.",
  ...
  "compare.lede.housecall_pro": "Housecall Pro бере плату за кожного додаткового користувача, тож ціна плану — це лише те, з чого починається ваш рахунок. FieldQuo виставляє рахунок тим, хто справді оцінює роботу — кошториси, замовлення, рахунки, — а кожен, хто у фургоні, — це бригада, безкоштовно. Кожна функція є в кожному плані, від $99.",
  ...
  "compare.lede.projul": "Projul просить рівне річне зобов’язання наперед. FieldQuo — це $99 на місяць за одне місце і п’ять бригадників, з усіма функціями, і ви можете піти в кінці будь-якого місяця — вам не треба купувати рік, щоб дізнатися, чи це вам підходить.",
  ...
  "compare.lede.quoteiq": "QuoteIQ починається від $29.99, і цей план не збудує вам сайт, не прийме бронювання і не дасть господарю оцінити власну роботу. План QuoteIQ, який несе те, що FieldQuo кладе в кожен план, — це їхній тариф Max, за $699 на місяць. Наш — $99, і сорок одна річ із нашого списку відсутня в їхній лінійці за будь-яку ціну.",
