...
const es = {
  ...
  "compare.indexLede": "Siete comparativas, cada una armada con lo que la otra empresa publica en su propio sitio. Aquí nada se convierte de una moneda a otra, nada es un precio promocional, y todo lo que no pudimos resolver se dice en vez de adivinarse. Dos de las siete empiezan más baratas que nosotros, y esas páginas lo dicen antes que cualquier otra cosa.",
  ...
  "compare.lede.jobber": "Jobber vende su paquete de marketing, su recepcionista con IA y su embudo de ventas como complementos mensuales aparte — {addOnTotal} al mes encima de un plan cuyo precio ya se mueve con el tamaño de tu equipo. FieldQuo pone los tres en todos los planes, a cualquier precio, y todo el que anda en la camioneta es gratis.",
  ...
  "compare.lede.projul": "Projul pide un compromiso anual fijo por adelantado. FieldQuo cuesta {ourEntry} al mes por un puesto y cinco de cuadrilla, con todas las funciones incluidas, y te puedes ir al final de cualquier mes — no tienes que comprar un año para averiguar si te sirve.",
  ...
  "compare.case.headlineTheirsPlusAddOns": "En {competitor} la misma lista cuesta {price} al mes, más {addOns} en complementos.",
  "compare.rows.parityOnlyPlan": "{plan} — su único plan; el resto se vende como complementos",
  "compare.rows.parityCheapestToo": "{plan} — su plan más barato ya lo incluye",
  "compare.rows.usersPlusEach": "{users} incluido, {amount}/mes por cada uno más",
  "compare.receptionistAddOnOnlyIntro": "Ningún plan de {competitor} lo lista como incluido. Su página lo vende como complemento encima del plan.",
  "compare.receptionistAddOnOnly": "Es {availability}: {price}. Es un mínimo que pagas en un mes en que el teléfono nunca suena.",
  ...
  "compare.capability.payments_in_canada": "Pagos con tarjeta y débito bancario para una empresa canadiense",
  "compare.rows.theirLimit": "Su página: «{limit}»",
  "compare.rows.unlimitedUsersCap": "Usuarios ilimitados",
  "compare.rows.unlimitedEveryPlan": "En todos los planes, en sus palabras",
  "compare.rows.notCounted": "No se cuenta",
  "compare.rows.flatFeeSub": "Una tarifa fija — la plantilla no mueve su precio",
  "compare.rows.addOnAtPrice": "Complemento {addOn} — {amount}/mes",
  "compare.rows.soldSeparately": "se vende aparte, encima del plan",
  "compare.case.seatWorking": "{base} + {extra} × {perUser} usuarios más",
  "compare.perUseTitle": "Cobrado por uso, encima del plan",
  "compare.perUseIntro": "{competitor} cobra esto por uso en todos los planes, así que el precio del plan de arriba es donde empieza su factura, no donde termina. FieldQuo no tiene ningún cargo de este tipo: medir un techo desde su dirección va en todos los planes al precio del plan.",
  ...
  "compare.case.headlineTheirsAnnual": "En {competitor} la misma lista cuesta {price} al año.",
  ...
  "compare.case.calcAfter": "y mira todas las empresas lado a lado.",
  ...
  "compare.rows.annualOnlyPlain": "{plan} — facturado por año",
  ...
  "compare.rows.tierAtAnnualPrice": "{plan} — {amount}/año",
