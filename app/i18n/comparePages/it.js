...
const it = {
  ...
  "compare.indexLede": "Sette confronti, ciascuno costruito su quello che l'altra azienda pubblica sul proprio sito. Qui non c'è nulla di convertito da una valuta all'altra, nulla che sia un prezzo promozionale, e tutto ciò che non siamo riusciti a stabilire viene detto invece che indovinato. Due dei sette partono più in basso di noi, e quelle pagine lo dicono prima di dire qualsiasi altra cosa.",
  ...
  "compare.lede.jobber": "Jobber vende la sua suite di marketing, il suo centralino AI e la sua pipeline commerciale come componenti aggiuntivi mensili separati — {addOnTotal} al mese sopra un piano il cui prezzo si muove già con la dimensione del team. FieldQuo mette tutti e tre in ogni piano, a ogni prezzo, e chi sta in furgone non si paga.",
  ...
  "compare.lede.housecall_pro": "Housecall Pro fa pagare ogni utente in più, quindi il prezzo del piano è solo il punto da cui parte la sua fattura. FieldQuo fa pagare le persone che il lavoro lo valorizzano davvero — preventivi, lavori, fatture — e chi sta in furgone è squadra, senza costi. Ogni funzionalità è in ogni piano, a partire da {ourEntry}.",
  ...
  "compare.lede.projul": "Projul chiede un impegno annuale fisso pagato in anticipo. FieldQuo costa {ourEntry} al mese per una postazione e cinque persone in squadra, tutte le funzionalità comprese, e se ne può andare alla fine di qualsiasi mese — non deve comprare un anno per scoprire se le va bene.",
  ...
  "compare.case.headlineTheirsPlusAddOns": "Da {competitor} lo stesso elenco costa {price} al mese, più {addOns} di componenti aggiuntivi.",
  "compare.rows.parityOnlyPlan": "{plan} — il loro unico piano; il resto è venduto come componente aggiuntivo",
  "compare.rows.parityCheapestToo": "{plan} — il loro piano più economico lo include",
  "compare.rows.usersPlusEach": "{users} incluso, {amount}/mese per ognuno in più",
  "compare.receptionistAddOnOnlyIntro": "Nessun piano {competitor} lo elenca come incluso. La loro pagina lo vende come componente aggiuntivo oltre al piano.",
  "compare.receptionistAddOnOnly": "È {availability}: {price}. È un minimo che paghi in un mese in cui il telefono non squilla mai.",
  ...
  "compare.capability.payments_in_canada": "Pagamenti con carta e addebito bancario per un'impresa canadese",
  "compare.rows.theirLimit": "La loro pagina: “{limit}”",
  "compare.rows.unlimitedUsersCap": "Utenti illimitati",
  "compare.rows.unlimitedEveryPlan": "In ogni piano, con parole loro",
  "compare.rows.notCounted": "Non conteggiato",
  "compare.rows.flatFeeSub": "Una tariffa fissa — l'organico non cambia il loro prezzo",
  "compare.rows.addOnAtPrice": "Componente {addOn} — {amount}/mese",
  "compare.rows.soldSeparately": "venduto a parte, oltre al piano",
  "compare.case.seatWorking": "{base} + {extra} × {perUser} altri utenti",
  "compare.perUseTitle": "Addebitato a consumo, oltre al piano",
  "compare.perUseIntro": "{competitor} addebita questo a consumo in ogni piano, quindi il prezzo del piano qui sopra è dove la loro fattura inizia, non dove finisce. FieldQuo non ha alcun addebito di questo tipo: misurare un tetto dal suo indirizzo è in ogni piano al prezzo del piano.",
  ...
  "compare.case.headlineTheirsAnnual": "Da {competitor} lo stesso elenco costa {price} all’anno.",
  ...
  "compare.case.calcAfter": "e li veda tutti fianco a fianco.",
  ...
  "compare.rows.annualOnlyPlain": "{plan} — fatturato come anno",
  ...
  "compare.rows.tierAtAnnualPrice": "{plan} — {amount}/anno",
