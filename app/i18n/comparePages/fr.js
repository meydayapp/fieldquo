...
const fr = {
  ...
  "compare.indexLede": "Sept comparatifs, chacun monté à partir de ce que l’autre entreprise publie sur son propre site. Rien ici n’est converti d’une devise à l’autre, rien n’est un prix promotionnel, et tout ce que nous n’avons pas pu trancher est nommé plutôt que deviné. Deux des sept commencent moins cher que nous, et ces pages-là le disent avant de dire quoi que ce soit d’autre.",
  ...
  "compare.case.headlineTheirsPlusAddOns": "Chez {competitor}, la même liste est à {price} par mois, plus {addOns} d’extras.",
  "compare.rows.parityOnlyPlan": "{plan} — leur seul forfait; le reste est vendu en extras",
  "compare.rows.parityCheapestToo": "{plan} — leur forfait le moins cher l’inclut",
  "compare.rows.usersPlusEach": "{users} inclus, {amount}/mois pour chacun en plus",
  "compare.receptionistAddOnOnlyIntro": "Aucun forfait {competitor} ne l’indique comme inclus. Leur page le vend comme un extra en plus du forfait.",
  "compare.receptionistAddOnOnly": "C’est {availability} : {price}. C’est un plancher que vous payez le mois où le téléphone ne sonne jamais.",
  ...
  "compare.capability.payments_in_canada": "Paiements par carte et par prélèvement bancaire pour une entreprise canadienne",
  "compare.rows.theirLimit": "Leur page : « {limit} »",
  "compare.rows.unlimitedUsersCap": "Utilisateurs illimités",
  "compare.rows.unlimitedEveryPlan": "Dans tous les forfaits, selon leurs mots",
  "compare.rows.notCounted": "Non compté",
  "compare.rows.flatFeeSub": "Un tarif fixe — l’effectif ne change pas leur prix",
  "compare.rows.addOnAtPrice": "Extra {addOn} — {amount}/mois",
  "compare.rows.soldSeparately": "vendu séparément, en plus du forfait",
  "compare.case.seatWorking": "{base} + {extra} × {perUser} utilisateurs de plus",
  "compare.perUseTitle": "Facturé à l’usage, en plus du forfait",
  "compare.perUseIntro": "{competitor} facture ceci à l’usage dans tous les forfaits, donc le prix du forfait ci-dessus est là où leur facture commence, pas là où elle finit. FieldQuo n’a aucuns frais de ce genre : mesurer un toit à partir de son adresse est dans tous les forfaits, au prix du forfait.",
  ...
  "compare.case.calcAfter": "et voyez toutes les entreprises côte à côte.",
