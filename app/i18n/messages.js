...
const en = {
  ...
  // The line under the visit address once it has been sent. See travelNote in
  // app/book/[companySlug]/BookingFlow.js for which one shows when; only
  // travelNotFound asks the visitor to check what they typed.
  "booking.mode.addressHintPlain": "Needed for an on-site visit.",
  "booking.mode.travelChecking": "Checking which times we can reach this address…",
  "booking.mode.travelApplied": "Showing times we can reach {address} on schedule.",
  "booking.mode.travelNotFound": "We couldn't find that address on the map, so every time is shown. Check it before you book.",
  "booking.mode.timeUnreachable": "That time doesn't work for this address — we couldn't get there on schedule.",
  "booking.mode.pickAnotherTime": "Pick another time",
  ...
  "pricing.custom.title": "Need more people? Build a custom plan.",
  "pricing.custom.body": "Past {baseSeats} seats, add as many as you need. Every seat you add brings a crew member with it, at {seatPrice} a seat a month — the same step as the ladder above.",
  "pricing.custom.seats": "Seats",
  "pricing.custom.quickPicks": "Quick picks",
  "pricing.custom.fewer": "One seat fewer",
  "pricing.custom.more": "One seat more",
  "pricing.custom.cap": "Up to {maxSeats} seats and {maxCrew} crew — {maxPeople} people in all. Bigger than that?",
...
const fr = {
  ...
  "booking.mode.addressHintPlain": "Requise pour une visite sur place.",
  "booking.mode.travelChecking": "Nous vérifions les heures où nous pouvons nous rendre à cette adresse…",
  "booking.mode.travelApplied": "Heures où nous pouvons arriver à temps à l'adresse {address}.",
  "booking.mode.travelNotFound": "Nous n'avons pas trouvé cette adresse sur la carte, alors toutes les heures sont affichées. Vérifiez-la avant de réserver.",
  "booking.mode.timeUnreachable": "Cette heure ne convient pas pour cette adresse — nous ne pourrions pas y arriver à temps.",
  "booking.mode.pickAnotherTime": "Choisir une autre heure",
  ...
  "pricing.custom.title": "Besoin de plus de monde ? Composez un forfait sur mesure.",
  "pricing.custom.body": "Au-delà de {baseSeats} sièges, ajoutez-en autant que nécessaire. Chaque siège ajouté vient avec un équipier, à {seatPrice} par siège et par mois — le même pas que l'échelle ci-dessus.",
  "pricing.custom.seats": "Sièges",
  "pricing.custom.quickPicks": "Choix rapides",
  "pricing.custom.fewer": "Un siège de moins",
  "pricing.custom.more": "Un siège de plus",
  "pricing.custom.cap": "Jusqu'à {maxSeats} sièges et {maxCrew} équipiers — {maxPeople} personnes en tout. Plus grand que ça ?",
...
const es = {
  ...
  "booking.mode.addressHintPlain": "Necesaria para una visita en sitio.",
  "booking.mode.travelChecking": "Comprobando a qué horas podemos llegar a esta dirección…",
  "booking.mode.travelApplied": "Mostrando las horas en que podemos llegar a tiempo a {address}.",
  "booking.mode.travelNotFound": "No encontramos esa dirección en el mapa, así que se muestran todas las horas. Revísela antes de reservar.",
  "booking.mode.timeUnreachable": "Esa hora no sirve para esta dirección — no podríamos llegar a tiempo.",
  "booking.mode.pickAnotherTime": "Elegir otra hora",
  ...
  "pricing.custom.title": "¿Necesita más gente? Arme un plan a medida.",
  "pricing.custom.body": "Más allá de {baseSeats} puestos, agregue tantos como necesite. Cada puesto trae consigo un miembro de cuadrilla, a {seatPrice} por puesto al mes — el mismo escalón que la escalera de arriba.",
  "pricing.custom.seats": "Puestos",
  "pricing.custom.quickPicks": "Opciones rápidas",
  "pricing.custom.fewer": "Un puesto menos",
  "pricing.custom.more": "Un puesto más",
  "pricing.custom.cap": "Hasta {maxSeats} puestos y {maxCrew} de cuadrilla — {maxPeople} personas en total. ¿Más grande que eso?",
  "pricing.custom.contact": "Contáctenos",
...
const uk = {
  ...
  "pricing.custom.title": "Потрібно більше людей? Складіть власний план.",
  "pricing.custom.body": "Понад {baseSeats} місць додавайте стільки, скільки потрібно. Кожне додане місце приносить із собою робітника, по {seatPrice} за місце на місяць — той самий крок, що й у драбині вище.",
  "pricing.custom.seats": "Місця",
  "pricing.custom.quickPicks": "Швидкий вибір",
  "pricing.custom.fewer": "На одне місце менше",
  "pricing.custom.more": "На одне місце більше",
  "pricing.custom.cap": "До {maxSeats} місць і {maxCrew} робітників — {maxPeople} осіб загалом. Більше?",
  "pricing.custom.contact": "Зв'яжіться з нами",
  ...
  "booking.mode.addressHintPlain": "Потрібна для виїзду на місце.",
  "booking.mode.travelChecking": "Перевіряємо, на який час ми встигнемо за цією адресою…",
  "booking.mode.travelApplied": "Показано час, коли ми встигнемо приїхати за адресою {address}.",
  "booking.mode.travelNotFound": "Ми не знайшли цю адресу на мапі, тому показано весь час. Перевірте її перед бронюванням.",
  "booking.mode.timeUnreachable": "Цей час не підходить для цієї адреси — ми не встигли б приїхати вчасно.",
  "booking.mode.pickAnotherTime": "Вибрати інший час",
...
const pa = {
  ...
  "pricing.custom.title": "ਹੋਰ ਲੋਕ ਚਾਹੀਦੇ ਹਨ? ਆਪਣਾ ਕਸਟਮ ਪਲਾਨ ਬਣਾਓ।",
  "pricing.custom.body": "{baseSeats} ਸੀਟਾਂ ਤੋਂ ਵੱਧ, ਜਿੰਨੀਆਂ ਚਾਹੀਦੀਆਂ ਹਨ ਜੋੜੋ। ਹਰ ਜੋੜੀ ਸੀਟ ਨਾਲ ਇੱਕ ਕਰੂ ਮੈਂਬਰ ਆਉਂਦਾ ਹੈ, {seatPrice} ਪ੍ਰਤੀ ਸੀਟ ਪ੍ਰਤੀ ਮਹੀਨਾ — ਉੱਪਰ ਵਾਲੀ ਪੌੜੀ ਵਾਂਗ ਹੀ ਕਦਮ।",
  "pricing.custom.seats": "ਸੀਟਾਂ",
  "pricing.custom.quickPicks": "ਤੇਜ਼ ਚੋਣ",
  "pricing.custom.fewer": "ਇੱਕ ਸੀਟ ਘੱਟ",
  "pricing.custom.more": "ਇੱਕ ਸੀਟ ਵੱਧ",
  "pricing.custom.cap": "{maxSeats} ਸੀਟਾਂ ਅਤੇ {maxCrew} ਕਰੂ ਤੱਕ — ਕੁੱਲ {maxPeople} ਲੋਕ। ਇਸ ਤੋਂ ਵੱਡੇ?",
  "pricing.custom.contact": "ਸਾਡੇ ਨਾਲ ਸੰਪਰਕ ਕਰੋ",
  ...
  "booking.mode.addressHintPlain": "ਸਾਈਟ 'ਤੇ ਮੁਲਾਕਾਤ ਲਈ ਲਾਜ਼ਮੀ।",
  "booking.mode.travelChecking": "ਜਾਂਚ ਕਰ ਰਹੇ ਹਾਂ ਕਿ ਅਸੀਂ ਇਸ ਪਤੇ 'ਤੇ ਕਿਹੜੇ ਸਮੇਂ ਪਹੁੰਚ ਸਕਦੇ ਹਾਂ…",
  "booking.mode.travelApplied": "ਉਹ ਸਮੇਂ ਦਿਖਾ ਰਹੇ ਹਾਂ ਜਦੋਂ ਅਸੀਂ {address} 'ਤੇ ਸਮੇਂ ਸਿਰ ਪਹੁੰਚ ਸਕਦੇ ਹਾਂ।",
  "booking.mode.travelNotFound": "ਸਾਨੂੰ ਇਹ ਪਤਾ ਨਕਸ਼ੇ 'ਤੇ ਨਹੀਂ ਮਿਲਿਆ, ਇਸ ਲਈ ਸਾਰੇ ਸਮੇਂ ਦਿਖਾਏ ਗਏ ਹਨ। ਬੁੱਕ ਕਰਨ ਤੋਂ ਪਹਿਲਾਂ ਇਸਦੀ ਜਾਂਚ ਕਰੋ।",
  "booking.mode.timeUnreachable": "ਇਹ ਸਮਾਂ ਇਸ ਪਤੇ ਲਈ ਠੀਕ ਨਹੀਂ — ਅਸੀਂ ਸਮੇਂ ਸਿਰ ਨਹੀਂ ਪਹੁੰਚ ਸਕਾਂਗੇ।",
  "booking.mode.pickAnotherTime": "ਕੋਈ ਹੋਰ ਸਮਾਂ ਚੁਣੋ",
...
const tl = {
  ...
  "pricing.custom.title": "Kailangan ng mas maraming tao? Gumawa ng custom na plan.",
  "pricing.custom.body": "Lampas sa {baseSeats} seats, magdagdag hangga't kailangan. Bawat seat na idadagdag ay may kasamang crew member, sa {seatPrice} bawat seat kada buwan — parehong hakbang ng hagdan sa itaas.",
  "pricing.custom.seats": "Seats",
  "pricing.custom.quickPicks": "Mabilis na pili",
  "pricing.custom.fewer": "Bawas isang seat",
  "pricing.custom.more": "Dagdag isang seat",
  "pricing.custom.cap": "Hanggang {maxSeats} seats at {maxCrew} crew — {maxPeople} tao lahat. Mas malaki pa?",
  "pricing.custom.contact": "Makipag-ugnayan sa amin",
  ...
  "booking.mode.addressHintPlain": "Kailangan para sa on-site na pagbisita.",
  "booking.mode.travelChecking": "Tinitingnan kung anong mga oras kami makakarating sa address na ito…",
  "booking.mode.travelApplied": "Ipinapakita ang mga oras na makakarating kami sa {address} sa takdang oras.",
  "booking.mode.travelNotFound": "Hindi namin nahanap ang address na iyan sa mapa, kaya ipinapakita ang lahat ng oras. Suriin ito bago mag-book.",
  "booking.mode.timeUnreachable": "Hindi puwede ang oras na iyan para sa address na ito — hindi kami makakarating sa takdang oras.",
  "booking.mode.pickAnotherTime": "Pumili ng ibang oras",
...
const de = {
  ...
  "booking.mode.addressHintPlain": "Erforderlich für einen Vor-Ort-Termin.",
  "booking.mode.travelChecking": "Wir prüfen, zu welchen Zeiten wir diese Adresse erreichen…",
  "booking.mode.travelApplied": "Angezeigt werden Zeiten, zu denen wir rechtzeitig bei {address} sein können.",
  "booking.mode.travelNotFound": "Wir haben diese Adresse nicht auf der Karte gefunden, daher werden alle Zeiten angezeigt. Bitte prüfen Sie sie vor der Buchung.",
  "booking.mode.timeUnreachable": "Diese Zeit passt nicht zu dieser Adresse — wir wären nicht rechtzeitig dort.",
  "booking.mode.pickAnotherTime": "Andere Zeit wählen",
  ...
  "pricing.custom.title": "Mehr Leute nötig? Stellen Sie einen eigenen Tarif zusammen.",
  "pricing.custom.body": "Über {baseSeats} Plätze hinaus fügen Sie so viele hinzu, wie Sie brauchen. Jeder zusätzliche Platz bringt einen Mitarbeiter mit, für {seatPrice} pro Platz und Monat — derselbe Schritt wie in der Leiter oben.",
  "pricing.custom.seats": "Plätze",
  "pricing.custom.quickPicks": "Schnellauswahl",
  "pricing.custom.fewer": "Ein Platz weniger",
  "pricing.custom.more": "Ein Platz mehr",
  "pricing.custom.cap": "Bis zu {maxSeats} Plätze und {maxCrew} Mitarbeiter — {maxPeople} Personen insgesamt. Noch größer?",
  "pricing.custom.contact": "Kontaktieren Sie uns",
...
const zh = {
  ...
  "booking.mode.addressHintPlain": "上门服务需要地址。",
  "booking.mode.travelChecking": "正在查看我们哪些时间能到达这个地址…",
  "booking.mode.travelApplied": "显示我们能准时到达 {address} 的时间。",
  "booking.mode.travelNotFound": "我们在地图上找不到这个地址，所以显示了所有时间。预约前请核对地址。",
  "booking.mode.timeUnreachable": "这个时间不适合该地址 — 我们无法准时到达。",
  "booking.mode.pickAnotherTime": "选择其他时间",
  ...
  "pricing.custom.title": "需要更多人手？定制您的方案。",
  "pricing.custom.body": "超过 {baseSeats} 个席位后，按需添加。每增加一个席位就附带一名工人，每席位每月 {seatPrice}——与上方阶梯的步长相同。",
  "pricing.custom.seats": "席位",
  "pricing.custom.quickPicks": "快速选择",
  "pricing.custom.fewer": "减少一个席位",
  "pricing.custom.more": "增加一个席位",
  "pricing.custom.cap": "最多 {maxSeats} 个席位和 {maxCrew} 名工人——共 {maxPeople} 人。规模更大？",
  "pricing.custom.contact": "联系我们",
...
const it = {
  ...
  "booking.mode.addressHintPlain": "Necessario per un sopralluogo.",
  "booking.mode.travelChecking": "Stiamo verificando a che ora possiamo raggiungere questo indirizzo…",
  "booking.mode.travelApplied": "Orari in cui possiamo arrivare puntuali a {address}.",
  "booking.mode.travelNotFound": "Non abbiamo trovato questo indirizzo sulla mappa, quindi sono mostrati tutti gli orari. Controllalo prima di prenotare.",
  "booking.mode.timeUnreachable": "Quell'orario non va bene per questo indirizzo — non riusciremmo ad arrivare in tempo.",
  "booking.mode.pickAnotherTime": "Scegli un altro orario",
  ...
  "pricing.custom.title": "Servono più persone? Componi un piano su misura.",
  "pricing.custom.body": "Oltre {baseSeats} postazioni, aggiungine quante ne servono. Ogni postazione aggiunta porta con sé un operativo, a {seatPrice} per postazione al mese — lo stesso gradino della scala qui sopra.",
  "pricing.custom.seats": "Postazioni",
  "pricing.custom.quickPicks": "Scelte rapide",
  "pricing.custom.fewer": "Una postazione in meno",
  "pricing.custom.more": "Una postazione in più",
  "pricing.custom.cap": "Fino a {maxSeats} postazioni e {maxCrew} operativi — {maxPeople} persone in tutto. Più grandi di così?",
  "pricing.custom.contact": "Contattaci",
