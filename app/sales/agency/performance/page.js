...
function callLabelsFor(t) {
  return {
    ...
    dialsMeaning: t("app.salesAgencyPerf.dialsMeaning"),
    nobodyAnswered: t("app.salesAgencyPerf.nobodyAnswered"),
    nobodyAnsweredMeaning: t("app.salesAgencyPerf.nobodyAnsweredMeaning"),
    hungUpFast: t("app.salesAgencyPerf.hungUpFast"),
    hungUpFastMeaning: t("app.salesAgencyPerf.hungUpFastMeaning"),
    voicemailOrBrief: t("app.salesAgencyPerf.voicemailOrBrief"),
    voicemailOrBriefMeaning: t("app.salesAgencyPerf.voicemailOrBriefMeaning"),
    realConversation: t("app.salesAgencyPerf.realConversation"),
    realConversationMeaning: t("app.salesAgencyPerf.realConversationMeaning"),
    reachedRepsWord: t("app.salesAgencyPerf.reachedRepsWord"),
    reachedRepsWordMeaning: t("app.salesAgencyPerf.reachedRepsWordMeaning"),
    callbacks: t("app.salesAgencyPerf.callbacks"),
    callbacksMeaning: t("app.salesAgencyPerf.callbacksMeaning"),
    minutesTalking: t("app.salesAgencyPerf.minutesTalking"),
    minutesTalkingMeaning: t("app.salesAgencyPerf.minutesTalkingMeaning"),
    minutesOnHold: t("app.salesAgencyPerf.minutesOnHold"),
    minutesOnHoldMeaning: t("app.salesAgencyPerf.minutesOnHoldMeaning"),
    holdSupervised: (held, supervised) => t("app.salesAgencyPerf.holdSupervised", { held, supervised }),
    gapHeading: t("app.salesAgencyPerf.gapHeading"),
    gapMeaning: t("app.salesAgencyPerf.gapMeaning"),
    sourceTwilio: t("app.salesAgencyPerf.sourceTwilio"),
    sourceRep: t("app.salesAgencyPerf.sourceRep"),
    sourceTranscriptOrTwilio: t("app.salesAgencyPerf.sourceTranscriptOrTwilio"),
    sourceDerived: t("app.salesAgencyPerf.sourceDerived"),
    ...
    notLogged: (n) => t("app.salesAgencyPerf.notLogged", { n }),
    overAnswered: (n) => t("app.salesAgencyPerf.overAnswered", { n }),
    unverified: (n, handset) => t("app.salesAgencyPerf.unverified", { n, handset }),
    carrierMissingSince: (date, n) => t("app.salesAgencyPerf.carrierMissingSince", { date, n }),
    reconciliation: (legs, attempts, unjoined) => t("app.salesAgencyPerf.reconciliation", { legs, attempts, unjoined }),
    reconciliationDetail: (a, l) => t("app.salesAgencyPerf.reconciliationDetail", { a, l }),
    carrierListCapped: t("app.salesAgencyPerf.carrierListCapped"),
    carrierNotAsked: (why) => t("app.salesAgencyPerf.carrierNotAsked", { why }),
