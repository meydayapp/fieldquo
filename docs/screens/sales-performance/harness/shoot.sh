...
shot "$D/platform-performance-1600.png" 1600 2600 1 "$U?page=platform&path=/platform/sales/performance&do=1"
shot "$D/agency-performance-1600.png"   1600 2000 1 "$U?page=agency&path=/sales/agency/performance&do=1"
shot "$D/agency-call-quality-1280.png"  1280 1400 1 "$U?page=quality&path=/sales/agency/call-quality&do=1"
