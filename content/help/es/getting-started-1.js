...
export const ARTICLES = {
  ...
  "the-sidebar-and-where-everything-is": {
    title: "El menú lateral, y dónde está cada cosa",
    summary:
      "Un solo menú de diecisiete filas en cinco grupos, una página Más para todo lo demás, una barra superior con búsqueda, Crear y tu cuenta, y los Ajustes deslizándose en el mismo menú — dónde vive cada pantalla, y por qué a algunas personas les faltan filas.",
    updated: "2026-09-21",
    intro: [
      "La oficina cabe en un solo menú. Aprende su forma una vez y sabrás dónde está todo: Inicio arriba, luego Trabajo, Personas, Finanzas, Crecer e IA — diecisiete filas — y luego Más, que abre el resto del producto como una página de mosaicos. Ajustes está al pie del menú y desliza su propia lista en la misma columna; no hay un segundo menú.",
      "Sobre cada pantalla hay una barra delgada: dónde estás, un cuadro de búsqueda que encuentra un cliente, un número de presupuesto, una página o un ajuste, el botón Crear, la campana de notificaciones y tu avatar. En un teléfono, las cinco pantallas más usadas están en una barra al pie y Más abre una hoja.",
    ],
    sections: [
      {
        id: "overview",
        heading: "Resumen",
        blocks: [
          { p: "El menú muestra iconos y etiquetas; el botón de abajo lo reduce a solo iconos, con el nombre de cada fila al pasar el cursor, y FieldQuo recuerda la elección. Cada encabezado de grupo excepto **Trabajo** e **IA** se pliega y despliega — esos dos quedan abiertos porque son la cadena y el recorrido guiado empieza ahí; los cinco están abiertos la primera vez que entras. El cuadro **Buscar** en la parte superior del menú abre la misma búsqueda que la barra superior; pulsa **/** en cualquier parte para abrirla desde el teclado." },
        ],
      },
      {
        id: "the-rail",
        heading: "El menú, de arriba abajo",
        blocks: [
          { table: {
            head: ["Grupo", "Filas"],
            rows: [
              ["**Trabajo**", "Solicitudes · Presupuestos · Revisiones de presupuestos · Trabajos · Facturas · Calendario"],
              ["**Personas**", "Clientes · Chat · Asignar turnos"],
              ["**Finanzas**", "Nómina · Análisis"],
              ["**Crecer**", "Marketing · Mensajes · Recepcionista"],
              ["**IA**", "FieldQuo IA · Equipo de IA"],
            ],
          } },
          { figure: "live:app", caption: "Inicio — el menú con Buscar, Inicio, los cinco grupos y Más; la barra superior y el panel al lado." },
          { p: "Bajo los grupos, **Más** lleva un contador — el número de filas que guarda para ti — y abre una página de cuatro mosaicos: **Trabajo y ventas** (Planes de servicio, Tareas, Embudos, Bandeja de la cuadrilla, Diseñador), **Tiempo y cuadrilla** (Mi inicio, Tu equipo, Calendario del equipo, Mi horario, Reloj, Hojas de horas, Hojas diarias, Ausencias, Seguridad, Bitácora), **Finanzas e informes** (Gastos, Compras, Vehículos, KPI) y **Clientes y socios** (Equipos de clientes, Subcontratistas, Recomendar y ganar). No se quitó nada al acortar el menú: cada fila que estaba en él está en un mosaico, a un clic." },
        ],
      },
      {
        id: "the-top-bar",
        heading: "La barra superior",
        blocks: [
          { p: "De izquierda a derecha: el grupo y la fila en que estás; **Buscar**, que recorre clientes, presupuestos, trabajos y facturas por nombre o número y cada página y ajuste por nombre — las flechas mueven, Intro abre, Esc cierra; **Crear**, un menú para empezar un Cliente, una Solicitud, un Presupuesto, un Trabajo o una Factura; la **campana**; y tu **avatar**, que abre Ajustes, Cuenta y facturación, Tu equipo, Ayuda, Idioma, el interruptor de **Apariencia** claro u oscuro y **Cerrar sesión**. Durante una sesión de soporte, el menú del avatar nombra a la persona de soporte y la empresa que se está viendo." },
        ],
      },
      {
        id: "the-settings-menu",
        heading: "El menú de Ajustes",
        blocks: [
          { p: "**Ajustes**, al pie del menú, desliza una lista de ocho grupos en la misma columna — **Volver al menú** arriba devuelve el menú principal, y Ajustes sigue resaltado mientras estés en una página de ajustes. Al hacer clic llegas al índice de ajustes: primero un cuadro **Buscar ajustes**, luego ocho tarjetas, cada una con sus filas como enlaces. Dos clics llegan a cualquier ajuste; uno desde la búsqueda." },
          { bullets: [
            "**Cuenta** — Cuenta y facturación · Recomendar y ganar · Migración de datos · Novedades",
            "**Empresa** — Ajustes de la empresa · Marca · Idioma · Registro de actividad",
            "**Equipo y horarios** — Gestionar equipo · Disponibilidad · Mi calendario · Políticas de ausencias · Políticas · Página de reservas · Zonas de trabajo · Trabajo de campo",
            "**Servicios y precios** — Productos y servicios · Servicios y precios · Costos de materiales · Tarifas de gabinetes · Gastos generales · Campos personalizados",
            "**Documentos y plantillas** — Correo del presupuesto · Plantillas de correo · Plantillas PDF · Traducciones · Listas de verificación · Etiquetas de fotos",
            "**Mensajes y alertas** — Mensajes a clientes · Seguimientos · Notificaciones · Dominio de correo",
            "**Cobros** — Pagos · Meta Ads · Seguimiento de gastos · Crédito de IA · Nómina",
            "**De cara al cliente** — Tu sitio web · Presupuestos instantáneos · Compartir tus enlaces · Enlace bio · Recepcionista telefónica · Empleado de IA · Reseñas",
          ] },
          { figure: "live:app-settings", caption: "Ajustes — el índice de ocho tarjetas, con la lista de ajustes deslizada en el menú de la izquierda." },
        ],
      },
      {
        id: "on-a-phone",
        ...
        blocks: [
          { p: "Por debajo del ancho de un portátil, la barra superior conserva el botón de menú, el logotipo (que lleva a Inicio), la búsqueda y la campana. Una barra al pie de la pantalla lleva **Solicitudes**, **Presupuestos**, **Trabajos**, **Facturas** y **Chat**, y una pestaña **Más** que abre una hoja sobre la página: primero la búsqueda, luego el resto del menú, los mismos cuatro mosaicos, los grupos de ajustes y tu cuenta — la barra sigue visible debajo. Un **+** redondo sobre la barra es el menú Crear. En una página de ajustes, una franja arriba lista las otras filas de ese grupo. Ver [[using-fieldquo-on-your-phone|Usar FieldQuo en tu teléfono]]." },
        ],
      },
      {
        id: "rows-you-may-not-see",
        heading: "Filas que quizá no veas",
        blocks: [
          { p: "Una fila que falta no es un fallo. El menú oculta lo que el nivel de acceso de la persona conectada no permite, y la página detrás de una fila oculta también la rechaza — ocultar es una cortesía, el rechazo es la seguridad. Las mismas reglas rigen en la página Más, en la hoja del teléfono y en la búsqueda: una fila que no ves tampoco aparece al escribir su nombre." },
          { bullets: [
            "**Presupuestos, Trabajos, Facturas, Solicitudes** requieren al menos acceso de lectura a esa área. La cuadrilla solo puede ver trabajos, así que el grupo Trabajo de un miembro de cuadrilla es Trabajos y Calendario.",
            "**Clientes, Recepcionista** requieren vista completa de los registros de clientes. **Análisis** requiere el interruptor de ver precios; **KPI** requiere el costeo de trabajos.",
            "**Tu equipo, Calendario del equipo, Revisiones de presupuestos, Equipo de IA, Subcontratistas, Vehículos, Marketing, Diseñador, Embudos** son para propietarios, administradores, despachadores y gerentes. **Cuenta y facturación** y **Recomendar y ganar** son solo para propietarios y administradores.",
            "**Tarifas de gabinetes** y **Costos de materiales** aparecen solo para empresas que venden un oficio con ese tipo de precios — las únicas filas que decide un oficio. Cada regla está en [[access-levels-overview|Niveles de acceso]] y [[the-settings-menu|El menú de Ajustes]].",
          ] },
        ],
      },
    ],
    faq: [
      { q: "¿Dónde están los mensajes de texto y de Facebook de mis clientes?", a: "Crecer → Mensajes, en el menú. Bandeja de la cuadrilla, bajo Más → Trabajo y ventas, es donde llegan las fotos que envía tu propia cuadrilla." },
      { q: "¿Por qué hay una fila que no encuentro en esta lista?", a: "Pulsa / y escríbela. Si nada coincide, está oculta para tu nivel de acceso — pregunta a un propietario o administrador." },
      { q: "¿Dónde cambio mi plan?", a: "Tu avatar → Cuenta y facturación — la misma pantalla que Ajustes → Cuenta y facturación. Solo propietarios y administradores." },
    ],
  },
