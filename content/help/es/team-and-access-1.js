      ...
      },
      {
        ...
        blocks: [
          { bullets: [
            ...
            "**Solo soy yo — ahora mismo no tengo cuadrilla.** — se muestra solo mientras usted es la única persona de la lista. Marcarla quita «Invita a tu equipo» de los Pasos de configuración adicionales del panel, y la casilla se oculta en cuanto se agrega a alguien más.",
        ...
        blocks: [
          { table: {
            ...
            rows: [
              ...
              ["Solo soy yo — ahora mismo no tengo cuadrilla.", "Registra que usted trabaja solo y quita la fila de invitación de los Pasos de configuración adicionales del panel. Desmárquela el día que contrate a alguien."],
            ],
          } },
        ],
      },
