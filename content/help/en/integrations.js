      ...
      },
      {
        ...
        blocks: [
          { bullets: [
            ...
            "**Offer pay-over-time (Affirm)** — lets a client split an invoice between $50 and $30,000, in USD or CAD, with Affirm at checkout, alongside paying by card. You are still paid in full, up front. Switching it on asks Stripe to enable Affirm on your account — there is nothing to set up in Stripe — and the line under the switch shows Stripe's answer (active, pending review, or not available in your country). Affirm's fee on those payments is passed through the same way as the card fee.",
