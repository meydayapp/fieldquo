      ...
      },
      {
        ...
        blocks: [
          { bullets: [
            ...
            "**It's just me — no crew right now.** — shown only while you are the only person on the roster. Ticking it takes “Invite your team” off the dashboard's Additional set-up steps, and the box hides itself the moment somebody else is added.",
        ...
        blocks: [
          { table: {
            ...
            rows: [
              ...
              ["It's just me — no crew right now.", "Records that you work alone and removes the invite row from the dashboard's Additional set-up steps. Untick it the day you take somebody on."],
            ],
          } },
        ],
      },
