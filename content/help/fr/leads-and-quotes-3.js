...
export const ARTICLES = {
  ...
  "the-kitchen-designer": {
    ...
    sections: [
      {
        ...
        heading: "Vue d'ensemble",
        blocks: [
          { p: "Le bouton **Concepteur de cuisine** apparaît sur une soumission quand votre entreprise a le **concepteur de cuisine** activé sous **Paramètres → Services et tarifs** — il s'active tout seul pour Kitchen Design & New Installs, la rénovation, la rénovation générale, l'entreprise générale, la construction neuve et le remplacement de façades d'armoires ; un homme à tout faire ou un refinisseur qui installe des cuisines peut l'activer, et toute entreprise peut le désactiver — ou quand cette soumission porte déjà une conception. Enregistrer dans le concepteur stocke le dessin et retarife la soumission en une seule étape — il n'y a volontairement pas de « enregistrer le dessin » et de « mettre à jour la soumission » séparés, parce que deux boutons, c'est ainsi qu'une soumission part à un prix qui ne correspond pas au dessin agrafé dessus." },
    ...
    faq: [
      ...
      { q: "Un propriétaire peut-il concevoir une cuisine avant que j'aie soumissionné ?", a: "Oui. Avec le **concepteur de cuisine** activé sous Services, une page publique **Concevez votre cuisine** existe : une carte sur Paramètres → Partager vos liens, une ligne sur votre lien de profil, et un lien à l'étape de chacun de ces services de cuisine dans le formulaire de soumission. Ce qu'il dessine arrive comme demande avec le plan joint et sans prix — c'est vous qui soumissionnez. Le lien client d'une soumission envoyée, c'est autre chose : il modifie la conception de cette soumission." },
