...
export const ARTICLES = {
  ...
  "the-sidebar-and-where-everything-is": {
    ...
    summary:
      "Un seul menu de dix-sept lignes en cinq groupes, une page Plus pour tout le reste, une barre du haut avec la recherche, Créer et votre compte, et les Paramètres qui glissent dans le même menu — où se trouve chaque écran, et pourquoi certaines lignes manquent pour certaines personnes.",
    updated: "2026-09-21",
    intro: [
      "Le bureau tient dans un seul menu. Apprenez sa forme une fois et vous savez où tout se trouve : Accueil en haut, puis Travail, Personnel, Finances, Croissance et IA — dix-sept lignes — puis Plus, qui ouvre le reste du produit sous forme d'une page de tuiles. Paramètres est au bas du menu et fait glisser sa propre liste dans la même colonne; il n'y a pas de second menu.",
      "En haut de chaque écran, une barre mince : où vous êtes, une boîte de recherche qui trouve un client, un numéro de soumission, une page ou un réglage, le bouton Créer, la cloche des notifications et votre avatar. Sur un téléphone, les cinq écrans les plus utilisés sont dans une barre au bas de l'écran et Plus ouvre un panneau.",
    ],
    sections: [
      {
        id: "overview",
        heading: "Aperçu",
        blocks: [
          { p: "Le menu montre des icônes et des libellés; le bouton du bas le réduit aux icônes seules, avec le nom de chaque ligne au survol, et FieldQuo se souvient du choix. Chaque en-tête de groupe sauf **Travail** et **IA** se replie et se déplie — ces deux-là restent ouverts parce qu'ils sont la chaîne et que la visite guidée y commence; les cinq sont ouverts à votre première connexion. La boîte **Rechercher** en haut du menu ouvre la même recherche que la barre du haut; appuyez sur **/** n'importe où pour l'ouvrir au clavier." },
        ],
      },
      {
        id: "the-rail",
        heading: "Le menu, de haut en bas",
        blocks: [
          { table: {
            head: ["Groupe", "Lignes"],
            rows: [
              ["**Travail**", "Prospects · Soumissions · Révisions de soumissions · Chantiers · Factures · Calendrier"],
              ["**Personnel**", "Clients · Clavardage · Attribuer les quarts"],
              ["**Finances**", "Paie · Analyses"],
              ["**Croissance**", "Marketing · Messages · Réceptionniste"],
              ["**IA**", "FieldQuo IA · Équipe IA"],
            ],
          } },
          { figure: "live:app", caption: "Accueil — le menu avec Rechercher, Accueil, les cinq groupes et Plus; la barre du haut et le tableau de bord à côté." },
          { p: "Sous les groupes, **Plus** porte un compte — le nombre de lignes qu'il contient pour vous — et ouvre une page de quatre tuiles : **Travail et ventes** (Plans de service, À faire, Entonnoirs, Boîte équipe, Concepteur), **Temps et équipe** (Mon espace, Votre équipe, Calendrier de l'équipe, Mon horaire, Pointeuse, Feuilles de temps, Feuilles quotidiennes, Congés, Sécurité, Journal de bord), **Finances et rapports** (Dépenses, Achats, Véhicules, KPI) et **Clients et partenaires** (Équipement client, Sous-traitants, Parrainage). Rien n'a été retiré quand le menu a été raccourci : chaque ligne qui s'y trouvait est dans une tuile, à un clic." },
        ],
      },
      {
        id: "the-top-bar",
        heading: "La barre du haut",
        blocks: [
          { p: "De gauche à droite : le groupe et la ligne où vous êtes; **Rechercher**, qui parcourt les clients, soumissions, chantiers et factures par nom ou numéro, et chaque page et réglage par nom — les flèches déplacent, Entrée ouvre, Échap ferme; **Créer**, un menu pour démarrer un Client, un Prospect, une Soumission, un Chantier ou une Facture; la **cloche**; et votre **avatar**, qui ouvre Paramètres, Compte et facturation, Votre équipe, Aide, Langue, l'interrupteur **Apparence** clair ou sombre et **Déconnexion**. Pendant une session de soutien, le menu de l'avatar nomme la personne du soutien et l'entreprise consultée." },
        ],
      },
      {
        ...
        blocks: [
          { p: "**Paramètres**, au bas du menu, fait glisser une liste de huit groupes dans la même colonne — **Retour au menu** en haut ramène le menu principal, et Paramètres reste surligné tant que vous êtes sur une page de réglages. Un clic mène à l'index des réglages : une boîte **Rechercher un réglage** d'abord, puis huit cartes, chacune avec ses lignes en liens. Deux clics atteignent n'importe quel réglage; un seul depuis la recherche." },
          { bullets: [
            "**Compte** — Compte et facturation · Parrainage · Migration des données · Nouveautés",
            "**Entreprise** — Paramètres de l'entreprise · Image de marque · Langue · Journal d'activité",
            "**Équipe et horaires** — Gérer l'équipe · Disponibilités · Mon calendrier · Politiques de congés · Politiques · Page de réservation · Zones de travail · Travail sur le terrain",
            ...
            "**Documents et modèles** — Courriel de soumission · Modèles de courriel · Modèles PDF · Traductions · Listes de contrôle · Étiquettes de photos",
            "**Messages et alertes** — Messages aux clients · Relances · Notifications · Domaine de courriel",
            "**Encaissement** — Paiements · Meta Ads · Suivi des dépenses · Crédit IA · Paie",
            "**Côté client** — Votre site web · Soumissions instantanées · Partager vos liens · Lien bio · Réceptionniste téléphonique · Employé IA · Avis",
          ] },
          { figure: "live:app-settings", caption: "Paramètres — l'index de huit cartes, avec la liste des réglages glissée dans le menu à gauche." },
        ],
      },
      {
        id: "on-a-phone",
        ...
        blocks: [
          { p: "Sous la largeur d'un portable, la barre du haut garde le bouton de menu, le logo (qui ramène à l'Accueil), la recherche et la cloche. Une barre au bas de l'écran porte **Prospects**, **Soumissions**, **Chantiers**, **Factures** et **Clavardage**, et un onglet **Plus** qui ouvre un panneau par-dessus la page : la recherche d'abord, puis le reste du menu, les mêmes quatre tuiles, les groupes de réglages et votre compte — la barre reste visible dessous. Un **+** rond au-dessus de la barre est le menu Créer. Sur une page de réglages, une bande en haut liste les autres lignes de ce groupe. Voir [[using-fieldquo-on-your-phone|Utiliser FieldQuo sur votre téléphone]]." },
        ],
      },
      {
        ...
        blocks: [
          { p: "Une ligne manquante n'est pas un défaut. Le menu cache ce que le niveau d'accès de la personne connectée ne permet pas, et la page derrière une ligne cachée la refuse aussi — cacher est une courtoisie, le refus est la sécurité. Les mêmes règles s'appliquent à la page Plus, au panneau du téléphone et à la recherche : une ligne que vous ne voyez pas ne se trouve pas non plus en tapant son nom." },
          { bullets: [
            "**Soumissions, Chantiers, Factures, Prospects** exigent au moins la consultation de ce domaine. L'équipe ne peut que consulter les chantiers, alors le groupe Travail d'un membre d'équipe se limite à Chantiers et Calendrier.",
            "**Clients, Réceptionniste** exigent la consultation complète des dossiers clients. **Analyses** exige l'interrupteur des prix; **KPI** exige le coût de revient.",
            "**Votre équipe, Calendrier de l'équipe, Révisions de soumissions, Équipe IA, Sous-traitants, Véhicules, Marketing, Concepteur, Entonnoirs** sont réservés aux propriétaires, administrateurs, répartiteurs et gestionnaires. **Compte et facturation** et **Parrainage** sont réservés aux propriétaires et administrateurs.",
            "**Tarifs des armoires** et **Coût des matériaux** n'apparaissent que pour les entreprises qui vendent un métier tarifé ainsi — les seules lignes qu'un métier décide. Toutes les règles sont dans [[access-levels-overview|Les niveaux d'accès]] et [[the-settings-menu|Le menu Paramètres]].",
          ] },
        ],
      },
    ],
    faq: [
      { q: "Où sont les textos et les messages Facebook de mes clients?", a: "Croissance → Messages, dans le menu. Boîte équipe, sous Plus → Travail et ventes, est l'endroit où arrivent les photos textées par votre propre équipe." },
      { q: "Pourquoi une ligne que je cherche n'est-elle pas dans cette liste?", a: "Appuyez sur / et tapez-la. Si rien ne correspond, elle est cachée pour votre niveau d'accès — demandez à un propriétaire ou à un administrateur." },
      { q: "Où est-ce que je change de forfait?", a: "Votre avatar → Compte et facturation — le même écran que Paramètres → Compte et facturation. Propriétaires et administrateurs seulement." },
    ],
  },
