...
// ═══════════════════════════════════════════════════════════════════════════
{
  ...
  ok("the list is 280 wide from md, the context bar 340 from lg (or 1400 when asked)", /md:w-\[280px\]/.test(layout) && /"hidden lg:flex"/.test(layout) && /"hidden min-\[1400px\]:flex"/.test(layout) && /\$\{columnClass\} w-\[340px\]/.test(layout));
