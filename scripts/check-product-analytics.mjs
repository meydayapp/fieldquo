...
section("3. sanitiseBatch");
{
  ...
  ok("AI assistants are their own sources, and gemini is not google", trafficSource({ referrerHost: cleanReferrerHost("https://chatgpt.com/c/abc") }) === "chatgpt" && trafficSource({ utmSource: "chatgpt.com" }) === "chatgpt" && cleanReferrerHost("claude.ai") === "claude.ai" && trafficSource({ referrerHost: "claude.ai" }) === "claude" && trafficSource({ referrerHost: cleanReferrerHost("grok.com") }) === "grok" && cleanReferrerHost("gemini.google.com") === "gemini.google.com" && trafficSource({ referrerHost: "gemini.google.com" }) === "gemini" && cleanReferrerHost("www.google.ca") === "google.com");
